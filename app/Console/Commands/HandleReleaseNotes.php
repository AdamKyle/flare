...
## [Prisoner](https://planesoftlessa.com/admin/classes/9)

[Prisoners](https://planesoftlessa.com/admin/classes/9) are a mix of thief and fighter and when using a weapon they have a chance to do 15% of their 15% of their strength 1-4 times for a rage attack against the enemy.

Prisoners are best with weapons of any type.

## [Alcoholic](https://planesoftlessa.com/admin/classes/10)
...
How do they fight? bare handed! Their [class specials](https://planesoftlessa.com/admin/classes/10) focus mostly on raising their health and their damage.
...
## [Merchant](https://planesoftlessa.com/admin/classes/11)

One of the best classes to play, who are most proficient in staves with bows as secondary.

[Merchants](https://planesoftlessa.com/admin/classes/11) get a discount of 25% of at the shop, they also get 25% off the total bulk price of buying multiple items.
...
- Fixed classes so they properly respect the [races and classes](https://planesoftlessa.com/information/races-and-classes) docs.
	+ [Arcane Alchemists](https://planesoftlessa.com/admin/classes/8) no longer get damage bonus from having healing spells equipped
