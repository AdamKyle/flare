...
class LocationGemParamtersManagementRequest extends FormRequest
{
                    ...
                    $query->where(function ($query) {
                        $query->whereIn(
                            ...
                            Item::where('type', 'quest')
                                ->whereNotNull('drop_location_id')
                                ->select('drop_location_id')
                        )->orWhereNotNull('type');
                    });
                }),
                Rule::unique('game_location_gem_paramters', 'location_id')->ignore($this->integer('id')),
            ],
