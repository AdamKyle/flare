...
class StoreQuestRequest extends FormRequest
{
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            $this->validateParentCycle($validator, $this->input('parent_quest_id'), null);
            $this->validateRequiredQuestCycle($validator, $this->input('required_quest_id'), null);
            $this->validateRequiredQuestChain($validator, $this->input('required_quest_chain'), null);
        });
    }
}
