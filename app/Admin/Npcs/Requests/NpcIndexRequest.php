...
class NpcIndexRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort_key' => 'required|string|in:real_name,type,x_position,y_position',
            'sort_direction' => 'required|string|in:asc,desc',
            'filters' => 'nullable|array',
            'filters.game_map_id' => 'nullable|integer|exists:game_maps,id',
            'filters.type' => ['nullable', 'integer', Rule::enum(NpcType::class)],
        ];
    }

    /**
     * Apply the NPCs list defaults before validation runs.
     *
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'sort_key' => $this->input('sort_key', 'real_name'),
