...
class RegisterMessage implements ShouldQueue
{
    ...
    public function handle() {
        ...
        event(new ServerMessageEvent($user, 'Welcome! I am so glad you could join us child! What an exciting time to join a rapidly developing game.
         ...
         There is even a discord icon up there. Finally you can ask for help here in the chat. Chat is loaded from the last 24 hours, so if someone doesn\'t respond right now, they will see your question when they login next!
