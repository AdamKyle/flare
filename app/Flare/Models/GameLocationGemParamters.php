...
use Database\Factories\GameLocationGemParamtersFactory;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\BelongsTo;

class GameLocationGemParamters extends Model
{
    use HasFactory;

    protected $table = 'game_location_gem_paramters';
    ...
    protected static function newFactory(): GameLocationGemParamtersFactory
    {
        return GameLocationGemParamtersFactory::new();
    }
}
