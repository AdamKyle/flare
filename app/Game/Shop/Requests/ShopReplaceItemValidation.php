...
class ShopReplaceItemValidation extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'slot_id' => 'required',
            'equip_type' => 'required|in:sword,stave,bow,hammer,mace,fan,gun,scratch-awl,body,shield,leggings,feet,sleeves,helmet,gloves,ring,spell-healing,spell-damage,artifact',
