...
class NotificationsController extends Controller {
    ...
    public function clear() {
        ...
        event(new UpdateNotificationsBroadcastEvent(
            auth()->user()->character
                          ->notifications()
                          ->where('read', false)->get(), auth()->user()
        ));
    ...
    public function clearNotification(Request $request, Notification $notification) {
        ...
        $notification = $character->notifications()
                                  ->where('id', $notification->id)
                                  ->where('character_id', $notification->character_id)
                                  ->first();
