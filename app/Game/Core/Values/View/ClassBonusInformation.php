...
class ClassBonusInformation
{
    ...
    {
        $classAttackValue = CharacterClass::from($className);
    ...
    {
        $classAttackValue = CharacterClass::from($character->class->name);
    ...
    protected function getClassDetails(CharacterClass $classAttackValue, array $details): array
    {
        if ($classAttackValue->isFighter()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::FIGHTERS_DOUBLE_DAMAGE->value);
        ...
        if ($classAttackValue->isRanger()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::RANGER_TRIPLE_ATTACK->value);
        ...
        if ($classAttackValue->isThief()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::THIEVES_SHADOW_DANCE->value);
        ...
        if ($classAttackValue->isHeretic()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::HERETICS_DOUBLE_CAST->value);
        ...
        if ($classAttackValue->isProphet()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::PROPHET_HEALING->value);
        ...
        if ($classAttackValue->isVampire()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::VAMPIRE_THIRST->value);
        ...
        if ($classAttackValue->isBlacksmith()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::BLACKSMITHS_HAMMER_SMASH->value);
        ...
        if ($classAttackValue->isArcaneAlchemist()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::ARCANE_ALCHEMISTS_DREAMS->value);
        ...
        if ($classAttackValue->isPrisoner()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::PRISONER_RAGE->value);
        ...
        if ($classAttackValue->isAlcoholic()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::ALCOHOLIC_PUKE->value);
        ...
        if ($classAttackValue->isMerchant()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::MERCHANTS_SUPPLY->value);
        ...
        if ($classAttackValue->isDancer()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::SENSUAL_DANCE->value);
        ...
        if ($classAttackValue->isCleric()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::HOLY_SMITE->value);
        ...
        if ($classAttackValue->isGunslinger()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::GUNSLINGERS_ASSASSINATION->value);
        ...
        if ($classAttackValue->isBookBinder()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::BOOK_BINDERS_FEAR->value);
        ...
        if ($classAttackValue->isApothecary()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::PLAGUE_SURGE->value);
        ...
        if ($classAttackValue->isBuccaneer()) {
            $details['type'] = Str::ucfirst(ClassSpecialAttackType::BUCCANEERS_BARRAGE->value);
