...
enum ItemEffectType: string
{
    ...
    case DELVE = 'delve';
    case DELVE_PACK_CHOICE = 'delve-pack-choice';
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::DELVE => 'Access Delve locations.',
            self::DELVE_PACK_CHOICE => 'Choose a Delve reward pack.',
        };
    }

    public function walkOnWater(): bool
    {
        return $this === self::WALK_ON_WATER;
    }

    public function walkOnIce(): bool
    {
        return $this === self::WALK_ON_ICE;
    }

    public function walkOnDeathWater(): bool
    {
        return $this === self::WALK_ON_DEATH_WATER;
    }

    public function walkOnMagma(): bool
    {
        return $this === self::WALK_ON_MAGMA;
    }
    ...
    {
        return $this === self::MERCENARY_SLOT_BONUS;
    }

    public function walkOnDelusionalMemoriesWater(): bool
    {
        return $this === self::WALK_ON_DELUSIONAL_MEMORIES_WATER;
    }

    public function accessTwistedMemories(): bool
    {
        return $this === self::TWISTED_TREE_BRANCH;
    }

    public function accessTwistedDungeons(): bool
    {
        return $this === self::TWISTED_DUNGEONS;
    }
    ...
    {
        return $this === self::DELVE_PACK_CHOICE;
    }
}
