...
class DelveTopsService
{
    ...
    public function leaderboard(Request|array $request = []): array
    {
        ...
        $metric = $parameters['metric'] ?? 'strongest_enemy_increase';
        $metrics = [
            ['key' => 'strongest_enemy_increase', 'label' => 'Strongest Enemy Increase'],
            ['key' => 'run_count', 'label' => 'Runs'],
            ['key' => 'encounter_count', 'label' => 'Encounters'],
            ['key' => 'average_pack_size', 'label' => 'Average Pack Size'],
        ];
    ...
    public function detail(DelveExploration $delveExploration): array
    {
        ...
        return [
            ...
            'duration_seconds' => $delveExploration->started_at && $delveExploration->completed_at ? $delveExploration->started_at->diffInSeconds($delveExploration->completed_at) : null,
