...
class HolyOilSelectedItemsStatusSection implements BatchCraftingStatusSection
{
    /**
    ...
    {
        return $type === BatchCraftingType::HOLY_OILS && $mode === HolyOilsBatchMode::SELECTED_ITEMS->value;
    }

    /**
     * Build the Holy Oils Selected Items mode-specific status facts for the batch.
     *
     ...
     * @return array The Holy Oils Selected Items mode-specific status facts.
     */
