...
class CraftSetStatusSection implements BatchCraftingStatusSection
{
    ...
    {
        return $type === BatchCraftingType::CRAFT && $mode === CraftingBatchMode::SET->value;
    }

    /**
     * Build the Craft Set mode-specific status facts for the batch.
     *
     ...
     * @return array The Craft Set mode-specific status facts.
     */
