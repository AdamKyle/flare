...
class AutomatedCraftingHandler
{
     ...
     *
     * @return AutomatedCraftingResult The crafting result.
     */
     ...
     * Set the target item.
     *
     * @return bool True when the target item was found.
     */
     ...
     *
     * @return bool True when a crafting skill was found.
     */
     ...
     *
     * @return bool True when target crafting should continue.
     */
     ...
     *
     * @return int The remaining required target item count.
     */
     ...
     *
     * @return bool True when the character's skill level is below the target item's requirement.
     */
     ...
     *
     * @return Item|null The next available training item, if any.
     */
