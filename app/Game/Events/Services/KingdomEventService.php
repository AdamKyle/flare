...
class KingdomEventService {
    ...
    public function handleKingdomRewardsForEvent(string $gameMapName) {
        ...
        if (!is_null($character)) {
            event(new GlobalMessageEvent('Congratulations to: ' . $character->name . ' for being the character with the most kingdoms on The Ice Plane! They have been rewarded with something beyond their imagination!'));
