...
class GemTierValue {
    ...
    public function maxTierOneAmount(): array|null {
        if ($this->isTierOne()) {
            return ['min' => 1, 'max' => 25, 'cost' => ['gold_dust' => 1000, 'shards' => 250, 'copper_coins' => 100, 'chance' => .30]];
        }
    ...
    public function maxTierTwoAmount(): array|null {
        if ($this->isTierTwo()) {
            return ['min' => 5, 'max' => 50, 'cost' => ['gold_dust' => 5000, 'shards' => 500, 'copper_coins' => 250, 'chance' => .15]];
        }
    ...
    public function maxTierThreeAmount(): array|null {
        if ($this->isTierThree()) {
            return ['min' => 10, 'max' => 75, 'cost' => ['gold_dust' => 10000, 'shards' => 1000, 'copper_coins' => 500, 'chance' => .05]];
        }
    ...
    public function maxTierFourAmount(): array|null {
        if ($this->isTierFour()) {
            return ['min' => 20, 'max' => 100, 'cost' => ['gold_dust' => 50000, 'shards' => 2500, 'copper_coins' => 1000, 'chance' => 0.01]];
        }
