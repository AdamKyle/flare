...
/**
 * The closed set of additive player/reward effects a resolved Area Gem
 * context can contribute. Crafting bonuses and Unique/Mythic/Cosmic rarity
 * modifiers are owned separately and are not part of this set.
 */
