...
class GemTierValue
{
    ...
    public function maxTierOneAmount(): ?array
    {
        if ($this->isTierOne()) {
            return [
                'min' => 1,
    ...
    public function maxTierTwoAmount(): ?array
    {
        if ($this->isTierTwo()) {
            return [
                'min' => 5,
    ...
    public function maxTierThreeAmount(): ?array
    {
        if ($this->isTierThree()) {
            return [
                'min' => 10,
    ...
    public function maxTierFourAmount(): ?array
    {
        if ($this->isTierFour()) {
            return [
                'min' => 20,
    ...
    public function maxForTier(): ?array
    {
