...
class Entrance extends BattleBase
{
    ...
    private function canAttackerEntranceDefender(array $attackType)
    {
    ...
    private function canPlayerEntranceMonster(Character $character, ServerMonster $monster, array $attackType): bool
    {
    ...
    private function canMonsterEntrancePlayer(Character $character, ServerMonster $monster, bool $isPlayerVoided): bool
    {
