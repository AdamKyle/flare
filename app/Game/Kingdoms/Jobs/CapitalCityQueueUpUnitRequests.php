...
class CapitalCityQueueUpUnitRequests implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;

    public function __construct(protected readonly int $characterId, protected readonly int $kingdomId, protected readonly array $requestData) {}
