...
class MoveUnits implements ShouldQueue {
    ...
    private function handleWhenResourceRequested(UnitMovementQueue $unitMovementQueue, UpdateKingdom $updateKingdom): void {
        ...
        RequestResources::dispatch($unitMovementQueue->character_id, $unitMovementQueue->to_kingdom_id, $unitMovementQueue->from_kingdom_id, $this->additionalParams['amount_of_resources'], $unitMovementQueue->units_moving, $this->additionalParams['additional_log_messages'], $this->additionalParams['capital_city_queue_id'], $this->additionalParams['building_id']);
