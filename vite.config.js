...
export default defineConfig({
    plugins: [
        laravel([
            ...
            'resources/js/tops-character-component.ts',
            'resources/js/tops-exploration-component.ts',
            'resources/js/tops-delve-component.ts',
            'resources/js/tops-faction-loyalty-component.ts',
            'resources/js/tops-kingdoms-component.ts',
