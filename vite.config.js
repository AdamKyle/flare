...
export default defineConfig({
    plugins: [
        laravel([
            ...
            'resources/js/admin/quests/quests-app.tsx',
            'resources/js/admin/monsters/monsters-app.tsx',
            'resources/js/information/quests/quests-info-app.tsx',
            'resources/js/information/monsters/monsters-info-app.tsx',
        ]),
        tailwindcss(),
        react(),
    ],
