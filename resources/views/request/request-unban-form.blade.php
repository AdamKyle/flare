    ...
    <div class="flex min-h-screen items-start justify-center px-4 pt-16">
        <div class="w-full max-w-md space-y-8">
            ...
            >
                ...
                <div>
                    <label for="unban-message" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        Reason
                    </label>
                    <textarea
                        id="unban-message"
                    ...
                    @error('unban_message')
                        <p id="unban-message-error" class="mt-2 text-sm text-red-600 dark:text-red-400" role="alert">
                            {{ $message }}
                        </p>
                    @enderror
                </div>
