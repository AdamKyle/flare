...
@section('content')
    <div class="container mx-auto lg:px-4 mb-5">
        <div class="text-center mb-10 lg:mt-10">
            ...
            >
                Weekly Currency Drops!
            </h3>
            <p class="mb-5 dark:text-gray-300 text-gray-800 italic">
                Slaughter the creatures before you and live in a wealth of
                currencies child! Alchemy awaits!
            </p>
        ...
        <div class="text-center w-full lg:w-2/4 mx-auto my-20">
            ...
            <p class="mb-10 dark:text-gray-300 text-gray-800">
                When you log in and kill any creature - other than a celestial,
                you gain 1 - 500 Gold Dust and Shards! These can be used in
                Alchemy as well as other Mid to late game systems that depend on
        ...
        <div class="grid lg:grid-cols-3 gap-3 w-full md:w-2/3 m-auto my-10">
            <x-core.cards.feature-card>
                ...
                <p>
                    Shards are used in a variety of things, how ever late game
                    you need them more for
                    <a href="/information/alchemy">Alchemy</a>
                    , which can grant you powerful boosts to your stats as well
                    as bring your enemies kingdoms to their knees!
                </p>
            </x-core.cards.feature-card>
            <x-core.cards.feature-card>
                <x-slot:icon>
                    <i
                        class="ra ra-crystals text-primary-600 relative top-[10px] right-[10px]"
                    ></i>
                </x-slot>
                <x-slot:title>
                    <a
                ...
                <p>
                    Gold Dust is gained in a small amount in a variety of ways.
                    From
                    <a href="/information/quests">Quests</a>
                    , to
                    <a href="/information/alchemy">Alchemy</a>
                    , to late game activities, players need this vital resource.
        ...
        <div class="w-full lg:w-2/4 mx-auto mt-10 lg:mt-20 mb-10 mt-4 lg:mt-0">
            ...
            <dl class="mt-3">
                ...
                <dd>
                    Login and kill a non celestial creature! That's it. Your
                    server messages section will show you how much Gold Dust and
                    Shards you gain.
                </dd>
                <dt>
                    Does this stack with special locations that also drop these
                    currencies?
                </dt>
                <dd>Yes it does!</dd>
            </dl>
