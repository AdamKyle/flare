    ...
    <div class="container mx-auto mb-5 lg:px-4">
        <div class="mb-10 text-center lg:mt-10">
            ...
            <p class="mb-5 text-gray-800 italic dark:text-gray-300">
                Slaughter the creatures before you and live in a wealth of currencies child! Alchemy awaits!
            </p>
        ...
        <div class="mx-auto my-20 w-full text-center lg:w-2/4">
            ...
            <p class="mb-10 text-gray-800 dark:text-gray-300">
                ...
                These can be used in Alchemy as well as other Mid to late game systems that depend on such a rare
                resource!
            </p>
        </div>
        ...
        <div class="m-auto my-10 grid w-full gap-3 md:w-2/3 lg:grid-cols-3">
            <x-core.cards.feature-card>
                ...
                <p>
                    Shards are used in a variety of things, how ever late game you need them more for
                    <a href="/information/alchemy">Alchemy</a>
                    , which can grant you powerful boosts to your stats as well as bring your enemies kingdoms to their
                    knees!
                </p>
            </x-core.cards.feature-card>
            <x-core.cards.feature-card>
                ...
                <p>
                    ...
                    , to
                    <a href="/information/alchemy">Alchemy</a>
                    , to late game activities, players need this vital resource. Today you can gain more then you will
                    ever need!
                </p>
            </x-core.cards.feature-card>
            <x-core.cards.feature-card>
        ...
        <div class="mx-auto mt-4 mt-10 mb-10 w-full lg:mt-0 lg:mt-20 lg:w-2/4">
            ...
            <dl class="mt-3">
                ...
                <dd>
                    Login and kill a non celestial creature! That's it. Your server messages section will show you how
                    much Gold Dust and Shards you gain.
                </dd>
