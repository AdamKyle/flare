    ...
    <div class="container mx-auto lg:px-4 mb-5">
        <div class="mb-10 lg:mt-10">
            <div class="text-center">
                <h3 class="mb-5 font-thin text-5xl dark:text-gray-300 text-gray-800 text-4xl md:text-7xl">Corrupted Bishop</h3>
                <p class="mb-5 dark:text-gray-300 text-gray-800 italic">A mad bishop of a time long lost who corrupts his own delusional memories!</p>
            </div>
            @if (!is_null($event))
        ...
        <div class="text-center w-full lg:w-2/4 mx-auto mt-20">
            ...
            <p class="mb-10 dark:text-gray-300 text-gray-800">
               Participate in two branches of quests! One will tell the story of The Jester and requires your ability to kill raid monsters to get the quest items,
                and the other quest line will lead to a cosmetic unlock. In this case players can take their inventory max from 75 (including <a href="/information/alchemy">Alchemy items</a>, <a href="/information/gems">gems</a> and regular items) to 150! Allowing you to have more items in your inventory.
                Of course you also have <a href="/information/equipment-sets">sets</a> which let you have unlimited items!
            </p>
        </div>
        ...
        <div class="text-center w-full lg:w-2/4 mx-auto mt-20">
            ...
            <p class="mb-10 dark:text-gray-300 text-gray-800">
                Complete the Raid Quests on Delusional Memories Plane and gain an additional 75 item slots in your inventory!
            </p>
        </div>
            ...
            <x-core.cards.feature-card>
                ...
                <x-slot:title>
                    <a
                        href="{{ route('info.page', [
                            'pageName' => 'raids',
                        ]) }}">Band together to take down the Corrupted Bishop</a>
                </x-slot:title>

                <p>
                    Band together with other players and take down the raid boss: The Corrupted Bishop
                </p>
            </x-core.cards.feature-card>
        </div>
