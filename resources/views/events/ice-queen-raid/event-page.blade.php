    ...
    <div class="container mx-auto lg:px-4 mb-5">
        <div class="mb-10 lg:mt-10">
            <div class="text-center">
                ...
                <p class="mb-5 dark:text-gray-300 text-gray-800 italic">
                    Her pain keeps her trapped in her own memories. Time to put
                    down this grieving mother!
                </p>
            </div>
        ...
        <div class="text-center w-full lg:w-2/4 mx-auto mt-20">
            ...
            <p class="mb-10 dark:text-gray-300 text-gray-800">
                ...
                unlock. In this case players get the ability to select a name
                tag that will show up when they use the public chat!
            </p>
        </div>
            ...
            <div class="md:flex md:items-center text-center md:text-left">
                <div>
                    ...
                    <p class="mb-10 dark:text-gray-300 text-gray-800">
                        ...
                        do not, she will just laugh at you and thank you for
                        tickeling her. All damage counts!
                    </p>
                </div>
            </div>
            <div class="mt-4 lg:mt-0">
