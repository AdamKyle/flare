    ...
    <div class="container mx-auto lg:px-4 mb-5">
        <div class="mb-10 lg:mt-10">
            <div class="text-center">
                ...
                <p class="mb-5 dark:text-gray-300 text-gray-800 italic">
                    He grieves his wife, he grieves his son. His cries are a
                    scream on the wind in the middle of the night!
                </p>
            </div>
        ...
        <div class="text-center w-full lg:w-2/4 mx-auto mt-20">
            ...
            <p class="mb-10 dark:text-gray-300 text-gray-800">
                ...
                . Players can enter corrupted locations and put their might to
                the test as they work together to take down the raid boss!
            </p>
        ...
        <div class="text-center w-full lg:w-2/4 mx-auto mt-20">
            ...
            <p class="mb-10 dark:text-gray-300 text-gray-800">
                ...
                unlock. In this case characters can freely switch their race
            ...
            <div class="md:flex md:items-center text-center md:text-left">
                <div>
                    ...
                    <p class="mb-5 dark:text-gray-300 text-gray-800">
                        ...
                        self. The raid boss is open for all players regardless
                        of skill level to take down!
                    </p>
                    <p class="mb-10 dark:text-gray-300 text-gray-800">
                        <strong>Are you new?</strong>
                        The raid boss fight for you wont sluaghter you on the
                        first hit! instead the raid boss will laugh at you and
                        you can keep hitting them until you reach a specific
                        damage range, which is when the damage boss starts
                        fighting back! If your character has an attack of 500
                        billion or higher, the raid boss will attack you, if you
                        do not, he will just laugh at you and thank you for
                        tickeling him. All damage counts!
                    </p>
                </div>
            </div>
            <div class="mt-4 lg:mt-0">
        ...
        <div class="grid lg:grid-cols-3 gap-3 w-full md:w-2/3 m-auto">
            ...
            <x-core.cards.feature-card>
                ...
                <p>
                    ...
                    <a
                        href="{{ route('info.page', ['pageName' => 'corrupted-ice']) }}"
                    >
                        Corrupted Ice
                    </a>
        ...
        <div class="w-full lg:w-2/4 mx-auto mt-10 lg:mt-20 mb-10 mt-4 lg:mt-0">
            ...
            <dl class="mt-3">
                ...
                <dd>
                    Simply log in and head down to the Ice Plane and search for
                    a skull location. One of these locations will have the raid
                    boss as the first critter in the list. The rest will be Raid
                    Critters.
                </dd>
                ...
                <dd>
                    ...
                    as well as having a full set of Purgatory chain gear. But if
                    you are loking at fighting the raid boss, any level will do!
                </dd>
            </dl>
        </div>
    </div>
