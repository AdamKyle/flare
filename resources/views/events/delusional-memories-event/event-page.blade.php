    ...
    <div class="container mx-auto lg:px-4 mb-5">
        <div class="mb-10 lg:mt-10">
            <div class="text-center">
                ...
                <p class="mb-5 dark:text-gray-300 text-gray-800 italic">
                    A plane with a story of living deep with in ones own
                    delusions.
                </p>
            </div>
            ...
            @endif
            <div
                class="grid md:grid-cols-3 gap-2 md:w-2/3 w-full mr-auto ml-auto text-center"
            >
        ...
        <div class="text-center w-full lg:w-2/4 mx-auto mt-20">
            ...
            <p class="mb-10 dark:text-gray-300 text-gray-800">
                ...
                equipment can venture down - through traversing - to the new
                plane where they can participate in global events to earn mid
                game gear to help your progression through Tlessa!
            </p>
            ...
            <div class="md:flex md:items-center text-center md:text-left">
                <div>
                    ...
                    <p class="mb-10 dark:text-gray-300 text-gray-800">
                        ...
                        Federation and The Corrupted Church! What could the
                        secrets of a Jester hide in this land?
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="md:flex md:items-center text-center md:text-left">
                <div>
                    ...
                    <p class="mb-10 dark:text-gray-300 text-gray-800">
                        ...
                        global events, be they Battling, Crafting or Enchanting!
                        Players who participate can be rewarded with mythical
                        items for the battle phase and Legendary Uniques for
        ...
        <div class="text-center w-full lg:w-2/4 mx-auto mt-20">
            ...
            <p class="mb-10 dark:text-gray-300 text-gray-800">
                With this event we dive into the delusional machinations of a
                mad Jester ever on the search for his brother. His own
                delusional fantasies play out before you! What's real and whats
                not?!
            </p>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-3 w-full md:w-2/3 m-auto">
            <x-core.cards.feature-card>
                ...
                <p>
                    ...
                    , fight powerful new monsters that test your might and
                    courage! New? You will be able to fight easier creatures so
            ...
            <x-core.cards.feature-card>
                ...
                <p>
                    Fight the Jester of Time and his minions for a chance at
                    wining the new tier of gear:
                    <a href="/information/delusional-silver">
                        Delusional Silver
                    </a>
                    ! All players regardless of level can participate in the
                    raid.
                </p>
            </x-core.cards.feature-card>
            <x-core.cards.feature-card>
                ...
                <p>
                    Fight the Corrupted Bishop and his minions for a chance at
                    wining the new tier of gear:
                    <a href="/information/delusional-silver">
                        Delusional Silver
                    </a>
            ...
            <div class="md:flex md:items-center text-center md:text-left">
                <div>
                    ...
                    <p class="mb-10 dark:text-gray-300 text-gray-800">
                        ...
                        while on this map. Players just have to omplete the new
                        quests to unlock the ability to take on powerful new
                        <a href="/information/weekly-fights">Weekly Fights</a>
                        down here and eaern them selves a chance at getting this
                        gear!
                    </p>
                </div>
            </div>
        ...
        <div class="w-full lg:w-2/4 mx-auto mt-10 lg:mt-20 mb-10 mt-4 lg:mt-0">
            ...
            <dl class="mt-3">
                ...
                <dd>
                    ...
                    is a traverse button, click that to then select Delusional
                    Memories and enter the event.
                </dd>
