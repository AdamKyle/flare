    ...
    <div class="container mx-auto lg:px-4 mb-5">
        <div class="text-center mb-10 lg:mt-10">
            ...
            <p class="mb-5 dark:text-gray-300 text-gray-800 italic">
                A simple move in the wrong direction could unleash death upon
                the plane as the gates have been flung open!
            </p>
        ...
        <div class="text-center w-full lg:w-2/4 mx-auto my-20">
            ...
            <p class="mb-10 dark:text-gray-300 text-gray-800">
                When players move via directional movement, teleporting, setting
                sail or even traversing, there is a 80% chance that a celestial
                some where could spawn! Using /Pct can teleport you to that
                celestial to challenge such a fearsome beast!
            </p>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-3 w-full md:w-2/3 m-auto my-10">
            <x-core.cards.feature-card>
                ...
                <p>
                    Be the first to slaughter one of these beasts and get a
                    godly reward in the form of currency rewards: Shards. Useful
                    in
            ...
            <x-core.cards.feature-card>
                ...
                <p>
                    Celestials are stronger then the creatures you are use to!
                    gear is vital as these beasts will flee if you fail to kill
                    it in one hit!
                </p>
            </x-core.cards.feature-card>
            <x-core.cards.feature-card>
                ...
                <p>
                    ...
                    hours to hunt down and slaughter celestials left right and
                    center, simply by just moving!
                </p>
            </x-core.cards.feature-card>
        </div>
        ...
        <div class="w-full lg:w-2/4 mx-auto mt-10 lg:mt-20 mb-10 mt-4 lg:mt-0">
            ...
            <dl class="mt-3">
                ...
                <dd>
                    Login, move around - use /PCT to travel to the celestial or
                    /PC to find it's quaternaries.
                </dd>
                <dt>What level should I be?</dt>
                <dd>
                    It depends on which plane the Celestial Spawns on. For
                    example - Shadow Plane Celestials are much stronger then
                    Surface. I would recommend being level 500 or higher with
                    maxed out crafted gear, with maxed out enchantments before
