    ...
    <div class="container mx-auto mb-5 lg:px-4">
        <div class="mb-10 text-center lg:mt-10">
            ...
            <p class="mb-5 text-gray-800 italic dark:text-gray-300">
                A simple move in the wrong direction could unleash death upon the plane as the gates have been flung
                open!
            </p>
        ...
        <div class="mx-auto my-20 w-full text-center lg:w-2/4">
            ...
            <p class="mb-10 text-gray-800 dark:text-gray-300">
                ...
                chance that a celestial some where could spawn! Using /Pct can teleport you to that celestial to
                challenge such a fearsome beast!
            </p>
        </div>
        ...
        <div class="m-auto my-10 grid w-full gap-3 md:w-2/3 lg:grid-cols-3">
            <x-core.cards.feature-card>
                ...
                <p>
                    Be the first to slaughter one of these beasts and get a godly reward in the form of currency
                    rewards: Shards. Useful in
            ...
            <x-core.cards.feature-card>
                ...
                <p>
                    Celestials are stronger then the creatures you are use to! gear is vital as these beasts will flee
                    if you fail to kill it in one hit!
                </p>
            </x-core.cards.feature-card>
            <x-core.cards.feature-card>
                <x-slot:icon>
                ...
                <p>
                    This event comes around once per week and gives players 24 hours to hunt down and slaughter
                    celestials left right and center, simply by just moving!
                </p>
            </x-core.cards.feature-card>
        </div>
        ...
        <div class="mx-auto mt-4 mt-10 mb-10 w-full lg:mt-0 lg:mt-20 lg:w-2/4">
            ...
            <dl class="mt-3">
                ...
                <dd>Login, move around - use /PCT to travel to the celestial or /PC to find it's quaternaries.</dd>
                <dt>What level should I be?</dt>
                <dd>
                    It depends on which plane the Celestial Spawns on. For example - Shadow Plane Celestials are much
                    stronger then Surface. I would recommend being level 500 or higher with maxed out crafted gear, with
