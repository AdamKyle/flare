  ...
  <div class="container mx-auto mb-5 lg:px-4">
    <div class="mb-10 lg:mt-10">
      <div class="text-center">
        ...
        <p class="mb-5 text-gray-800 italic dark:text-gray-300">
          Covered in ice and ruled by the wailing queen of ice. Help Mr.
          Whiskers find the truth of this cold and desolate place!
        </p>
      </div>
    ...
    <div class="mx-auto mt-20 w-full text-center lg:w-2/4">
      ...
      <p class="mb-10 text-gray-800 dark:text-gray-300">
        During the The Winter event, players of all levels and equipment can
        venture down - through
        <a href="/information/traverse">traversing</a>
        - to the new plane where they can participate in global events to earn
        mid game gear to help your progression through Tlessa!
      </p>
      ...
      <div class="text-center md:flex md:items-center md:text-left">
        <div>
          ...
          <p class="mb-10 text-gray-800 dark:text-gray-300">
            ...
            places to settle in this land controlled by The Ice Queen who search
            for her dead son. Mr. Whiskers will guide you through quests to tell
            a frozen and dark story of despair!
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="mx-auto mt-20 w-full text-center lg:w-2/4">
      ...
      <p class="mb-10 text-gray-800 dark:text-gray-300">
        With this event we dive deep into the exploration of a mother driven mad
        by the death of her son and the wailing despair of his father as we
        explore more about wjho The Creator is and how he came to this
        mysterious world of Tlessa! This story is a continuation of the main
        story of the game, however, it is done in such a way that you dont have
        to have played through all the previous quests to participate!
      </p>
    </div>
    ...
    <div class="m-auto grid w-full gap-3 md:w-2/3 lg:grid-cols-3">
      <x-core.cards.feature-card>
        ...
        <p>
          ...
          to face powerful monsters that test your might. New players will
          encounter easier fights to join the event!
        </p>
      </x-core.cards.feature-card>
      <x-core.cards.feature-card>
        <x-slot:icon>
      ...
      <x-core.cards.feature-card>
        ...
        <p>
          ...
          <a href="/information/corrupted-ice">Corrupted Ice Gear</a>
          and complete raid quests to unlock Race Change. Join in no matter your
          level or gear!
        </p>
      </x-core.cards.feature-card>
    </div>
    ...
    <div class="mx-auto mt-20 w-full text-center lg:w-2/4">
      ...
      <p class="mb-10 text-gray-800 dark:text-gray-300">
        While exploring or manually fighting you have a 35% chance for Mr.
        Whiskers to give you a gift that is either
    ...
    <div class="mx-auto mt-4 mt-10 mb-10 w-full lg:mt-0 lg:mt-20 lg:w-2/4">
      ...
      <dl class="mt-3">
        ...
        <dd>
          ...
          click that to then select The Ice Plane and enter the event.
        </dd>
