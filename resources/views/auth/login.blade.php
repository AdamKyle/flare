    ...
    <div class="w-full max-w-md space-y-8">
      ...
      @if (config('app.disabled_reg_and_login'))
        <x-core.alerts.info-alert title="ATTN!">
          ...
          maintenance and unlike other deployments, this one has had to disable
          registration and login for a short time. We promise to be back up and
          running soon. For more info, please check
          <a
