        ...
        <div class="w-full md:w-1/2 xl:w-1/3">
            ...
            <x-core.cards.form-card css="mt-5 p-5 md:p-10" method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-5">
                    ...
                    <p class="py-3">
                        Check out
                        <a href="/information/races-and-classes">
                            Races and Classes
                        </a>
                ...
                <div class="mb-5">
                    <label class="label block mb-2" for="name">
                        Name
                        <i class="far fa-question-circle pl-2 cursor" data-toggle="tooltip" data-tippy-placement="right"
                            data-tippy-content="Character names may not contain spaces an can only be 15 characters long (5 characters min) and only contain letters and numbers (of any case)."></i>
                    </label>
                    <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}"
                        required autocomplete="name" autofocus minlength="5" maxlength="15" />
                    @error('name')
                        <div class="text-red-800 dark:text-red-500 pt-3" role="alert">
                            <strong>{{ $message }}</strong>
                        </div>
