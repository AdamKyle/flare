    ...
    <div class="flex min-h-screen items-start justify-center px-4 pt-16">
        <div class="w-full max-w-md space-y-8">
            <header class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600 uppercase dark:text-gray-400">Let's roll that character up!</p>
            </header>

            @if (config('app.disabled_reg_and_login'))
                <x-core.alerts.info-alert title="ATTN!">
                    Deepest apologizes, however Planes of Tlessa is currently down for maintenance and
                    registration/login are paused. We promise to be back soon. For updates, check
                    <a
            ...
            >
                ...
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        Name
                        <span x-data="{ tooltip: false }" class="relative ml-2 inline-block align-middle">
                            <button
                                type="button"
                            ...
                            >
                                Character names may not contain spaces and can only be 15 characters long (5 characters
                                min) and only contain letters and numbers.
                            </div>
                        </span>
                    </label>
                    <input
