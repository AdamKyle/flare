...
@section('content')
    <div class="flex min-h-screen items-start justify-center bg-gray-50 px-4 pt-16 dark:bg-gray-900">
        <div class="w-full max-w-md space-y-8">
            <header class="text-center">
                <h1 class="text-3xl font-extrabold text-gray-900 dark:text-gray-100">Reset Your Password</h1>
                <p class="mt-2 text-sm text-gray-600 uppercase dark:text-gray-400">Come back and adventure with us!</p>
            </header>
