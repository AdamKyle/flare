                ...
                <div class="my-4">
                    ...
                    <div class="grid gap-2 lg:grid-cols-2">
                        <div>
                            ...
                            <p class="mb-4">
                                Below shows the amount of times this character has reincarnated as well as relative stat
                                information.
                            </p>
                            <dl>
                        ...
                        <div class="my-3 block border-b-2 border-b-gray-300 lg:hidden dark:border-b-gray-600"></div>
                        <div>
