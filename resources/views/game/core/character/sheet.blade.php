                        ...
                        <div class="card-body character-skill-info">
                            @if (auth()->user()->hasRole('Admin'))
                                <div class="alert alert-info mb-2">
                                    Changing skills, will not be affected by using different snapshots
                                    when testing. Skills are also not added to snap shots. So feel free to change these to your
                                    heats content.
                                </div>
                            @endif
                            <div class="mt-2">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            @if (auth()->user()->hasRole('Admin'))
                                <div class="alert alert-info mb-2">
                                    <p>Changing the inventory will not be applied to snapshots and will not affect 
