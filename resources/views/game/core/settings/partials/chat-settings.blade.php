<x-core.cards.card-with-title title="Server Message Settings">
    <p class="mb-4">
        Here you can manage what notifications you see in the Server Messages.
        Some are off by default, because they can get annoying.
    </p>
    ...
    >
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label
                    ...
                    for="show_unit_recruitment_messages"
                >
                    <input
                        type="hidden"
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are saying you want server message
                notifications about unit recruitment for all kingdoms.
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label
                    class="custom-checkbox mb-5"
                    for="show_building_upgrade_messages"
                >
                    <input
                        type="hidden"
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are saying you want server message
                notifications about building upgrades for all kingdoms.
            </x-core.alerts.info-alert>
        </div>
        <div
            class="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-3"
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label
                    class="custom-checkbox mb-5"
                    for="show_building_rebuilt_messages"
                >
                    <input
                        type="hidden"
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are saying you want server message
                notifications about buildings that finished being rebuilt, for
                all kingdoms.
            </x-core.alerts.info-alert>
        </div>
        <div
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label
                    class="custom-checkbox mb-5"
                    for="show_kingdom_update_messages"
                >
                    <input
                        type="hidden"
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are saying you want server message
                notifications for when the hourly reset happens.
            </x-core.alerts.info-alert>
        </div>
        <div
            class="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-3"
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted, via
                the Server Message tab, when a monster is to low level for you.
            </x-core.alerts.info-alert>
        </div>
        <div
            class="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-3"
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted of xp
                gained during exploration. This will be a total of the xp given
                to you based on the number of creatures you killed.
            </x-core.alerts.info-alert>
        </div>
        <div
            class="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-3"
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted of xp
                gained out side of exploration on a per kill basis.
            </x-core.alerts.info-alert>
        </div>
        <div
            class="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-3"
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label
                    class="custom-checkbox mb-5"
                    for="show_xp_for_class_masteries"
                >
                    <input
                        type="hidden"
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted of xp
                gained for yuor current classes masteries. These includes things
                like using a weapon and gaining XP towards the mastery of using
                weapons. you can learn more about this through:
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label
                    class="custom-checkbox mb-5"
                    for="show_faction_point_message"
                >
                    <input
                        type="hidden"
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted of
                gaining points for
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label
                    class="custom-checkbox mb-5"
                    for="show_faction_loyalty_xp_gain"
                >
                    <input
                        type="hidden"
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted of xp
                gained for your character when leveling your
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted of xp
                gained for the current skill you have in
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label
                    class="custom-checkbox mb-5"
                    for="show_item_skill_kill_count"
                >
                    <input
                        type="hidden"
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted of an
                items skill kill count when fighting. This only applies to
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted gold
                you gain per kill.
            </x-core.alerts.info-alert>
        </div>
        <div
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted
                (crystal) shards you gain per kill.
            </x-core.alerts.info-alert>
        </div>
        <div
            class="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-3"
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label
                    class="custom-checkbox mb-5"
                    for="show_copper_coins_per_kill"
                >
                    <input
                        type="hidden"
            ...
            <x-core.alerts.info-alert title="ATTN!">
                By selecting this, you are stating you want to be alerted copper
                coins you gain per kill.
            </x-core.alerts.info-alert>
        </div>
        <div
            class="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-3"
