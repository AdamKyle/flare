...
>
    ...
    <x-slot:footer>
        ...
        <button
          type="submit"
          form="account-reset"
          class="whitespace-nowrap rounded-sm bg-red-600 px-4 py-2 text-center text-sm font-medium tracking-wide text-white transition hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 active:opacity-100 active:outline-offset-0 dark:bg-red-600"
        >
            Yes. I am sure
        </button>
    </x-slot:footer>
