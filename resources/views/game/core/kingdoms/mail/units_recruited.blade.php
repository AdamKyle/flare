    ...
    <mj-column width="400px">
        ...
        <mj-table>
            ...
            <tr>
                ...
                <td style="padding: 0 0 0 15px;color:#637381;">{{$kingdom->gameMap->name}}</td>
            </tr>
        </mj-table>
        ...
        <mj-table>
            ...
            <tr>
                <td style="padding: 0 15px 0 0;color:#637381;">{{$unit->name}}</td>
                <td style="padding: 0 15px 0 0;color:#637381;">{{$amount}}</td>
            </tr>
        </mj-table>
