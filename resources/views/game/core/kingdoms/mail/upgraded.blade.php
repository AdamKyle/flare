...
@section('content')
    <mj-column width="400px">
        ...
        <mj-table>
            ...
            <tr>
                <td style="padding: 0 15px 0 0;color:#637381;">{{$building->kingdom->name}}</td>
                <td style="padding: 0 0 0 15px;color:#637381;">{{$building->kingdom->x_position}}</td>
                <td style="padding: 0 0 0 15px;color:#637381;">{{$building->kingdom->y_position}}</td>
                <td style="padding: 0 0 0 15px;color:#637381;">{{$building->kingdom->gameMap->name}}</td>
            </tr>
        </mj-table>
        ...
        <mj-table>
            <tr style="border-bottom:1px solid #2D2424;text-align:left;padding:15px 0;">
              ...
              <th style="padding: 0 15px 0 0;color:#637381;">Level</th>
            ...
            <tr>
                <td style="padding: 0 15px 0 0;color:#637381;">{{$building->name}}</td>
                <td style="padding: 0 15px 0 0;color:#637381;">{{$building->level}}</td>
                <td style="padding: 0 0 0 15px;color:#637381;">{{$building->current_durability}}</td>
                <td style="padding: 0 0 0 15px;color:#637381;">{{$building->current_defence}}</td>
            </tr>
        </mj-table>
