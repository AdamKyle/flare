    ...
    <x-core.layout.info-container>
        ...
        <div class="w-full md:w-3/5 m-auto mt-5">
            <x-core.cards.card-with-title title="Buy and Replace">
                <p class="mb-4">
                    If the item you are replacing is in a set, that item will be
                    moved to your inventory. If you do not have inventory space,
                    your purchase will fail (you won't lose gold).
                </p>
                <p></p>
                ...
                <p class="mb-4 text-orange-700 dark:text-orange-500">
                    ...
                    @if (isset($listingPrice))
                        {{ number_format($listingPrice * 1.05) }} Gold
                        (includes 5% Tax)
                    @else
                ...
                @if (in_array($itemToEquip['type'], ['stave', 'bow', 'hammer']))
                    <x-core.alerts.info-alert title="Attn!">
                        It does not matter which hand you pick as this item is a
                        duel wielded weapon. This weapon can be used with Attack
                        and Cast and Cast and Attack.
                    ...
                    <div class="w-full mt-4">
                        <div class="flex justify-center">
                            ...
                            >
                                ...
                                <input
                                    type="hidden"
                                    value="{{ $positions[$itemToEquip['type']][0] }}"
                                    name="position"
                                />
                                <input
                                    type="hidden"
                                    value="{{ $itemToEquip['id'] }}"
                                    name="item_id_to_buy"
                                />
                                @if (isset($listingId))
                                    <input
                            ...
                            >
                                ...
                                <input
                                    type="hidden"
                                    value="{{ $positions[$itemToEquip['type']][1] }}"
                                    name="position"
                                />
                                <input
                                    type="hidden"
                ...
                @else
                    <p class="mb-4">
                        ...
                        {{ $itemToEquip['default_position'] }}. You cannot
                        select the position.
                    </p>
                    <form
                        method="post"
