        ...
        <div class="{{is_null($item->itemSuffix) ? 'col-md-12' : 'col-md-6'}}">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr />
                    <div class="row">
                        <div class={{$item->itemPrefix->damage !== 0 ? 'col-md-6' : 'col-md-12'}}>
                            <dl>
                                <dt>Name:</dt>
                        ...
                        <div class={{$item->itemPrefix->damage !== 0 ? 'col-md-6' : 'hide'}}>
                            <dl>
                                <dt>Damage:</dt>
        ...
        <div class="{{is_null($item->itemPrefix) ? 'col-md-12' : 'col-md-6'}}">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr />
                    <div class="row">
                        <div class={{$item->itemSuffix->damage !== 0 ? 'col-md-6' : 'col-md-12'}}>
                            <dl>
                                <dt>Name:</dt>
                                <dd>{{$item->itemSuffix->name}}</dd>
                                <dt>Base Attck Modifier:</dt>
                        ...
                        <div class={{$item->itemSuffix->damage !== 0 ? 'col-md-6' : 'hide'}}>
                            <dl>
                                <dt>Damage:</dt>
                                <dd>{{$item->itemSuffix->damage}}</dd>
                                <dt>Is Damage Irresistible?:</dt>
