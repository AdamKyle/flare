  ...
  @foreach ($this->getFiltersByRow() as $filterRowIndex => $filtersInRow)
    ...
    >
      @foreach ($filtersInRow as $filter)
        <div
          @class([
            'mb-4 space-y-1' => $isBootstrap,
            'col-sm-9 col-md-6 col-lg-3 col-12' =>
              $isBootstrap && ! $filter->hasFilterSlidedownColspan(),
            'col-sm-6 col-md-6 col-lg-3 col-12' =>
              $isBootstrap &&
              $filter->hasFilterSlidedownColspan() &&
              $filter->getFilterSlidedownColspan() === 2,
            'col-sm-3 col-md-3 col-lg-3 col-12' =>
              $isBootstrap &&
              $filter->hasFilterSlidedownColspan() &&
              $filter->getFilterSlidedownColspan() === 3,
            'col-sm-1 col-md-1 col-lg-1 col-12' =>
              $isBootstrap &&
              $filter->hasFilterSlidedownColspan() &&
              $filter->getFilterSlidedownColspan() === 4,
            'col-span-12 space-y-1' => $isTailwind,
            'sm:col-span-6 md:col-span-4 lg:col-span-2' =>
              $isTailwind && ! $filter->hasFilterSlidedownColspan(),
