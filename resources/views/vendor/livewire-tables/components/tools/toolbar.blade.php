...
>
  <div
    @class([
      ...
      'mb-4 w-full space-y-4 md:mb-0 md:flex md:w-2/4 md:space-y-0 md:space-x-2' => $isTailwind,
    ])
  >
  ...
  <div
    ...
    @class([
      'd-md-flex' => $isBootstrap,
      'space-y-4 md:flex md:items-center md:space-y-0 md:space-x-2' => $isTailwind,
    ])
  >
