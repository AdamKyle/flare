...
<aside class="menu-bar menu-sticky">
  ...
  <div class="menu-detail" data-menu="basic-info">
    <div class="menu-detail-wrapper">
      ...
      <a href="{{ route('info.page', ['pageName' => 'rules']) }}">
        <span class="fas fa-info-circle text-sm"></span>
        Rules
      </a>
      <a
      ...
      <a href="{{ route('info.page', ['pageName' => 'settings']) }}">
        <span class="fas fa-cogs text-sm"></span>
        Player Settings
      </a>
      <a href="{{ route('info.page', ['pageName' => 'chat-commands']) }}">
        <span class="far fa-comment-dots text-sm"></span>
        Chat Commands
      </a>
      <a href="{{ route('info.page', ['pageName' => 'raids']) }}">
        <span class="ra ra-monster-skull text-sm"></span>
        Raids
      </a>
    ...
    <div class="menu-detail-wrapper">
      ...
      <a href="{{ route('info.page', ['pageName' => 'shop']) }}">
        <span class="icon ra ra-anvil text-sm"></span>
        Shop
      </a>
    ...
    <div class="menu-detail-wrapper">
      ...
      <a href="{{ route('info.page', ['pageName' => 'cosmetic-text']) }}">
        <span class="icon far fa-keyboard text-sm"></span>
        Cosmetic Text
      </a>
      <a href="{{ route('info.page', ['pageName' => 'cosmetic-name-tags']) }}">
        <span class="icon fas fa-tag text-sm"></span>
        Cosmetic Name Tags
      </a>
    </div>
  </div>
  ...
  <div class="menu-detail" data-menu="events">
    ...
    <div class="menu-detail-wrapper">
      ...
      >
        <span class="ra ra-broken-skull text-sm"></span>
