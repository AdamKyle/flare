<x-sidebar.container>
  ...
  >
    <div>
      <h3
        class="mb-4 text-xs leading-[20px] text-gray-600 uppercase dark:text-gray-400"
      >
      ...
      <ul class="mb-6 flex flex-col gap-4">
        <li>
          ...
          >
            ...
            <i
              class="fas fa-chevron-right ml-auto text-gray-500 dark:text-gray-400"
              aria-hidden="true"
            ></i>
          </button>
          <ul
            id="admin-nav-manage"
            class="menu-dropdown mt-2 hidden flex-col gap-1 pl-9"
          >
            <li>
              <a
...
<div
  ...
  class="fixed inset-0 z-[999998] hidden bg-gray-900/50"
  aria-hidden="true"
></div>
