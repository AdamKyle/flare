      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-4">
          ...
          <li>
            ...
            <div :class="selected === 'Dashboard' ? 'block translate transform overflow-hidden' : 'hidden translate transform overflow-hidden'">
              <ul class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                ...
                <li>
                  ...
                  >Analytics <span class="menu-dropdown-badge" :class="page==='analytics'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a>
                </li>
                <li>
                  <a
                    href="marketing.html"
                  ...
                  >Marketing <span class="menu-dropdown-badge" :class="page==='marketing'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a>
                </li>
                <li>
                  <a
                    href="crm.html"
                  ...
                  >CRM <span class="menu-dropdown-badge" :class="page==='crm'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a>
                </li>
                <li>
                  <a
                    href="stocks.html"
                  ...
                  >Stocks <span class="menu-dropdown-badge" :class="page==='stocks'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">New</span> <span class="menu-dropdown-badge" :class="page==='stocks'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li>
            ...
            <div :class="selected === 'Task' ? 'block translate transform overflow-hidden' : 'hidden translate transform overflow-hidden'">
              <ul class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                <li>
                  <a
                    href="task-list.html"
                  ...
                  >List <span class="menu-dropdown-badge" :class="page==='taskList'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a>
                </li>
                <li>
                  <a
                  ...
                  >Kanban <span class="menu-dropdown-badge" :class="page==='taskKanban'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li>
            ...
            <div :class="selected === 'Forms' ? 'block translate transform overflow-hidden' : 'hidden translate transform overflow-hidden'">
              <ul class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                <li>
                  <a
          ...
          <li>
            ...
            <div :class="selected === 'Tables' ? 'block translate transform overflow-hidden' : 'hidden translate transform overflow-hidden'">
              <ul class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                <li>
                  <a
                ...
                <li>
                  ...
                  >Data Tables <span class="menu-dropdown-badge" :class="page==='dataTables'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a>
                </li>
              </ul>
            </div>
          </li>
      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-4">
          ...
          <li>
            ...
            >
              <i :class="selected==='Chat'&&page==='chat'
                            ? 'fas fa-comments text-danube-500 dark:text-danube-400'
                            : 'fas fa-comments text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover=text-gray-300'"></i>
          ...
          <li>
            ...
            >
              <i :class="(selected==='Email' || ['inbox','inboxDetails'].includes(page))
                            ? 'fas fa-envelope text-danube-500 dark:text-danube-400'
                            : 'fas fa-envelope text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover=text-gray-300'"></i>
              <span class="menu-item-text">Email</span>
              <i :class="selected==='Email'
                            ? 'fas fa-chevron-down ml-auto text-danube-500 dark:text-danube-400'
                            : 'fas fa-chevron-right ml-auto text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover=text-gray-300'"></i>
            </a>
            <div :class="selected==='Email' ? 'block translate transform overflow-hidden' : 'hidden translate transform overflow-hidden'">
              <ul class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                <li><a href="inbox.html" class="menu-dropdown-item group" :class="page==='inbox'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Inbox <span class="menu-dropdown-badge" :class="page==='inbox'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a></li>
                <li><a href="inbox-details.html" class="menu-dropdown-item group" :class="page==='inboxDetails'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Details <span class="menu-dropdown-badge" :class="page==='inboxDetails'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a></li>
              </ul>
            </div>
          </li>
          <!-- Invoice -->
          <li>
            ...
            >
              <i :class="selected==='Invoice'&&page==='invoice'
                            ? 'fas fa-file-alt text-danube-500 dark:text-danube-400'
                            : 'fas fa-file-alt text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover=text-gray-300'"></i>
      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-4">
          ...
          <li>
            ...
            >
              <i :class="(selected==='Charts'||['lineChart','barChart','pieChart'].includes(page))
                            ? 'fas fa-chart-pie text-danube-500 dark:text-danube-400'
                            : 'fas fa-chart-pie text-gray-500 group-hover:text-gray-700 dark=text-gray-400 dark:group-hover=text-gray-300'"></i>
              <span class="menu-item-text">Charts</span>
              <i :class="selected==='Charts'
                            ? 'fas fa-chevron-down ml-auto text-danube-500 dark:text-danube-400'
                            : 'fas fa-chevron-right ml-auto text-gray-500 group-hover:text-gray-700 dark=text-gray-400 dark:group-hover=text-gray-300'"></i>
            </a>
            <div :class="selected==='Charts'?'block translate transform overflow-hidden':'hidden translate transform overflow-hidden'">
              <ul class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                <li><a href="line-chart.html" class="menu-dropdown-item group" :class="page==='lineChart'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Line Chart <span class="menu-dropdown-badge" :class="page==='lineChart'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a></li>
                <li><a href="bar-chart.html" class="menu-dropdown-item group" :class="page==='barChart'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Bar Chart <span class="menu-dropdown-badge" :class="page==='barChart'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a></li>
                <li><a href="pie-chart.html" class="menu-dropdown-item group" :class="page==='pieChart'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Pie Chart <span class="menu-dropdown-badge" :class="page==='pieChart'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a></li>
              </ul>
            </div>
          </li>
          ...
          <li>
            ...
            >
              <i :class="(selected==='UiElements'||['alerts','buttons','images','pagination'].includes(page))
                            ? 'fas fa-cubes text-danube-500 dark:text-danube-400'
                            : 'fas fa-cubes text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover=text-gray-300'"></i>
              <span class="menu-item-text">Ui Elements</span>
              <i :class="selected==='UiElements'
                            ? 'fas fa-chevron-down ml-auto text-danube-500 dark:text-danube-400'
                            : 'fas fa-chevron-right ml-auto text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover=text-gray-300'"></i>
            </a>
            <div :class="selected==='UiElements'?'block translate transform overflow-hidden':'hidden translate transform overflow-hidden'">
              <ul class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                <li><a href="alerts.html" class="menu-dropdown-item group" :class="page==='alerts'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Alerts <span class="menu-dropdown-badge" :class="page==='alerts'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a></li>
                <li><a href="buttons.html" class="menu-dropdown-item group" :class="page==='buttons'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Buttons <span class="menu-dropdown-badge" :class="page==='buttons'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a></li>
                <li><a href="images.html" class="menu-dropdown-item group" :class="page==='images'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Images <span class="menu-dropdown-badge" :class="page==='images'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a></li>
                <li><a href="pagination.html" class="menu-dropdown-item group" :class="page==='pagination'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Pagination <span class="menu-dropdown-badge" :class="page==='pagination'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a></li>
              </ul>
            </div>
          </li>
          ...
          <li>
            ...
            >
              <i :class="(selected==='Authentication'||['signin','signup','advancedChart'].includes(page))
                            ? 'fas fa-lock text-danube-500 dark:text-danube-400'
                            : 'fas fa-lock text-gray-500 group-hover:text-gray-700 dark=text-gray-400 dark:group-hover=text-gray-300'"></i>
              <span class="menu-item-text">Authentication</span>
              <i :class="selected==='Authentication'
                            ? 'fas fa-chevron-down ml-auto text-danube-500 dark:text-danube-400'
                            : 'fas fa-chevron-right ml-auto text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover=text-gray-300'"></i>
            </a>
            <div :class="selected==='Authentication'?'block translate transform overflow-hidden':'hidden translate transform overflow-hidden'">
              <ul class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                <li><a href="signin.html" class="menu-dropdown-item group" :class="page==='signin'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Sign In</a></li>
                <li><a href="signup.html" class="menu-dropdown-item group" :class="page==='signup'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Sign Up</a></li>
                <li><a href="advanced-chart.html" class="menu-dropdown-item group" :class="page==='advancedChart'?'menu-dropdown-item-active':'menu-dropdown-item-inactive'">Advanced Chart <span class="menu-dropdown-badge" :class="page==='advancedChart'?'menu-dropdown-badge-active':'menu-dropdown-badge-inactive'">Pro</span></a></li>
              </ul>
            </div>
          </li>
