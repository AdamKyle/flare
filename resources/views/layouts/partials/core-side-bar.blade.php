        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
            <x-sidebar.menu-items.group-options-container headerTitle="Game Data Management">
                ...
                >
                    ...
                    <x-sidebar.menu-items.nested-menu-option href="#" pageKey="import" icon="fas fa-file-import">
                        Import Locations
                    </x-sidebar.menu-items.nested-menu-option>
                    <x-sidebar.menu-items.nested-menu-option href="#" pageKey="export" icon="fas fa-file-download">
                        Export Locations
                    </x-sidebar.menu-items.nested-menu-option>
                </x-sidebar.menu-items.nested-container>
                <x-sidebar.menu-items.nested-container
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        <a
                            ...
                            ['ecommerce', 'analytics', 'marketing', 'crm', 'stocks'].includes(page)
                                ? 'menu-item-active'
                                : 'menu-item-inactive'"
                        >
                            <i
                    ...
                    <x-sidebar.menu-items.nested-container
                        ...
                        icon="fas fa-file"
                    >
                        <x-sidebar.menu-items.nested-menu-option href="#" pageKey="fileManager">
                            File Manager
                        </x-sidebar.menu-items.nested-menu-option>
                        <li>
                            <a
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        <a
                            ...
                            ['alerts', 'buttons', 'images', 'pagination'].includes(page)
                                ? 'menu-item-active'
                                : 'menu-item-inactive'"
                        >
                            <i
                    ...
                    <li>
                        <a
                            ...
                            ['signin', 'signup', 'advancedChart'].includes(page)
                                ? 'menu-item-active'
                                : 'menu-item-inactive'"
                        >
                            <i
