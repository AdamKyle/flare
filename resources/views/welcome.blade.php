  ...
  <div class="container mx-auto mb-5 lg:px-4">
    ...
    <div class="mx-auto mt-20 w-full text-center lg:w-2/4">
      ...
      <p class="mb-10 text-gray-800 dark:text-gray-300">
        ...
        enchanting, gear progression, quests, monsters, kingdoms to manage and
        to take. There is more to do here including but not limited to: Reach
        level 4000+, Fight epic Celestials, Get Faction Points for Uniques,
    ...
    <div class="mx-auto mt-20 w-full text-center lg:w-2/4">
      ...
      <p class="mb-10 text-gray-800 dark:text-gray-300">
        Tlessa has a lot of events that keep players engaged! You can check out
        our event calendar and see what events are coming up. All event all
        intended for all players regardless of level or power to participate in!
      </p>
    ...
    @if (SurveyStats::canShowSurveyMenuOption())
      <div class="mx-auto mt-20 w-full text-center lg:w-2/4">
        ...
        <p class="mb-10 text-gray-800 dark:text-gray-300">
          Tlessa will occasionally hold an event where players can get large
          amounts of XP to help them progress. After 6 hours of total game play,
          does not need to be consecutive, players are promoted with a survey -
          filling out rhe survey helps Tlessa make the game better and become of
          the best PBBGS around! Players also get a shiny mythical item for
          completing them!
        </p>
    ...
    <div class="m-auto mt-20 grid w-full gap-3 md:w-2/3 lg:grid-cols-3">
      <x-core.cards.feature-card>
        ...
        <p>
          Buy/sell weapons, armor, rings and more to out fit your character for
          the road ahead. Who knows what beasties you might find!
        </p>
      </x-core.cards.feature-card>
      <x-core.cards.feature-card>
        <x-slot:icon>
        ...
        <p>
          Settle, Manage and wage war against other players! You can use Kingdom
          passives to train new skills to unlock new buildings and units that
          give your kingdoms even more power!
        </p>
      </x-core.cards.feature-card>
      <x-core.cards.feature-card>
        <x-slot:icon>
        ...
        <p>
          Set up automation and let the game do all the fighting for you! Come
          back later or do other actions and get rewards over time!
        </p>
      </x-core.cards.feature-card>
    </div>
    ...
    >
      ...
      <div class="text-center md:flex md:items-center md:text-left">
        <div>
          ...
          <p class="mb-10 text-gray-800 dark:text-gray-300">
            Adventure on a map by clicking the action buttons. Set sail from one
            port to the other, traverse to other planes of existence!
          </p>
    ...
    <div class="mx-auto mt-20 w-full text-center lg:w-2/4">
      ...
      <p class="mb-10 text-gray-800 dark:text-gray-300">
        This game is free. This game has one philosophy: You want it? Earn it!
        Every thing from the best gear, to the strongest kingdoms to ability to
        travel from one plane to the next is all only attainable by playing the
        game.
      </p>
    </div>
    ...
    >
      ...
      <div class="text-center md:flex md:items-center md:text-left">
        <div>
          ...
          <p class="mb-10 text-gray-800 dark:text-gray-300">
            Join together with other players to take down fearsom creatures that
            corrupte locations on the map and win epic rewards for being the
            first to slay the beast!
          </p>

          <p class="mb-10 text-gray-800 dark:text-gray-300">
            Raids are
            <a href="/information/events">scheduled</a>
            events that last for over a month and give players a chance to be
            the one who wins the
            <a href="/information/ancestral-items">Ancestral Item</a>
            the fiend drops! Raid Bosses will respawn one hour after death.
          </p>
    ...
    <div class="m-auto mt-20 grid w-full gap-3 md:w-2/3 lg:grid-cols-3">
      <x-core.cards.feature-card>
        ...
        <p>
          No need to gather. You can just start crafting! Find tomes to get xp
          bonuses!
        </p>
      </x-core.cards.feature-card>
      ...
      <x-core.cards.feature-card>
        ...
        <p>
          With over 400 enchantments, there isn't anything you can't make for
          your character!
        </p>
      </x-core.cards.feature-card>
      ...
      <x-core.cards.feature-card>
        ...
        <p>
          Buy and sell from the market board. Craft and Enchant items for others
          and make a profit!
        </p>
      </x-core.cards.feature-card>
    </div>
    ...
    <div class="m-auto mt-2 grid w-full gap-3 md:w-2/3 lg:grid-cols-3">
      <x-core.cards.feature-card>
        ...
        <p>
          Participate in Weekly Fights to unlock new content, earn epic items
          such as Mythics and Legandry items as well as Cosmic Items during
          specific events!
        </p>
      </x-core.cards.feature-card>
      <x-core.cards.feature-card>
        ...
        <p>
          New Player? The Guide will be auto enabled for you to help you
          navigate the world of Tlessa!
        </p>
      </x-core.cards.feature-card>
      <x-core.cards.feature-card>
        <x-slot:icon>
    ...
    <div class="m-auto mt-4 mb-8 w-full text-center md:w-2/3">
      ...
      <p class="mb-10 text-gray-800 italic dark:text-gray-300">
        Planes of tlessa has so many rich and diverse features its hard to
        showcase them all!
      </p>
      <div
        class="mr-auto ml-auto flex w-full justify-center text-center lg:w-1/3"
      >
        <x-core.buttons.link-buttons.success-button
          css="mr-2 mb-4"
    ...
    <div class="mx-auto mt-4 mt-10 mb-10 w-full lg:mt-0 lg:mt-20 lg:w-2/4">
      ...
      <dl class="mt-3 text-gray-800 dark:text-gray-300">
        ...
        <dd>
          Yes. You can start an exploration, move your units from one kingdom to
          the next or attack another kingdom. log out and come back later and it
          all ran for you behind the scenes.
        ...
        <dd>
          ...
          is your best bet for automation. It automates the whole fighting
          process so you can focus on other things like
          <a
        ...
        <dd>
          ...
          . These apply to action you do and time you out from doing that action
          again for a matter of seconds or minutes. However, the goal of Tlessa
          is not to keep you engaged, so for example you could: Fight, Craft,
          Move and then wait for their respective timers to end before doing the
          same thing. In the aforementioned example: Killing a monster gates you
          a 10-second time out before being able to kill the monster again, but
          being killed by said monster, gives you a 20-second time out before
          being able to revive.
        </dd>
        <dt>Are they're guilds?</dt>
        <dd>
          No. In Tlessa, it's every person for themselves. There is no guild or
          clan system in Tlessa.
        </dd>
      </dl>
    </div>
  </div>
