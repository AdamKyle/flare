<div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label for="race-dur-mod">Durabillity Modifier: </label>
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for="race-deffense-mod">Deffense Modifier: </label>
                ...
                @error('race.deffense_mod') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
        </div>
    </div>
</div>
