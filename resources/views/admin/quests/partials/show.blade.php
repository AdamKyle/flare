<div class="grid gap-4 lg:grid-cols-2">
  <div>
    <p class="mt-3 mb-3">
      This quest belongs to an NPC, whom you must be on the same place as to
      complete.
    </p>
    <p class="mb-3">
      To complete all a quest all you have to do is on the same plane, then
      click Quests tab, click the quest, click complete.
    </p>
    <p class="mb-3">
    ...
    <dl>
      ...
      @if ($quest->npc->must_be_at_same_location)
        ...
        <dd>
          ...
          (You will be moved to this location upon handing in the quest.)
        </dd>
      @endif
