    ...
    <x-core.layout.info-container>
        ...
        >
            <x-core.form-wizard.container
                action="{{ route('quest.store') }}"
                modelId="{{ !is_null($quest) ? $quest->id : 0 }}"
            ...
            >
                <x-core.form-wizard.tabs>
                    <x-core.form-wizard.tab
                        ...
                        secondaryTitle="Basic information about the quest."
                        isActive="true"
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-2"
                        primaryTitle="Requirements"
                        secondaryTitle="Quest requirements."
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-3"
                        primaryTitle="Rewards"
                        secondaryTitle="Quest rewards."
                    />
                </x-core.form-wizard.tabs>
                ...
                <x-core.form-wizard.contents>
                    <x-core.form-wizard.content target="tab-style-2-1" isOpen="true">
                        ...
                        <x-core.forms.key-value-select
                            :model="$quest"
                            label="Belongs To Raid (optional):"
                            modelKey="raid_id"
                            name="raid_id"
                            :options="$raids"
                        />
                        <x-core.forms.key-value-select
                            :model="$quest"
                            label="Belongs To NPC:"
                            modelKey="npc_id"
                            name="npc_id"
                            :options="$npcs"
                        />
                        <x-core.forms.quill-editor
                            type="normal"
                            :model="$quest"
                            label="Before Completion text:"
                            modelKey="before_completion_description"
                            name="before_completion_description"
                            quillId="before-completion-text"
                        />
                        <x-core.forms.quill-editor
                            type="normal"
                            :model="$quest"
                            label="After Completion text:"
                            modelKey="after_completion_description"
                            name="after_completion_description"
                            quillId="after-completion-text"
                        />
                    ...
                    <x-core.form-wizard.content target="tab-style-2-2">
                        ...
                        <x-core.forms.key-value-select
                            :model="$quest"
                            label="Secondary Required Item:"
                            modelKey="secondary_required_item"
                            name="secondary_required_item"
                            :options="$questItems"
                        />
                        ...
                        <x-core.forms.key-value-select
                            :model="$quest"
                            label="Parent Quest:"
                            modelKey="parent_quest_id"
                            name="parent_quest_id"
                            :options="$quests"
                        />
                        <x-core.forms.key-value-select
                            :model="$quest"
                            label="Only During Event (only for the parent):"
                            modelKey="only_for_event"
                            name="only_for_event"
                            :options="$eventTypes"
                        />
                        ...
                        <x-core.forms.key-value-select
                            :model="$quest"
                            label="Faction Map:"
                            modelKey="faction_game_map_id"
                            name="faction_game_map_id"
                            :options="$gameMaps"
                        />
                        <x-core.forms.input
                            :model="$quest"
                        ...
                        <x-core.forms.key-value-select
                            :model="$quest"
                            label="Npc To Assist:"
                            modelKey="assisting_npc_id"
                            name="assisting_npc_id"
                            :options="$npcs"
                        />
                        <x-core.forms.input
                            :model="$quest"
                            label="Fame Level Required:"
                        ...
                        <x-core.forms.input
                            :model="$quest"
                            label="Reincrnation Amount (Optional):"
                            modelKey="reincarnated_times"
                            name="reincarnated_times"
                        />
                    </x-core.form-wizard.content>
                    ...
                    <x-core.form-wizard.content target="tab-style-2-3">
                        ...
                        <x-core.forms.input
                            :model="$quest"
                            label="Gold Reward:"
                            modelKey="reward_gold"
                            name="reward_gold"
                        />
                        <x-core.forms.input
                            :model="$quest"
                            label="Gold Dust Reward:"
                            modelKey="reward_gold_dust"
                            name="reward_gold_dust"
                        />
                        <x-core.forms.input
                            :model="$quest"
                            label="Shards Reward:"
                            modelKey="reward_shards"
                            name="reward_shards"
                        />
                        ...
                        <x-core.forms.check-box
                            :model="$quest"
                            label="Unlocks skill?"
                            modelKey="unlocks_skill"
                            name="unlocks_skill"
                        />
                        <x-core.forms.key-value-select
                            :model="$quest"
                            label="Unlocks Skill Type: "
                            modelKey="unlocks_skill_type"
                            name="unlocks_skill_type"
                            :options="$skillTypes"
                        />
                        ...
                        <x-core.forms.key-value-select
                            :model="$quest"
                            label="Unlocks Feature Type: "
                            modelKey="unlocks_feature"
                            name="unlocks_feature"
                            :options="$unlocksFeatures"
                        />
                        ...
                        <x-core.forms.key-value-select
                            :model="$quest"
                            label="Unlocks Kingdom Passive: "
                            modelKey="unlocks_passive_id"
                            name="unlocks_passive_id"
