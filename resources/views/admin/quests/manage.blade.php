            ...
            <x-core.form-wizard.container action="{{route('quest.store')}}" modelId="{{!is_null($quest) ? $quest->id : 0}}" lastTab="tab-style-2-5">
                ...
                <x-core.form-wizard.contents>
                    <x-core.form-wizard.content target="tab-style-2-1" isOpen="true">
                        ...
                        <x-core.forms.quill-editor :model="$quest" label="Before Completion text:" modelKey="before_completion_description" name="before_completion_description" quillId="before-completion-text"/>
                        <x-core.forms.quill-editor :model="$quest" label="After Completion text:" modelKey="after_completion_description" name="after_completion_description" quillId="after-completion-text"/>
