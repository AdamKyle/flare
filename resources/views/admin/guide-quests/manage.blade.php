    ...
    <x-core.layout.info-container>
        ...
        >
            <x-core.form-wizard.container
                action="{{ route('admin.guide-quests.store') }}"
            ...
            >
                <x-core.form-wizard.tabs>
                    <x-core.form-wizard.tab
                        ...
                        secondaryTitle="Basic quest info."
                        isActive="true"
                    />
                    <x-core.form-wizard.tab
                    ...
                    <x-core.form-wizard.tab
                        ...
                        primaryTitle="Bonuses"
                        secondaryTitle="Bonuses"
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-4"
                        primaryTitle="Rewards"
                        secondaryTitle="Rewards"
                    />
                </x-core.form-wizard.tabs>
                ...
                <x-core.form-wizard.contents>
                    ...
                    >
                        ...
                        <x-core.forms.quill-editor
                            ...
                            name="instructions"
                            quillId="quest-instructions"
                        />
                        <x-core.forms.quill-editor
                            type="html"
                            :model="$guideQuest"
                            label="Desktop Instructions:"
                            modelKey="desktop_instructions"
                            name="desktop_instructions"
                            quillId="desktop-instructions"
                        />
                        <x-core.forms.quill-editor
                            type="html"
                            :model="$guideQuest"
                            label="Mobile Instructions:"
                            modelKey="mobile_instructions"
                            name="mobile_instructions"
                            quillId="mobile-instructions"
                        />
                        ...
                        <p class="mb-3">
                            When setting these values, these guide quests will
                            jump in regardless of where the player is In their
                            set of guide quests, these will over ride those and
                            make the player do the quests going down.
                        </p>
                        <p class="mb-3">
                            The quests that use these should be in the order of
                            Parent which unlocks during an event and/or at a
                            specific level and then any additional guide quests
                            that need to explain the specific feature or
                            features would set that quest as their parent.
                        </p>
                        <p class="mb-3">
                            Once the quests are done in the parent line then the
                            player is returned to the original set of guide
                            quests.
                        </p>
                        <x-core.forms.input
                            :model="$guideQuest"
                    ...
                    <x-core.form-wizard.content target="tab-style-2-2">
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <h3 class="mb-3">
                                    Required levels for completion
                                </h3>
                                <x-core.forms.input
                                    :model="$guideQuest"
                            ...
                            <div>
                                ...
                                <h3 class="mb-3">
                                    Required To Be (Physically) On Map
                                </h3>
                                <x-core.forms.key-value-select
                                    :model="$guideQuest"
