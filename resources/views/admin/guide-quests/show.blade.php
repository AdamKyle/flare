    ...
    <x-core.layout.info-container>
        ...
        <x-core.cards.card>
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <dl class="mb-5">
                        ...
                        @if (! is_null($guideQuest->required_event_goal_participation))
                            <dt>
                                Participate in the Event Goal and Kill # of
                                Creatures:
                            </dt>
                            <dd>
                        ...
                        @if (! is_null($guideQuest->required_kingdom_building_id))
                            <dt>
                                ...
                                {{ $guideQuest->kingdom_building_name }} to
                                level
                            </dt>
                            <dd>
                    ...
                    @if (! is_null($guideQuest->eventType()) || ! is_null($guideQuest->unlock_at_level))
                        <div class="my-4">
                            <x-core.alerts.info-alert
                                title="Event Specific Guide Quest!"
                            >
                                <p>
                                    This Guide quest is only available when it
                                    unlocks at a specific level, is used for an
                                    event or both.
                                </p>
                                <p class="my-2">
                                    These types of quests interrupt what the
                                    player was doing to introduce them to new
                                    features.
                                </p>
                                <div
                                    class="border-b-2 border-b-blue-300 dark:border-b-blue-600 my-3"
                                ></div>
                                <dl>
                ...
                <div>
                    <div
                        class="border-1 rounded-sm p-2 bg-slate-300 dark:bg-slate-700 max-h-[250px] overflow-x-auto mb-4"
                    >
                    ...
                    <div
                        class="border-1 rounded-sm p-2 bg-slate-300 dark:bg-slate-700 max-h-[250px] overflow-x-auto"
                    >
