                ...
                <x-core.form-wizard.contents>
                    <x-core.form-wizard.content target="tab-style-2-1" isOpen="true">
                        ...
                        <p class="mb-3 text-sm italic">
                            Items of this "specialty type" will drop at random for players when the raid completes. It
                            is ideal to have multiple items, usually weapons and armour of this type to drop.
                        </p>
                        <x-core.forms.select
                            :model="$raid"
