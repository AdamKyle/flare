                ...
                <x-core.form-wizard.contents>
                    ...
                    >
                        ...
                        <p class="mb-3 italic text-sm">
                            Items of this "specialty type" will drop at random
                            for players when the raid completes. It is ideal to
                            have multiple items, usually weapons and armour of
                            this type to drop.
                        </p>
                        <x-core.forms.select
                            :model="$raid"
                        ...
                        <p class="mb-3 italic text-sm">
                            This item will be rewarded to the one that kills the
                            Raid Boss
                        </p>
                        <x-core.forms.collection-select
                            :model="$raid"
