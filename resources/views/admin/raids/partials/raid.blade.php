<x-core.layout.info-container>
    ...
    >
        ...
        <p class="my-4">
            <a href="/information/monster/{{ $raid->raid_boss_id }}" target="_blank">
                <i class="fas fa-external-link-alt"></i>
                {{ $raid->raidBoss->name }}
            </a>
            who you will find at
            <a href="/information/location/{{ $raid->raid_boss_location_id }}" target="_blank">
                <i class="fas fa-external-link-alt"></i>
        ...
        <p class="my-4">This item is only given to those who kill the Raid Boss.</p>
        <p class="my-4">
            <a href="/information/item/{{ $raid->artifact_item_id }}" target="_blank">
                <i class="fas fa-external-link-alt"></i>
                ...
                <div>
                    <ul class="ml-8 list-disc">
                        @foreach ($raidMonsterChunk as $monster)
                            <li>
                                <a href="/information/monster/{{ $monster['id'] }}" target="_blank">
                                    <i class="fas fa-external-link-alt"></i>
                                    {{ $monster['name'] }}
                                </a>
                            </li>
        ...
        <p>
            These items will drop when the raid is completed. Players will get one item, at random, so long as they are
            in the top twenty Five damage dealers to the raid boss
        </p>
    </x-core.cards.card-with-title>
</x-core.layout.info-container>
