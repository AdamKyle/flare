    ...
    <x-core.layout.info-container>
        ...
        >
            <x-core.form-wizard.container
                action="{{ route('affixes.store') }}"
                modelId="{{ !is_null($itemAffix) ? $itemAffix->id : 0 }}"
            ...
            >
                <x-core.form-wizard.tabs>
                    <x-core.form-wizard.tab
                        ...
                        secondaryTitle="Basic information about the affix."
                        isActive="true"
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-2"
                        primaryTitle="Stats & Modifiers"
                        secondaryTitle="Stats and modifiers."
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-3"
                        primaryTitle="Skill Effects"
                        secondaryTitle="Skill Details."
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-4"
                        primaryTitle="Effects"
                        secondaryTitle="Other effects."
                    />
                    <x-core.form-wizard.tab
                        ...
                        <div class="grid gap-2 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Class Bonus:"
                                    modelKey="class_bonus"
                                    name="base_heaclass_bonusling_mod"
                                />
                            </div>
                        </div>
                    </x-core.form-wizard.content>
                            ...
                            <div>
                                ...
                                <div class="mt-4 mb-4">
                                    <x-core.alerts.info-alert title="ATTN!">
                                        The logic states that prefixes can reduce all stats and do not stack, while
                                        suffixes can reduce individual stats and do stack.
                                    </x-core.alerts.info-alert>
                                </div>
                                <x-core.forms.check-box
                                    :model="$itemAffix"
                                    label="Can Reduce Enemy Stats?"
                                    modelKey="reduces_enemy_stats"
                                    name="reduces_enemy_stats"
                                />
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Str Reduction (%):"
                                    modelKey="str_reduction"
                                    name="str_reduction"
                                />
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Dex Reduction (%):"
                                    modelKey="dex_reduction"
                                    name="dex_reduction"
                                />
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Dur Reduction (%):"
                                    modelKey="dur_reduction"
                                    name="dur_reduction"
                                />
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Agi Reduction (%):"
                                    modelKey="agi_reduction"
                                    name="agi_reduction"
                                />
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Int Reduction (%):"
                                    modelKey="int_reduction"
                                    name="int_reduction"
                                />
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Chr Reduction (%):"
                                    modelKey="chr_reduction"
                                    name="chr_reduction"
                                />
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Focus Reduction (%):"
                                    modelKey="focus_reduction"
                                    name="focus_reduction"
                                />
                            </div>
                            <div class="my-6 block border-b-2 border-b-gray-300 md:hidden dark:border-b-gray-600"></div>
                            <div>
                                ...
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Enemy Resistance Reduction (%):"
                                    modelKey="resistance_reduction"
                                    name="resistance_reduction"
                                />
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Enemy Skill Reduction (%):"
                                ...
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Steal Life (%):"
                                    modelKey="steal_life_amount"
                                    name="steal_life_amount"
                                />
                                <x-core.forms.input
                                    :model="$itemAffix"
                                    label="Entrance Chance (%):"
                                    modelKey="entranced_chance"
                                    name="entranced_chance"
                                />
                                ...
                                <x-core.forms.check-box
                                    :model="$itemAffix"
                                    label="Is Damage Irresistible?"
                                    modelKey="irresistible_damage"
                                    name="irresistible_damage"
                                />
                                <x-core.forms.check-box
                                    :model="$itemAffix"
                                    label="Can Damage Stack?"
                                    modelKey="damage_can_stack"
                                    name="damage_can_stack"
                                />
                            </div>
                        </div>
                    </x-core.form-wizard.content>
