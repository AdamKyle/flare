    ...
    <x-core.layout.info-container>
                    ...
                    <div>
                        ...
                        <dl>
                            ...
                            @if ($itemAffix->base_healing_mod > 0)
                                ...
                                <dd>
                                    {{ $itemAffix->base_healing_mod * 100 }}%
                                </dd>
                            @endif
                        </dl>
                    </div>
                ...
                <div>
                    ...
                    <dl>
                        ...
                        @if ($itemAffix->skill_training_bonus > 0)
                            ...
                            <dd>
                                {{ $itemAffix->skill_training_bonus * 100 }}%
                            </dd>
                        @endif
        ...
        @if ($itemAffix->damage_amount > 0)
            <x-core.cards.card-with-title title="Damage Info" buttons="false">
                <x-core.alerts.warning-alert title="ATTN!">
                    <p class="my-2">
                        Some damage-based affixes can stack - which is outlined
                        below. Those that do stack have a chance to be resisted
                        by the enemy.
                    </p>
                    <p class="mb-2">
                        Those that do not stack are irresistible and cannot be
                        blocked.
                    </p>
        ...
        @if (! is_null($itemAffix->steal_life_amount))
            <x-core.cards.card-with-title title="Life Stealing" buttons="false">
                <x-core.alerts.warning-alert title="ATTN!">
                    These affixes will only stack for Vampire classes. For other
                    classes, the Lifestealing Affix attached will be used.
                    Durability stacks for all classes.
                </x-core.alerts.warning-alert>
                <dl>
        ...
        @if ($itemAffix->entranced_chance > 0)
            ...
            >
                <x-core.alerts.warning-alert title="ATTN!">
                    These Affixes will not stack. Entrancing the enemy makes it
                    so your attack cannot be blocked and will not miss.
                </x-core.alerts.warning-alert>
                <dl>
        ...
        @if ($itemAffix->devouring_light > 0)
            ...
            >
                <x-core.alerts.warning-alert title="ATTN!">
                    Devouring light prevents enemies from using enchantments and
                    life stealing, and prevents them from voiding your
                    enchantments.
                </x-core.alerts.warning-alert>
                <dl>
        ...
        @if ($itemAffix->skill_reduction > 0)
            ...
            >
                <x-core.alerts.warning-alert title="ATTN!">
                    These affixes reduce enemy skills like Accuracy, Dodge,
                    Casting Accuracy, and Criticality.
                </x-core.alerts.warning-alert>
                <dl>
        ...
        @if ($itemAffix->resistance_reduction > 0)
            ...
            >
                <x-core.alerts.warning-alert title="ATTN!">
                    These affixes reduce specific resistances, making it easier
                    for certain abilities to land.
                </x-core.alerts.warning-alert>
                <dl>
