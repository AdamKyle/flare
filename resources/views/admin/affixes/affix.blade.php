    ...
    <x-core.layout.info-container>
        ...
        @if ($itemAffix->damage_amount > 0)
            <x-core.cards.card-with-title title="Damage Info" buttons="false">
                <x-core.alerts.warning-alert title="ATTN!">
                    <p class="my-2">
                        Some damage-based affixes can stack - which is outlined below. Those that do stack have a chance
                        to be resisted by the enemy.
                    </p>
        ...
        @if (! is_null($itemAffix->steal_life_amount))
            <x-core.cards.card-with-title title="Life Stealing" buttons="false">
                <x-core.alerts.warning-alert title="ATTN!">
                    These affixes will only stack for Vampire classes. For other classes, the Lifestealing Affix
                    attached will be used. Durability stacks for all classes.
                </x-core.alerts.warning-alert>
                <dl>
        ...
        @if ($itemAffix->entranced_chance > 0)
            <x-core.cards.card-with-title title="Entrance Chance" buttons="false">
                <x-core.alerts.warning-alert title="ATTN!">
                    These Affixes will not stack. Entrancing the enemy makes it so your attack cannot be blocked and
                    will not miss.
                </x-core.alerts.warning-alert>
                <dl>
        ...
        @if ($itemAffix->devouring_light > 0)
            <x-core.cards.card-with-title title="Devouring Light" buttons="false">
                <x-core.alerts.warning-alert title="ATTN!">
                    Devouring light prevents enemies from using enchantments and life stealing, and prevents them from
                    voiding your enchantments.
                </x-core.alerts.warning-alert>
                <dl>
