    ...
    <x-core.layout.info-container>
        ...
        >
            <x-form-wizard.step stepTitle="Basic Info">
                <x-form-elements.input :model="$item" label="Name:" modelKey="name" name="name" />
                <x-form-elements.select :model="$item" label="Type:" modelKey="type" name="type" :options="$types" />
                ...
                <h2 class="mb-4 text-center text-lg">Item Cost Info</h2>
                ...
                />
                <x-form-elements.input :model="$item" label="Gold Cost:" modelKey="cost" name="cost" />
                <x-form-elements.input :model="$item" label="Shards Cost:" modelKey="shards_cost" name="shards_cost" />
            ...
            <x-form-wizard.step step-title="State Info">
                <x-form-elements.input :model="$item" label="Str Modifier (%):" modelKey="str_mod" name="str_mod" />
                <x-form-elements.input :model="$item" label="Dex Modifier (%):" modelKey="dex_mod" name="dex_mod" />
                <x-form-elements.input :model="$item" label="Dur Modifier (%):" modelKey="dur_mod" name="dur_mod" />
                <x-form-elements.input :model="$item" label="Agi Modifier (%):" modelKey="agi_mod" name="agi_mod" />
                <x-form-elements.input :model="$item" label="Int Modifier (%):" modelKey="int_mod" name="int_mod" />
                <x-form-elements.input :model="$item" label="Chr Modifier (%):" modelKey="chr_mod" name="chr_mod" />
                <x-form-elements.input
                    :model="$item"
                ...
                <h2 class="mb-4 text-center text-lg">Item Cost Info</h2>
                <x-core.separator.separator />
                <x-form-elements.input :model="$item" label="Base Attack:" modelKey="base_damage" name="base_damage" />
                <x-form-elements.input :model="$item" label="Base AC:" modelKey="base_ac" name="base_ac" />
                <x-form-elements.input
                    :model="$item"
                    label="Base healing:"
            ...
            <x-form-wizard.step step-title="Modifier">
                ...
                <h2 class="mb-4 text-center text-lg">Resurrection Chance</h2>
                <x-form-elements.check-box
                    :model="$item"
                    label="Can Ressurect?"
                ...
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Xp Modifiers</h2>
                <x-form-elements.input :model="$item" label="XP Bonus (%):" modelKey="xp_bonus" name="xp_bonus" />
                <x-form-elements.check-box
                    :model="$item"
                ...
                <h2 class="mb-4 text-center text-lg">Enemy Reductions</h2>
                <x-form-elements.input
                    :model="$item"
                    label="Spell Evasion (%):"
                ...
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Devouring Light/Darkness</h2>
                <x-form-elements.input
                    :model="$item"
            ...
            <x-form-wizard.step step-title="Crafting Info">
                <x-form-elements.check-box :model="$item" label="Can Craft?" modelKey="can_craft" name="can_craft" />
                <x-form-elements.check-box
                    :model="$item"
                ...
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Holy Level</h2>
                <x-form-elements.input :model="$item" label="Holy Level:" modelKey="holy_level" name="holy_level" />
            </x-form-wizard.step>
            <x-form-wizard.step step-title="Special Effects">
                ...
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Class to unlock</h2>
                ...
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Specialty Type</h2>
                <x-form-elements.select
                    :model="$item"
                ...
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Skill Tree (Parent Skill)</h2>
                ...
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Drop Location</h2>
                <x-form-elements.collection-select
                    :model="$item"
                    label="Drops From:"
                ...
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Effects Skill</h2>
                <x-form-elements.select
                    :model="$item"
                    label="Skill:"
                    modelKey="skill_name"
                    ...
                    :options="$skills"
                />
                <x-form-elements.input :model="$item" label="Skill Bonus:" modelKey="skill_bonus" name="skill_bonus" />
                <x-form-elements.input
                    :model="$item"
            ...
            <x-form-wizard.step step-title="Alchemy Info (Usable)">
                <x-form-elements.check-box :model="$item" label="Usable?" modelKey="usable" name="usable" />
                <x-form-elements.check-box
                    :model="$item"
                ...
                <h2 class="mb-4 text-center text-lg">Skill Info</h2>
                <x-form-elements.key-value-select
                    :model="$item"
                    label="Type:"
