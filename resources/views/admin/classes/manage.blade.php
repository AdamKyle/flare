        ...
        >
            <x-core.form-wizard.container action="{{route('classes.store')}}" modelId="{{!is_null($class) ? $class->id : 0}}" lastTab="tab-style-2-5">
                <x-core.form-wizard.tabs>
                    ...
                    <x-core.form-wizard.tab target="tab-style-2-3" primaryTitle="Class Rank Info" secondaryTitle="How players can unlock the class."/>
                </x-core.form-wizard.tabs>
                <x-core.form-wizard.contents>
                    ...
                    <x-core.form-wizard.content target="tab-style-2-3">
                        ...
                        <x-core.forms.key-value-select :model="$class" label="Primary Class Required:" modelKey="primary_required_class_id" name="primary_required_class_id" :options="$classes"/>
                        <x-core.forms.key-value-select :model="$class" label="Secondary Class Required:" modelKey="secondary_required_class_id" name="secondary_required_class_id" :options="$classes"/>
                        <x-core.forms.input :model="$class" label="Primary Class Level Required:" modelKey="primary_required_class_level" name="primary_required_class_level" />
                        <x-core.forms.input :model="$class" label="Secondary Class Level Required:" modelKey="secondary_required_class_level" name="secondary_required_class_level" />
                    </x-core.form-wizard.content>
                </x-core.form-wizard.contents>
