...
@if (! is_null($monster->fire_atonement) && ! is_null($monster->ice_atonement) && ! is_null($monster->water_atonement))
    <x-core.cards.card-with-title title="Elemental Atunement">
        <p class="mb-3">
            ...
            element the critter is, which means tier elemental attack will be of
            that type. If your elemental atunement is the oppisite, for example
            Water is oppisite to Fire, you will only take half the damage, If
            your element is weak against their, ie: They are fire, you are ice,
            you will take twice the amount of damage.
        </p>
