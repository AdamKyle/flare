    ...
    <x-core.layout.info-container>
        ...
        >
            <x-form-wizard.step step-title="Basic Info">
                <x-form-elements.input :model="$monster" label="Name:" modelKey="name" name="name" type="text" />
                <x-form-elements.input :model="$monster" label="Max Level:" modelKey="max_level" name="max_level" />
                ...
                <h2 class="mb-4 text-center text-lg">Basic Stats</h2>
                <x-core.separator.separator />
                ...
                />
                <x-form-elements.input :model="$monster" label="Str:" modelKey="str" name="str" />
                <x-form-elements.input :model="$monster" label="Dex:" modelKey="dex" name="dex" />
                <x-form-elements.input :model="$monster" label="Dur:" modelKey="dur" name="dur" />
                <x-form-elements.input :model="$monster" label="Agi:" modelKey="agi" name="agi" />
                <x-form-elements.input :model="$monster" label="Int:" modelKey="int" name="int" />
                <x-form-elements.input :model="$monster" label="Chr:" modelKey="chr" name="chr" />
                <x-form-elements.input :model="$monster" label="Focus:" modelKey="focus" name="focus" />
            </x-form-wizard.step>
            <x-form-wizard.step step-title="Skills">
                <x-form-elements.input :model="$monster" label="Accuracy (%):" modelKey="accuracy" name="accuracy" />
                ...
                />
                <x-form-elements.input :model="$monster" label="Dodge (%):" modelKey="dodge" name="dodge" />
                <x-form-elements.input
                    :model="$monster"
                    label="Criticality (%):"
            ...
            <x-form-wizard.step step-title="Attack, Health & Armour">
                ...
                <x-form-elements.input
                    ...
                    name="attack_range"
                />
                <x-form-elements.input :model="$monster" label="Armour Class:" modelKey="ac" name="ac" />
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Spell Damage (Optional)</h2>
                <x-core.separator.separator />
                <x-form-elements.check-box :model="$monster" label="Can Cast?" modelKey="can_cast" name="can_cast" />
                <x-form-elements.input
                    :model="$monster"
            ...
            <x-form-wizard.step step-title="Elemental Atonement">
                <p class="mb-3">
                    This allows creatures to have elemental atonements, the highest value is used for attack. This
                    should only be used for raid creatures, where characters have to make use of gems. This can also be
                    used for other server side fight creatures.
                </p>
                <x-form-elements.input
                    :model="$monster"
            ...
            <x-form-wizard.step step-title="Raid Details (Optional)">
                ...
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Belongs to specific location? (Optional)</h2>
                <p class="text-center">
                    This monster can only be fought at a specific location which shares the same selected type as below.
                </p>
                <x-core.separator.separator />
            ...
            <x-form-wizard.step step-title="Rewards">
                <x-form-elements.input :model="$monster" label="XP Per Kill:" modelKey="xp" name="xp" />
                <x-form-elements.input :model="$monster" label="Gold Per Kill:" modelKey="gold" name="gold" />
                <x-form-elements.input
                    :model="$monster"
                    label="Drop Check (%):"
                    modelKey="drop_check"
                ...
                />
                <x-core.separator.separator />
                <h2 class="mb-4 text-center text-lg">Quest item Reward? (Optional)</h2>
                <x-core.separator.separator />
                <x-form-elements.collection-select
                    :model="$monster"
