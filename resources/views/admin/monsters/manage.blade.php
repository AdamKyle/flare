            ...
            >
                <x-core.form-wizard.tabs>
                    <x-core.form-wizard.tab
                        ...
                        secondaryTitle="Basic monster info."
                        isActive="true"
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-2"
                        primaryTitle="Resistances"
                        secondaryTitle="Resistances against player actions."
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-3"
                        primaryTitle="Modifiers"
                        secondaryTitle="Misc modifiers."
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-4"
                        primaryTitle="Ambush & Counter"
                        secondaryTitle="Ambush and Counter"
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-5"
                        primaryTitle="Quest Item"
                        secondaryTitle="Monsters quest item."
                    />
                </x-core.form-wizard.tabs>
                    ...
                    >
                        <div class="grid md:grid-cols-2 gap-2">
                            <div>
                                ...
                                <p
                                    class="mb-3 text-sm text-gray-800 dark:text-gray-300"
                                >
                                ...
                                />
                                <h3>
                                    Belongs to specific location? (Optional)
                                </h3>
                                <p>
                                    This monster can only be fought at a
                                    specific location which shares the same
                                    selected type as below.
                                </p>
                                <x-core.forms.key-value-select
                                    :model="$monster"
                            ...
                            <div>
                                ...
                                <x-core.forms.key-value-select
                                    :model="$monster"
                                    label="Celestial Type (Optional):"
                                    modelKey="celestial_type"
                                    name="celestial_type"
                                    :options="$celestialTypes"
                                />
                                <x-core.forms.input
                                    :model="$monster"
                    ...
                    <x-core.form-wizard.content target="tab-style-2-3">
                        <div class="grid md:grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <p class="mb-3">
                                    This allos creatures to have elemental
                                    atonements, the highest value is used for
                                    attack. This should only be used for raid
                                    creatures, where characters have to make use
                                    of gems. This can also be used for other
                                    server side fight creatures.
                                </p>
                                <x-core.forms.input
                                    :model="$monster"
