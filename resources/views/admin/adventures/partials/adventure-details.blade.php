...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="adventure-item-reward"> Reward Item : <span class="danger">*</span> </label>
            <select class="custom-select form-control required" id="adventure-item-reward" name="reward_item_id">
