<x-core.layout.info-container>
    ...
    >
        <div class="grid md:grid-cols-2 gap-2">
            <div>
                <img src="{{$mapUrl}}" width="500" class="shadow rounded max-w-full h-auto align-middle border-none img-fluid"/>
            </div>
            <div>
                ...
                @if ($map->mapType()->isPurgatory())
                    ...
                    <x-core.alerts.info-alert title="ATTN!">
                        You need to be a location in Hell to access this place. See above to see the location you need to be at.
