        ...
        >
            <x-core.form-wizard.container action="{{route('buildings.store')}}" modelId="{{!is_null($building) ? $building->id : 0}}" lastTab="tab-style-2-5">
                <x-core.form-wizard.tabs>
                    <x-core.form-wizard.tab target="tab-style-2-1" primaryTitle="Basic Info" secondaryTitle="Basic building info." isActive="true"/>
                    <x-core.form-wizard.tab target="tab-style-2-2" primaryTitle="Upgrade Costs" secondaryTitle="Building Upgrade Costs"/>
                    <x-core.form-wizard.tab target="tab-style-2-3" primaryTitle="Gain Upon Upgrade" secondaryTitle="What does the building get when upgraded?"/>
                    <x-core.form-wizard.tab target="tab-style-2-4" primaryTitle="Unit Recruiment (Optional)" secondaryTitle="When the building can recruit units."/>
                </x-core.form-wizard.tabs>
                    ...
                    <x-core.form-wizard.content target="tab-style-2-1" isOpen="true">
                        <div class="grid md:grid-cols-2 gap-2">
                            <div>
                                ...
                                <x-core.forms.check-box :model="$building" label="Are we a wall?" modelKey="is_wall" name="is_wall" />
                                <x-core.forms.check-box :model="$building" label="Are we a Farm?" modelKey="is_farm" name="is_farm" />
                                <x-core.forms.check-box :model="$building" label="Are we a Church?" modelKey="is_church" name="is_church" />
                    ...
                    <x-core.form-wizard.content target="tab-style-2-3">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-core.forms.input :model="$building" label="Increase To Wood:" modelKey="increase_wood_amount" name="increase_wood_amount" type="text"/>
                                <x-core.forms.input :model="$building" label="Increase To Clay:" modelKey="increase_clay_amount" name="increase_clay_amount" type="text"/>
                                <x-core.forms.input :model="$building" label="Increase To Stone:" modelKey="increase_stone_amount" name="increase_stone_amount" type="text"/>
                                <x-core.forms.input :model="$building" label="Increase To Iron:" modelKey="increase_iron_amount" name="increase_iron_amount" type="text"/>
                            </div>
                            <div class='border-b-2 block md:hidden border-b-gray-300 dark:border-b-gray-600 my-6'></div>
                            <div>
                                <h3 class="mb-3">Building Gains</h3>
                                <x-core.forms.input :model="$building" label="Increase To Durability:" modelKey="increase_durability_amount" name="increase_durability_amount" type="text"/>
                                <x-core.forms.input :model="$building" label="Increase To Defence:" modelKey="increase_defence_amount" name="increase_defence_amount" type="text"/>
                            </div>
                        </div>
                    </x-core.form-wizard.content>

                    <x-core.form-wizard.content target="tab-style-2-4">
                        <x-core.forms.check-box :model="$building" label="Can Train Units?" modelKey="trains_units" name="trains_units" />
                        <x-core.forms.collection-select-no-model label="Units to recruit"
                        ...
                        />
                        <x-core.forms.input :model="$building" label="Units Per Level:" modelKey="units_per_level" name="units_per_level" type="text"/>
                        <x-core.forms.input :model="$building" label="Unit At Only Level:" modelKey="only_at_level" name="only_at_level" type="text"/>
                    </x-core.form-wizard.content>
                </x-core.form-wizard.contents>
