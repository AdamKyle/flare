        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <x-core.alerts.info-alert title="Cost Calculation">
                    <p>
                        Below is the cost for one level, that is from level 1 to level 2. For every level past that, its
                        the
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div>
                <x-core.alerts.info-alert title="Resource Calculation">
                    <p>
                        Below is what you would get at level 1, should this building provide resources. For every level
                        past that, for example level 2, it would be:
            ...
            <div>
                <x-core.alerts.info-alert title="Morale Calculation">
                    <p>
                        ...
                        and the building decreases the morale.
                    </p>
                </x-core.alerts.info-alert>
                <dl>
                    <dd>
