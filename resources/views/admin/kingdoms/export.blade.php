...
@section('content')
    <x-core.layout.info-container>
        <x-core.cards.card-with-title title="Export Kingdom Data" buttons="true" backUrl="{{ route('home') }}">
            <x-core.alerts.warning-alert title="ATTN!">
                <p class="mt-4 mb-4">
                    Export both buildings, units and the building -> unit relationships. It is not suggested you make
                    edits to these excell files.
                </p>
