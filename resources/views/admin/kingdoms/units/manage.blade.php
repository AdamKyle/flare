    ...
    <x-core.layout.info-container>
        ...
        >
            <x-core.form-wizard.container
                ...
                modelId="{{!is_null($unit) ? $unit->id : 0}}"
                lastTab="tab-style-2-2"
            >
                <x-core.form-wizard.tabs>
                    <x-core.form-wizard.tab
                        target="tab-style-2-1"
                        primaryTitle="Basic Info"
                        secondaryTitle="Basic unit info."
                        isActive="true"
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-2"
                        primaryTitle="Resource Costs"
                        secondaryTitle="Resources Costs per unit"
                    />
                </x-core.form-wizard.tabs>
                        ...
                        <div class="grid md:grid-cols-1 gap-2">
                            <div>
                                ...
                                <x-core.forms.input
                                    ...
                                    modelKey="reduces_morale_by"
                                    name="reduces_morale_by"
                                    type="number"
                                />
                                ...
                                <p class="mb-3 text-sm">
                                    Special units cannot be purchased with gold.
                                </p>
                                <x-core.forms.check-box
                                    :model="$unit"
                                    label="Special?"
                                ...
                                <x-core.forms.check-box
                                    ...
                                    modelKey="can_not_be_healed"
                                    name="can_not_be_healed"
                                />
                                ...
                                ></div>
                                <h3 class="mb-3">
                                    Time to Recruit (per 1 unit in seconds)
                                </h3>
                                <x-core.forms.input
                                    :model="$unit"
                                    label="Time to Recruit:"
                                    modelKey="time_to_recruit"
                                    name="time_to_recruit"
                                    type="number"
                                />
                            </div>
                        </div>
