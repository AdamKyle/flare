    ...
    <x-core.layout.info-container>
        @php
            ...
            if (!auth()->user()->hasRole('Admin')) {
                $backUrl = '/information/class-specials';
            }
        @endphp
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div>
                        ...
                        <p>
                            The damage to this specialty will be done only after your attack, with a weapon
                            lands. That is: Attack, Cast and Attack or Attack and Cast will fire off the damage
                            of this specialty if: your attack lands and is not blocked.
                        </p>
                        <div class='border-b-2 border-b-gray-300 dark:border-b-gray-600 my-6'></div>
                        <dl>
                            ...
                            <dd>{{!is_null($classSpecial->increase_specialty_damage_per_level) ? $classSpecial->increase_specialty_damage_per_level : 0}}</dd>
