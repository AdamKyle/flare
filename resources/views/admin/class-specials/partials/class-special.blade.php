        ...
        <div>
            ...
            <div class="grid grid-cols-2 gap-2">
                <div>
                    ...
                    <p>
                        The damage to this specialty will be done only after
                        your attack, with a weapon lands. That is: Attack, Cast
                        and Attack or Attack and Cast will fire off the damage
                        of this specialty if: your attack lands and is not
                        blocked.
                    </p>
                    <div
                        class="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-6"
                    ...
                    <p>
                        This will be applied to your spell evasion, which comes
                        primarily from rings.
                    </p>
                    <div
                        class="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-6"
                    ></div>
                ...
                <div
                    class="border-b-2 block lg:hidden border-b-gray-300 dark:border-b-gray-600 my-6"
                ></div>
                <div>
                    <h3>Modifiers</h3>
                    <div
                    ...
                    <dl>
                        ...
                        <dd>
                            {{ $classSpecial->affix_damage_reduction * 100 }}%
                        </dd>
                        ...
                        <dd>
                            {{ $classSpecial->resistance_reduction * 100 }}%
                        </dd>
                    </dl>
                </div>
            </div>
