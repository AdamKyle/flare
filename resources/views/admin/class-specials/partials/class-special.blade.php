<x-core.layout.info-container>
    ...
    >
        <div>
            <p class="my-4">{{ $classSpecial->description }}</p>
            <div class="grid grid-cols-2 gap-2">
                <div>
                    ...
                    <p>
                        The damage to this specialty will be done only after your attack, with a weapon lands. That is:
                        Attack, Cast and Attack or Attack and Cast will fire off the damage of this specialty if: your
                        attack lands and is not blocked.
                    </p>
                    <div class="my-6 border-b-2 border-b-gray-300 dark:border-b-gray-600"></div>
                    <dl>
                    ...
                    <p>This will be applied to your spell evasion, which comes primarily from rings.</p>
                    <div class="my-6 border-b-2 border-b-gray-300 dark:border-b-gray-600"></div>
                    <dl class="mb-4">
                        <dt>Spell Evasion</dt>
                ...
                <div class="my-6 block border-b-2 border-b-gray-300 lg:hidden dark:border-b-gray-600"></div>
                <div>
                    <h3>Modifiers</h3>
                    <div class="my-6 border-b-2 border-b-gray-300 dark:border-b-gray-600"></div>
                    <dl class="mb-4">
