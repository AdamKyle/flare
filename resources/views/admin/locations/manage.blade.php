    ...
    <x-core.layout.info-container>
        ...
        >
            <x-form-wizard.step stepTitle="Basic Info">
                <x-form-elements.input :model="$location" label="Name:" modelKey="name" name="name" />
                ...
                <x-form-elements.input
                    :model="$location"
                    label="Time Between Delve Fights (Minutes):"
                    modelKey="minutes_between_delve_fights"
                    name="minutes_between_delve_fights"
                />
            </x-form-wizard.step>
