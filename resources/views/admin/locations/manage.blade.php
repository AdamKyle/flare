...
@section('content')
    <x-core.layout.info-container>
        <x-core.cards.card-with-title
            ...
            <x-core.form-wizard.container action="{{ route('locations.store') }}"
                modelId="{{ !is_null($location) ? $location->id : 0 }}" lastTab="tab-style-2-1">
                    ...
                    <x-core.form-wizard.content target="tab-style-2-1" isOpen="true">
                        <div class="grid md:grid-cols-2 gap-2">
                            <div>
                                ...
                                <x-core.forms.text-area :model="$location" label="Description:" modelKey="description"
                                    name="description" />
                                ...
                                <x-core.forms.check-box :model="$location" label="Can players enter this location?"
                                    modelKey="can_players_enter" name="can_players_enter" />
                                <x-core.forms.check-box :model="$location" label="Can players Auto Battle at this location?"
                                    modelKey="can_auto_battle" name="can_auto_battle" />
                                <x-core.forms.select :model="$location" label="X Position:" modelKey="x" name="x"
                                    :options="$coordinates['x']" />
                                <x-core.forms.select :model="$location" label="Y Position:" modelKey="y" name="y"
                            ...
                            <div>
                                ...
                                <x-core.forms.key-value-select :model="$location" label="Location Type:" modelKey="type"
                                    name="type" :options="$locationTypes" />
                                <x-core.forms.key-value-select :model="$location" label="Enemy Strength Increase(%):"
