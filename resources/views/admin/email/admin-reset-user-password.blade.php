@include('flare.email.partials.header')
    ...
    <p style="font-size: 16px; color: #404040">
        Hello, You recently requested the administrator to reset your password. You may do so below.
    </p>
    <div class="sm-h-8" style="line-height: 24px">&zwnj;</div>
    <a href="{{route('password.reset', $token)}}" class="hover-bg-blue-600" style="text-decoration: none; display: inline-block; border-radius: 4px; background-color: #4d7c0f; padding: 20px 24px; font-size: 14px; font-weight: 600; text-transform: uppercase; line-height: 1; color: #fff">
