    ...
    <x-core.layout.info-container>
        ...
        >
            <x-core.form-wizard.container
                ...
                modelId="{{ !is_null($skill) ? $skill->id : 0 }}"
            ...
            >
                <x-core.form-wizard.tabs>
                    <x-core.form-wizard.tab
                        ...
                        secondaryTitle="Basic information about the skill."
                        isActive="true"
                    />
                    <x-core.form-wizard.tab
                        target="tab-style-2-2"
                        primaryTitle="Modifiers"
                        secondaryTitle="Setup modifiers for the skill."
                    />
                </x-core.form-wizard.tabs>
                        ...
                        <div class="grid gap-2 md:grid-cols-2">
                            <div>
                                ...
                                <x-core.forms.input
                                    ...
                                    modelKey="base_damage_mod_bonus_per_level"
                                    name="base_damage_mod_bonus_per_level"
                                />
                                <x-core.forms.input
                                    :model="$skill"
                                    label="Base Healing Modifier % (per level):"
                                    modelKey="base_healing_mod_bonus_per_level"
                                    name="base_healing_mod_bonus_per_level"
                                />
                                <x-core.forms.input
                                    :model="$skill"
                                    label="Base AC Modifier % (per level):"
                                    modelKey="base_ac_mod_bonus_per_level"
                                    name="base_ac_mod_bonus_per_level"
                                />
                                ...
                                <x-core.forms.input
                                    ...
                                    modelKey="fight_time_out_mod_bonus_per_level"
                                    name="fight_time_out_mod_bonus_per_level"
                                />
                                <x-core.forms.input
                                    :model="$skill"
                                    label="Move Timeout Reduction % (per level):"
                                    modelKey="move_time_out_mod_bonus_per_level"
                                    name="move_time_out_mod_bonus_per_level"
                                />
                                ...
                                <x-core.forms.input
                                    :model="$skill"
                                    label="Skill Bonus Per Level (per level):"
                                    modelKey="skill_bonus_per_level"
                            ...
                            <div>
                                ...
                                <x-core.forms.input
                                    :model="$skill"
                                    label="Unit Recruitment Time Reduction % (per level):"
                                    modelKey="unit_time_reduction"
                                    name="unit_time_reduction"
                                />
                                <x-core.forms.input
                                    :model="$skill"
                                    label="Building Time Reduction % (per level):"
                                    modelKey="building_time_reduction"
                                    name="building_time_reduction"
                                />
                                <x-core.forms.input
                                    :model="$skill"
                                    label="Unit Movement Time Reduction % (per level):"
                                    modelKey="unit_movement_time_reduction"
