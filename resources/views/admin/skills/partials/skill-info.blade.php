<x-core.layout.info-container>
    ...
    <x-core.cards.card>
        ...
        @if ($skill->skillType()->isCrafting())
            <p class="mb-4">
                This skill cannot be trained by fighting alone. Instead, by crafting weapons of this type you'll gain
                some xp towards its level. Certain quest items can help increase the amount of xp you get from training
                this skill.
            </p>
        ...
        @if ($skill->skillType()->isEnchanting())
            <p class="mb-4">
                This skill requires you to enchant items. You can do this by clicking Craft/Enchant and selecting
                enchant. Specific quest items can help increase the amount of XP you get per successful attempt.
            </p>
        ...
        @if ($skill->skillType()->isAlchemy())
            <p class="mb-4">
                This skill requires you to use Alchemy, which you can find under Craft/Enchant Assuming you have done
