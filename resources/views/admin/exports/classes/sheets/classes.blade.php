    ...
    <tbody>
        @foreach ($gameClasses as $gameClass)
            <tr>
                ...
                <td>
                    {{ ! is_null($gameClass->primaryClassRequired) ? $gameClass->primaryClassRequired->name : '' }}
                </td>
                <td>
                    {{ ! is_null($gameClass->secondaryClassRequired) ? $gameClass->secondaryClassRequired->name : '' }}
                </td>
