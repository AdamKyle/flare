...
@section('content')
  <x-core.layout.info-container>
    ...
    <x-core.cards.card>
      ...
      <div
        class="accordion mt-5 rounded-xl border border-gray-300 dark:border-gray-900"
      >
        <h5
          class="border-t border-gray-300 p-5 dark:border-gray-900"
        ...
        <div id="accordion-3" class="collapse">
          <div class="p-5 pt-0">
            ...
            >
              ...
              <div class="mb-5">
                <label for="silence-options" class="label mb-2 block">
                  Silence Options
                </label>
                <select
                  class="form-control"
        ...
        <div id="accordion-4" class="collapse">
          <div class="p-5 pt-0">
            @if ($character->user->ignored_unban_request)
              <div class="mt-4 mb-4 text-red-600 dark:text-red-500">
                You have chosen to ignore this users request to be unbanned. You
                may however, unban the character.
              </div>
            ...
            @elseif (! is_null($character->user->un_ban_request))
              ...
              <h4 class="mt-5 mb-5">Unban Character</h4>
              ...
              <h4 class="mt-5 mb-5">Or, Ignore Request</h4>
            ...
            @else
              ...
              >
                ...
                <div class="mb-5 w-full">
                  ...
                  >
                    <option @selected(old('for') === 'Please select')>
                      Please select
                    </option>
                    <option value="one-day" @selected(old('for') === 'one-day')>
                      1 Day
                    </option>
                    <option value="one-week" @selected(old('for') === 'one-week')>
                      1 Week
                    </option>
                    <option value="perm" @selected(old('for') === 'perm')>
                      For ever
                    </option>
                  </select>
