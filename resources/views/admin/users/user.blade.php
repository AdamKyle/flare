...
@section('content')
    <x-core.layout.info-container>
        ...
        <x-core.cards.card>
            ...
            <div class="accordion mt-5 rounded-xl border border-gray-300 dark:border-gray-900">
                <h5
                ...
                <div id="accordion-3" class="collapse">
                    <div class="p-5 pt-0">
                        ...
                        >
                            ...
                            <div class="mb-5">
                                <label for="silence-options" class="label mb-2 block"> Silence Options </label>
                    ...
                    <div class="p-5 pt-0">
                        @if ($character->user->ignored_unban_request)
                            <div class="mt-4 mb-4 text-red-600 dark:text-red-500">
                                You have chosen to ignore this users request to be unbanned. You may however, unban the
                                character.
                            </div>
