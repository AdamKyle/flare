...
<div class="w-full lg:w-3/4 mx-auto mt-20">
    <div class="text-center">
        ...
        <p class="mb-10 dark:text-gray-300 text-gray-800">
            Tlessa currently has some events running you might be interested in!
            Oh how exciting!
        </p>
    </div>

    <div class="relative">
        <div class="absolute inset-0 bg-gradient-to-br from-orange-500 via-red-500 to-pink-500 opacity-50 blur-lg pulse">
        </div>
        ...
        <div class="relative z-10 py-4">
            ...
            @else
                <div
                    class="grid md:grid-cols-{{ calculateGridCols(count($scheduledEventsRunning)) }} gap-2 items-stretch">
                    @foreach ($scheduledEventsRunning as $runningEvent)
                        <div class="my-4 h-full">
                            @include('./welcome-partials/event-card', ['eventRunning' => $runningEvent])
                        </div>
