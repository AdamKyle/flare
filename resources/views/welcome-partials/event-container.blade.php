...
<div class="mx-auto mt-20 w-full lg:w-3/4">
    ...
    <div class="relative">
        <div class="pulse absolute inset-0 bg-gradient-to-br from-orange-500 via-red-500 to-pink-500 opacity-50 blur-lg"></div>
        ...
        <div class="relative z-10 py-4">
            ...
            @elseif (count($scheduledEventsRunning) === 2)
                <div class="mx-auto grid w-full items-stretch gap-2 md:w-4/5 md:grid-cols-2">
            ...
            @else
                <div class="md:grid-cols-{{ calculateGridCols(count($scheduledEventsRunning)) }} grid items-stretch gap-2">
                    @foreach ($scheduledEventsRunning as $runningEvent)
                        <div class="my-4 h-full">
                            @include('./welcome-partials/event-card', ['eventRunning' => $runningEvent])
                        </div>
