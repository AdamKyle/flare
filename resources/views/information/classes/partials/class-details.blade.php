...
<div class="m-auto ml-auto w-full md:w-1/2">
    ...
    >
        <div class="-mx-2 mb-8 flex flex-wrap">
            <div class="mb-4 w-full px-2 md:w-1/2">
                ...
                <div class="my-3 border-b-2 border-b-gray-200 dark:border-b-gray-600"></div>
                <p class="my-2">Damage Stat refers to the primary stat which your damage will come from.</p>
                <p class="my-2">
                    To Hit Stat refers to the stat in which is used in conjunction with your accuracy and casting
                    accuracy to determine if you can hit or if your damage spell hits.
                </p>
                <dl class="my-4">
                    <dt>Damage Stat</dt>
            ...
            <div class="mb-4 w-full px-2 md:w-1/2">
                @if ($class->gameSkills->isNotEmpty())
                    ...
                    <ul>
                        @foreach ($class->gameSkills as $skill)
                            <li>
                                <a href="{{ route('info.page.skill', ['skill' => $skill->id]) }}">{{ $skill->name }}</a>
                            </li>
                        @endforeach
                    </ul>
                @endif
                ...
                <div class="my-3 border-b-2 border-b-gray-200 dark:border-b-gray-600"></div>
                <h5 class="mt-2 mb-2">Prefered Weapons</h5>
                <p class="my-2">Below you will find information about the weapons that are best for this class.</p>
