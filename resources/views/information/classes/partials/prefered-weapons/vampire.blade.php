    ...
    <p class="my-2">
        ...
        as you will be able to steal up to 99% of the enmies health in soe instances.
    </p>
    <p class="mb-2">
        Vampires do best with
        <a href="/information/combat" target="_blank"> Defend <i class="fas fa-external-link-alt"></i></a> when it comes to combat.
    </p>
