...
<p>
  Heretics can use Staves, Wands or Damage Spells. All of which help to increase
  your intelligence which helps you deal damage to enemies.
</p>
<x-core.alerts.info-alert title="Tip!">
  <p>
    When you first start out, for added attack, you could go two wands, two
    damage spells and a body piece. This allows you to use Attack and Cast, and
    focus on Accuracy, so you can actually hit harder creatures, before
...
<p>
  Heretics also get 30% of their intelligence added to their spell damage or 15%
  if they have no damage spells equipped.
</p>
<p>
...
<p>
  Heretics are glass cannon and should only focus on Cast attack with no healing
  spells (at later stages). They do not get any healing bonuses from healing
  spells.
</p>
