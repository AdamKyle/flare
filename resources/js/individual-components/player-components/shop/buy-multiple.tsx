...
export default class BuyMultiple extends React.Component<
    BuyMultipleProps,
    BuyMultipleState
> {
            ...
            <>
                ...
                {this.props.is_merchant ? (
                    <InfoAlert additional_css={"my-4"}>
                        As a merchant you will receive a 25% discount on
                ...
                <BasicCard additionalClasses={"my-4"}>
                        ...
                        <div className="grid md:grid-cols-2 gap-4 my-4">
                            <div className="flex items-center">
                                ...
                                <input
                                    ...
                                    onChange={this.handleSettingAmount.bind(
                                        this,
                                    )}
                                />
                            </div>
                    ...
                    <div>
                        <strong>Cost:</strong> {formatNumber(this.state.cost)}{" "}
                        Gold <strong>For Amount:</strong>{" "}
