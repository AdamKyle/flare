...
export default class Shop extends React.Component<ShopProps, ShopState> {
    ...
    constructor(props: ShopProps) {
        ...
        this.shopColumns = shopServiceContainer()
            .fetch(ShopTableColumns)
            .setComponent(this);

        this.shopListener =
            shopServiceContainer().fetch<ShopListenerDefinition>(ShopListener);
        ...
        return (
            <>
                ...
                <BasicCard additionalClasses={"my-4"}>
                    ...
                    <div className="my-3">
                        <strong>Current inventory space:</strong>{" "}
                ...
                {this.state.item_to_compare !== null ? (
                    <BuyAndCompare
                        ...
                        close_view_buy_and_compare={this.closeViewSection.bind(
                            this,
                        )}
                    ...
                    <div>
                        ...
                        <ItemTable
                            ...
                            close_view_item_action={this.closeViewSection.bind(
                                this,
                            )}
