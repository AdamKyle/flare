...
var guideQuestLabelBuilder = function (key, questData) {
    switch (key) {
        case "required_level":
        ...
        case "required_skill_type":
            return "Get Skill Type: ".concat(
                questData.skill_type_name,
                " to level",
            );
        ...
        case "required_faction_id":
            return "Get Faction ".concat(questData.faction_name, " to level");
        case "required_mercenary_level":
            return "Purchase and get Mercenary: ".concat(
                questData.mercenary_name,
                " to level",
            );
        case "required_secondary_mercenary_level":
            return "Purchase and get Secondary Mercenary: ".concat(
                questData.secondary_mercenary_name,
                " to level",
            );
...
var buildLabelLink = function (name, key, questData) {
    switch (key) {
        case "required_skill":
            return React.createElement(
                "a",
...
var getRequirementKey = function (labelKey) {
    switch (labelKey) {
        case "required_quest_id":
            return "quest_name";
        case "required_game_map_id":
...
var buildValueLink = function (name, key, questData) {
    switch (key) {
        case "required_quest_id":
            return React.createElement(
                "a",
...
//# sourceMappingURL=guide-quest-label-builder.js.map
