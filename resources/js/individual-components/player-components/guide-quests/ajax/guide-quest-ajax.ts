...
export default class GuideQuestAjax {
    ...
    public doGuideQuestAction(component: GuideQuest, actionType: GUIDE_QUEST_ACTIONS, params?: any) {
        ...
        const route = this.getRoute(actionType, component.props.user_id, guideQuestId);
    ...
    protected handleFetchGuideQuest(component: GuideQuest, route: string, action: Method, params?: any): void {
    ...
    protected handleHandingInGuideQuest(component: GuideQuest, route: string, action: Method, params?: any): void {
    ...
    protected getRoute(actionType: GUIDE_QUEST_ACTIONS, userId: number, guideQuestId?: number): string {
        switch (actionType) {
