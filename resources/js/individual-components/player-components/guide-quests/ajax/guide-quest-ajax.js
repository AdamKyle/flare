...
var GuideQuestAjax = (function () {
    ...
    GuideQuestAjax.prototype.doGuideQuestAction = function (
        component,
        actionType,
        params,
    ) {
    ...
    GuideQuestAjax.prototype.handleFetchGuideQuest = function (
        component,
        route,
        action,
        params,
    ...
    GuideQuestAjax.prototype.handleHandingInGuideQuest = function (
        component,
        route,
        action,
        params,
    ...
    GuideQuestAjax.prototype.getRoute = function (
        actionType,
        userId,
        guideQuestId,
    ) {
