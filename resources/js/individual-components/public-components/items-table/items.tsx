...
export default  class Items extends React.Component<ItemTableProps, ItemTableState> {
    ...
    constructor(props: ItemTableProps) {
        ...
        this.itemsTableColumns = itemsTableServiceContainer().fetch(ItemTableColumns);
    }
    ...
    render() {
        ...
        return <ItemTable items={this.state.items}
