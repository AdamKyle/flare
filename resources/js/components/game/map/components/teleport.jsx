            ...
            >
                ...
                <div className="form-row">
                    <div className="form-group col-md-6">
                        ...
                        <select className="form-control" id="x-position" onChange={this.handleX.bind(this)} value={this.state.selected_x}>
                            {this.fetchXLocations()}
                        </select>
                    </div>
                    <div className="form-group col-md-6">
                        <label htmlFor="x-position">Y Position</label>
                        <select className="form-control" id="x-position" onChange={this.handleY.bind(this)} value={this.state.selected_y}>
