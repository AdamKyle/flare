  ...
  healthMeters() {
    ...
    return (
      <div className="health-meters mb-2 mt-2">
        <div class="progress character mb-2">
          <div class={"progress-bar character-bar w-" + characterCurrentHealth} role="progressbar"
        ...
        <div className="progress monster mb-2">
          <div className={"progress-bar monster-bar w-" + monsterCurrentHealth} role="progressbar"
