    ...
    constructor(props) {
        ...
        this.columns = [
            ...
            },
            {
                key: "attack",
                text: "Attack",
                cell: row => <div data-tag="allowRowEvents"><div key={row.id}>{this.getAttack(row.id)}</div></div>,
                sortable: true
            },
            {
                key: "current-amount",
            ...
            },
            {
                key: "defence",
                text: "Defence",
                cell: row => <div data-tag="allowRowEvents"><div key={row.id}>{this.getDefence(row.id)}</div></div>,
                sortable: true
            },
            {
                key: "wood_cost",
                text: "Wood Cost",
                cell: row => <div data-tag="allowRowEvents"><div key={row.id}>{this.getCost(row.id, 'wood')}</div></div>,
                sortable: true
            },
            {
                key: "clay_cost",
                text: "Clay Cost",
                cell: row => <div data-tag="allowRowEvents"><div key={row.id}>{this.getCost(row.id, 'clay')}</div></div>,
                sortable: true
            },
            {
                key: "stone_cost",
                text: "Stone Cost",
                cell: row => <div data-tag="allowRowEvents"><div key={row.id}>{this.getCost(row.id, 'stone')}</div></div>,
                sortable: true
            },
            {
                key: "iron_cost",
                text: "Iron Cost",
                cell: row => <div data-tag="allowRowEvents"><div key={row.id}>{this.getCost(row.id, 'iron')}</div></div>,
                sortable: true
            },
        ];
