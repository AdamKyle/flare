          ...
          <div className="col-md-12">
            <div className="row">
              <div className="col-md-9">
                ...
                {this.state.openKingdomManagement ? <Management openKingdomManagement={this.openKingdomManagement.bind(this)} isAdventuring={this.state.canAdventureAgainAt} isPort={this.state.portDetails.currentPort} xPosition={this.state.current_x} yPosition={this.state.current_y} characterId={this.state.characterId}/> : null}
              </div>
