      ...
      <>
        {
          this.props.item.type === 'trinket' ?
            <Fragment>
              <dl>
                <dt>Ambush Chance %</dt>
                <dd className={this.props.item.ambush_chance > 0.0 ? 'text-success' : ''}>{(this.props.item.ambush_chance * 100).toFixed(2)}%</dd>
                <dt>Ambush Resist %</dt>
                <dd
                  className={this.props.item.ambush_resistance_chance > 0.0 ? 'text-success' : ''}>{(this.props.item.ambush_resistance_chance * 100).toFixed(2)}%
                </dd>
                <dt>Counter Chance %</dt>
                <dd className={this.props.item.counter_chance > 0.0 ? 'text-success' : ''}>{(this.props.item.counter_chance * 100).toFixed(2)}%
                </dd>
                <dt>Counter Resist %</dt>
                <dd
                  className={this.props.item.counter_resistance_chance > 0.0 ? 'text-success' : ''}>{(this.props.item.counter_resistance_chance * 100).toFixed(2)}%
                </dd>
              </dl>
              <p className="mt-4">See <a href="/information/combat">Combat Docs</a> for more information</p>
            </Fragment>
          :
            <Fragment>
