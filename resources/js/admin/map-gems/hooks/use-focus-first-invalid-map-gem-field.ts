...
const STEP_FIELDS = [
  [
    { field: 'game_map_id', id: 'map-gem-game-map' },
    { field: 'name', id: 'map-gem-name' },
    { field: 'description', id: 'map-gem-description' },
  ],
  [
    {
    ...
    { field: 'crafting_skill_ids', id: 'map-gem-crafting-skills' },
    {
  ...
  [
    { field: 'gold_gain_range', id: 'map-gem-gold-gain-range' },
    { field: 'gold_dust_gain_range', id: 'map-gem-gold-dust-gain-range' },
    { field: 'shards_gain_range', id: 'map-gem-shards-gain-range' },
    { field: 'copper_coin_gain_range', id: 'map-gem-copper-coin-gain-range' },
    {
  ...
  [
    {
      field: 'character_power_reduction_range',
  ...
  [
    ...
    { field: 'monster_atonement', id: 'map-gem-monster-atonement' },
    { field: 'monster_atonement_range', id: 'map-gem-monster-atonement-range' },
  ],
] as const;

export const useFocusFirstInvalidMapGemField = (
