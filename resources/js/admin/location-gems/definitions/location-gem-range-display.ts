...
import { LocationGemRangesDefinition } from '../api/definitions/location-gem-detail-definition';

export interface LocationGemRangeDisplayField {
  range_field: keyof LocationGemRangesDefinition;
  rolled_field: keyof AdminRolledGemDefinition;
  label: string;
}

export interface LocationGemRangeDisplayGroup {
  title: string;
  fields: LocationGemRangeDisplayField[];
}

export const LOCATION_GEM_RANGE_DISPLAY_GROUPS: LocationGemRangeDisplayGroup[] =
  [
    {
