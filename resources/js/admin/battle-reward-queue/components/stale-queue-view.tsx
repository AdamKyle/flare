...
import { StaleQueue, RewardRequest } from "../types/reward-queue";
import StaleQueueViewProps from "../types/stale-queue-view-props";
import RewardQueueCard from "./reward-queue-card";

export default class StaleQueueView extends React.Component<StaleQueueViewProps> {
    renderRequestRows(queue: StaleQueue) {
        return queue.requests.map((request: RewardRequest) => (
            ...
            >
                ...
                <div className="mt-4 overflow-x-auto">
                    <table className="w-full min-w-[850px] text-left text-sm">
                        ...
                        <tbody>{this.renderRequestRows(queue)}</tbody>
                    </table>
                </div>
            </RewardQueueCard>
        );
    ...
    render() {
        return (
            <div className="space-y-4">
                <div className="flex flex-wrap gap-2">
                    ...
                    <button
                        ...
                        disabled={
                            ...
                            this.props.staleQueues.length === 0
                        }
                ...
                {this.props.staleQueues.map((queue: StaleQueue) =>
