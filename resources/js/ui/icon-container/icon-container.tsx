...
const IconContainer = (props: IconContainerProps): ReactNode => {
  return (
    <div className="flex lg:flex-col items-center md:mx-auto w-full lg:w-10 justify-between lg:items-start lg:mr-4 lg:justify-start lg:mt-3 mt-4 space-y-0 lg:space-y-2">
