...
var Game = (function (_super) {
    ...
    Game.prototype.updateLogIcon = function () {
        ...
        if (this.state.kingdom_logs.length > 0) {
            var hasLogs = this.state.kingdom_logs.filter(function (log) {
                return !log.opened;
            });
            if (hasLogs.length > 0) {
    ...
    Game.prototype.setActionState = function (stateData) {
        this.setState({
            action_data: __assign(
                __assign({}, this.state.action_data),
                stateData,
            ),
        });
    };
    ...
    Game.prototype.renderLoading = function () {
        return React.createElement(
            ...
            {
                className:
                    "flex h-screen justify-center items-center max-w-md m-auto mt-[-150px]",
            },
            React.createElement(
                "div",
                { className: "w-full" },
    ...
    Game.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(CharacterTopSection, {
                                    character: this.state.character,
                                    view_port: this.state.view_port,
                                    update_character_status:
                                        this.updateCharacterStatus.bind(this),
                                    update_character_currencies:
                                        this.updateCharacterCurrencies.bind(
                                            this,
                                        ),
                                }),
                            ),
                                ...
                                React.createElement(
                                    ActionTabs,
                                    {
                                        ...
                                        update_faction_action_tasks:
                                            this.updateFactionActionTasks.bind(
                                                this,
                                            ),
                                    ...
                                    React.createElement(ActionSection, {
                                        ...
                                        update_celestial:
                                            this.updateCelestial.bind(this),
                                        update_plane_quests:
                                            this.updateQuestPlane.bind(this),
                                        update_character_position:
                                            this.setCharacterPosition.bind(
                                                this,
                                            ),
                                        view_port: this.state.view_port,
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(MapSection, {
                                        ...
                                        can_engage_celestials_again_at:
                                            this.state.character
                                                .can_engage_celestials_again_at,
                                        show_celestial_fight_button:
                                            this.updateCelestial.bind(this),
                                        set_character_position:
                                            this.setCharacterPosition.bind(
                                                this,
                                            ),
                                        update_character_quests_plane:
                                            this.updateQuestPlane.bind(this),
                ...
                React.createElement(
                    ...
                    React.createElement(CharacterSheet, {
                        ...
                        update_pledge_tab:
                            this.setCanSeeFactionLoyaltyTab.bind(this),
                        update_faction_action_tasks:
                            this.updateFactionActionTasks.bind(this),
                    }),
                ),
                React.createElement(
                    TabPanel,
                    ...
                    React.createElement(
                        BasicCard,
                        null,
                        React.createElement(Quests, {
                            quest_details: this.state.quests,
                            character_id: this.props.characterId,
                            update_quests:
                                this.updateCharacterQuests.bind(this),
                        }),
                    ),
                ),
                React.createElement(
                    TabPanel,
                    { key: "kingdoms" },
                    React.createElement(KingdomsList, {
            ...
            this.state.character.force_name_change
                ? React.createElement(ForceNameChange, {
                      character_id: this.state.character.id,
                  })
                : null,
            this.state.show_global_timeout
                ? React.createElement(GlobalTimeoutModal, null)
                : null,
        );
    };
    return Game;
