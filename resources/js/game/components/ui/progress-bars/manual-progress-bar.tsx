...
export default class ManualProgressBar extends React.Component<ManualProgressBarProps, any> {
        ...
        return (
            <Fragment>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                    <div className='h-2.5 rounded-full bg-blue-600 dark:bg-blue-500' style={{width: (this.props.percentage_left * 100) + '%'}}></div>
                </div>
            </Fragment>
        );
    }
