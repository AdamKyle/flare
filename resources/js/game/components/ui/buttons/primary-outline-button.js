...
var PrimaryOutlineButton = (function (_super) {
    __extends(PrimaryOutlineButton, _super);
    function PrimaryOutlineButton(props) {
        return _super.call(this, props) || this;
    }
    PrimaryOutlineButton.prototype.render = function () {
        return React.createElement(
            "button",
            {
                type: "button",
                className:
                    "py-2 px-3 text-xs border-blue-500 border-2 font-medium text-center " +
...
//# sourceMappingURL=primary-outline-button.js.map
