...
export default class SuccessButton extends React.Component<ButtonProps, {}> {
    ...
    render() {
        return(
            <button className={'hover:bg-blue-700 hover:drop-shadow-md dark:text-white hover:text-gray-300 bg-green-600 dark:bg-green-700 text-white dark:hover:bg-green-600 dark:hover:text-white font-semibold\n' +
