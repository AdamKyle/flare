...
export default class SuccessOutlineButton extends React.Component<ButtonProps, {}> {
    ...
    render() {
        return (
            <button type="button"
                    className={'py-2 px-3 text-xs border-green-600 border-2 font-medium text-center text-gray-900 ' +
                        ...
                        'focus-visible:ring-opacity-75 disabled:bg-opacity-75 dark:disabled:bg-opacity-50' +
                        'disabled:bg-green-600 dark:disabled:bg-green-500 disabled:text-white ' + this.props.additional_css}
