...
var Tabs = (function (_super) {
                ...
                if (tab[this.props.icon_key]) {
                    return React.createElement(
                        ...
                        React.createElement("i", {
                            className:
                                "ra ra-scroll-unfurled text-yellow-600 dark:text-yellow-400",
                        }),
                    );
                }
                return tab.name;
                ...
                function (_a) {
                    ...
                    return React.createElement(
                        "button",
                        {
                            ...
                            disabled:
                                typeof _this.props.disabled !== "undefined"
                                    ? _this.props.disabled
                                    : false,
                        },
                        _this.renderIcon(tab, selected),
                    );
                },
            );
        });
    ...
    Tabs.prototype.render = function () {
        return React.createElement(
            Tab.Group,
            { onChange: this.props.listen_for_change },
            React.createElement(
                Tab.List,
                {
                    className: clsx(
