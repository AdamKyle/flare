        ...
        if (typeof this.props.icon_key !== 'undefined' && !selected) {
            if (this.props.icon_key === 'has_logs') {
                if (tab[this.props.icon_key]) {
                    return <span>{tab.name} <i
                        className="ra ra-scroll-unfurled text-yellow-600 dark:text-yellow-400"></i></span>
                }
            ...
            if (typeof this.props.icon_key !== 'undefined' && typeof tab[this.props.icon_key] !== 'undefined') {
                if (this.props.icon_key === 'has_logs') {
                    if (tab[this.props.icon_key]) {

                        return <span>{tab.name} <i className="ra ra-scroll-unfurled text-yellow-600 dark:text-yellow-400"></i></span>
                    }
