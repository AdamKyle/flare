...
export default class BasicClosableCard extends React.Component<BasicCardProperties, any> {
        ...
        return (
            <div className={'bg-white rounded-sm drop-shadow-md p-6 dark:bg-gray-800 dark:text-gray-400 ' + this.appendAdditionalClasses()}>
                <div className='text-right cursor-pointer text-red-500 relative top-[10px] right-[20px]'>
                    <button onClick={this.props.close_action}><i className="fas fa-minus-circle"></i></button>
                </div>
