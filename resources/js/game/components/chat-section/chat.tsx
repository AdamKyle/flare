        ...
        <div className="bg-gray-700 dark:bg-gray-800 p-2 w-full h-96 overflow-y-auto rounded-md text-gray-400">
          <ul className="space-y-4">
            ...
            <li>
              ...
              air as families gathered for evening picnics. The aroma of freshly
              baked bread wafted from the local bakery, mingling with the scent
              of blooming flowers. As the stars began to twinkle, a gentle
              breeze carried the promise of a peaceful night, inviting all to
              pause and reflect on the beauty surrounding them.resources/
            </li>
            <li>
              <span className="underline font-bold">
              ...
              energy. Baristas crafted lattes with intricate foam designs while
              patrons enjoyed their drinks, some lost in books and others
              engaged in animated conversations. The scent of fresh coffee
              filled the air, creating a warm atmosphere.
            </li>
          </ul>
        </div>
      </Card>
