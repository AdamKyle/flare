...
export default class WorkBench extends React.Component<any, any> {
                    ...
                    .doAjaxCall(
                        ...
                        (result: AxiosResponse) => {
                            this.setState(
                                ...
                                () => {
                                    const foundItem =
                                        this.state.inventory_items.filter(
                                            (slot: any) => {
                                                return (
    ...
    setItem(data: any) {
        this.setState(
            ...
            () => {
                const foundItem = this.state.inventory_items.filter(
                    (slot: any) => {
    ...
    setAlchemyItem(data: any) {
        ...
        const foundSelectedItem = this.state.inventory_items.filter(
            (slot: any) => {
                    ...
                    <div className="col-start-1 col-span-2">
                        {this.state.inventory_items.length > 0 ? (
                            ...
                            <p className="mt-2 text-red-400 text-red-500 text-center">
                                No valid items in your inventory to apply oils
                                to.
                            </p>
                        )}
                    </div>
