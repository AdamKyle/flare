import SeerCamp from "../seer-camp";
...
export default class SeerActions {
    ...
    static attachGemToItem<T>(
        component: ManageGems<T>,
        slotId: number,
        gemSlotId: number,
    ) {
        new Ajax()
    ...
    static replaceGemOnItem(
        component: AtonementComparison,
        slotId: number,
        gemSlotId: number,
        gemSocketId: number,
    ) {
