...
import LabyrinthOracleState, {
    LabyrinthOracleInventory,
} from "./types/labyrinth-oracle-state";
...
export default class LabyrinthOracle extends React.Component<
    LabyrinthOracleProps,
    LabyrinthOracleState
> {
    private ajax: Ajax;
    ...
    transferItems(): { label: string; value: string }[] | [] {
        return this.state.inventory.map(
            (inventoryItem: LabyrinthOracleInventory) => {
                return {
    ...
    selectedTransfer(key: string) {
        ...
        const foundSelectedItem = this.state.inventory.filter(
            (item: LabyrinthOracleInventory) => {
                    ...
                    <div className="lg:cols-start-1 lg:col-span-2">
                        ...
                        this.state.inventory.length === 0 ? (
                            ...
                            <>
                                <div className="my-2">
                                    <Select
                                        onChange={this.setSelectedTransferFrom.bind(
                                            this,
                                        )}
                                ...
                                <Select
                                    onChange={this.setSelectedTransferTo.bind(
                                        this,
                                    )}
                                    options={this.transferItems()}
                                    menuPosition={"absolute"}
