...
> {
    ...
    render() {
        ...
        return (
            <div>
                <p className="my-4">
                    Your atonement is calculated based off the gems you have
                    socketed onto your gear. The highest elemental value is your
                    damage, where as the rest are used as resistances against
                    that type of elemental damage.
                </p>

                {this.state.elemental_atonement === null ? (
                    <WarningAlert>
                        You have nothing equipped. Cannot calculate your
                        Elemental Atonement. Learn more{" "}
                        <a href="/information/atonement" target="_blank">
                            here: Atonement{" "}
                    ...
                    <Fragment>
                        ...
                        <dl>
                            ...
                            <dd>
                                {
                                    this.state.elemental_atonement
                                        .highest_element.name
                                }
                            </dd>
                            <dt>Damage: </dt>
                            <dd>
                                {(
                                    this.state.elemental_atonement
                                        .highest_element.damage * 100
                                ).toFixed(2)}
                                %
                            </dd>
                        </dl>
                        <p className="my-4">
                            Your elemental damage is a % of damage you will deal
                            as that element in addition to your other attacks
                            when you attack an enemy. You can learn more about
                            it{" "}
                            <a href="/information/atonement" target="_blank">
                                here: Atonement{" "}
                                <i className="fas fa-external-link-alt"></i>
