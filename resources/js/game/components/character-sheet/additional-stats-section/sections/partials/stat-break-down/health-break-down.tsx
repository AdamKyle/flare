                    ...
                    .doAjaxCall(
                        ...
                        (error: AxiosError) => {
                            let errorMessage: string =
                                "Unable to load the health breakdown.";
            ...
            <div>
                ...
                {this.props.is_voided ? (
                    <p className="my-4 text-blue-700 dark:text-blue-500">
                        Your modded dur, when voided, is based off a few other
                        aspects such as equipment with out affixes, class
                        specialties and other minor factors. This only comes
                        into effect when the enemy voids you in combat.
                    </p>
                ) : null}
