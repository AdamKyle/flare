        ...
        return (
            <div className="max-h-[350px] md:max-h-full overflow-y-scroll md:overflow-y-visible">
                        ...
                        <dl>
                            <dt>
                                <PrimaryLinkButton
                                    ...
                                    on_click={() => {
                                        this.showTypeDetails("str", false);
                                    }}
                                />
                            </dt>
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.str_modded,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                                    ...
                                    on_click={() => {
                                        this.showTypeDetails("dex", false);
                                    }}
                                />
                            </dt>
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.dex_modded,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                                    ...
                                    on_click={() => {
                                        this.showTypeDetails("agi", false);
                                    }}
                                />
                            </dt>
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.agi_modded,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                                    ...
                                    on_click={() => {
                                        this.showTypeDetails("chr", false);
                                    }}
                                />
                            </dt>
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.chr_modded,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                                    ...
                                    on_click={() => {
                                        this.showTypeDetails("dur", false);
                                    }}
                                />
                            </dt>
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.dur_modded,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                                    ...
                                    on_click={() => {
                                        this.showTypeDetails("int", false);
                                    }}
                                />
                            </dt>
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.int_modded,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                                    ...
                                    on_click={() => {
                                        this.showTypeDetails("focus", false);
                                    }}
                                />
                            </dt>
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.focus_modded,
                                )}
                            </dd>
                        </dl>
                    </div>
                ...
                <div className="grid md:grid-cols-3 gap-2">
                    <div>
                        <dl>
                            ...
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.voided_health,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                            ...
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.voided_ac,
                                )}
                            </dd>
                        </dl>
                    </div>
                    ...
                    <div>
                        <dl>
                            ...
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.weapon_attack,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                            ...
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.ring_damage,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                            ...
                            <dd>
                                {formatNumber(
                                    this.props.stat_details.spell_damage,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                                    ...
                                    on_click={() => {
                                        this.showTypeDetails("heal_for", false);
                                    }}
                                />
                            </dt>
                            <dd>
                    ...
                    <div>
                        <dl>
                            ...
                            <dd>
                                {formatNumber(
                                    this.props.stat_details
                                        .voided_weapon_attack,
                                )}
                            </dd>
                            <dt>
                                <PrimaryLinkButton
                            ...
                            <dt>
                                <PrimaryLinkButton
                                    ...
                                    on_click={() => {
                                        this.showTypeDetails("heal_for", true);
                                    }}
                                />
                            </dt>
                            <dd>
                ...
                <p className="mt-4 mb-2">
                    <sup>*</sup> For more information please see{" "}
