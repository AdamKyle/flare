                    ...
                    .doAjaxCall(
                        ...
                        (error: AxiosError) => {
                            let errorMessage: string =
                                "Unable to load the Armour Class breakdown.";
            ...
            <div>
                ...
                {this.props.is_voided ? (
                    <p className="my-4 text-blue-700 dark:text-blue-500">
                        Voided Armour Class means no enchantments from your gear
                        is used. Voided Armour Class only comes into play when
                        an enemy voids you in combat.
                    </p>
                ) : null}

                <p className="mb-4">
                    Armour Class, or AC, is used to block or reduce (some, like
                    physical) incoming enemy attacks.
                </p>
