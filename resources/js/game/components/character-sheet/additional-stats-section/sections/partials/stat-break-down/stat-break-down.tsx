                    ...
                    .doAjaxCall(
                        ...
                        (error: AxiosError) => {
                            let errorMessage: string =
                                "Unable to load the selected stat breakdown.";
                    ...
                    {equippedItem.item_holy_stacks_applied > 0 ? (
                        <ul className="ps-5 mt-2 space-y-1 list-disc list-inside">
                            <li className="text-slate-700 dark:text-slate-300">
                                You have applied:{" "}
                                {equippedItem.item_holy_stacks_applied} of:{" "}
                                {equippedItem.item_holy_stacks_applied} Holy
                                Stacks, which gives you a bonus of:{" "}
                                {(
                                    equippedItem.total_stat_increase * 100
                                ).toFixed(2)}
                                % to {this.titelizeType()}
                            </li>
                        </ul>
                    ) : null}
                </li>
            ...
            return (
                <li>
                    ...
                    <span className="text-green-700 dark:text-green-500">
                        (+
                        {(
                            attachedAffix[this.props.type + "_mod"] * 100
                        ).toFixed(2)}
                        %);
                    </span>
                </li>
                        ...
                        {this.state.details.map_reduction !== null ? (
                            <ul className="space-y-4 text-gray-500 list-disc list-inside dark:text-gray-400">
                                <li>
                                    ...
                                    <span className="text-red-700 darmk:text-red-500">
                                        (-
                                        {(
                                            this.state.details.map_reduction
                            ...
                            <p>
                                There are no map reductions applied to this
                                stat.
                            </p>
                        )}
                    </div>
