...
const lockedStyles =
  'border-mango-tango-400 dark:border-mango-tango-700 bg-mango-tango-100 dark:bg-mango-tango-950/40 hover:bg-mango-tango-200 dark:hover:bg-mango-tango-900/50 text-mango-tango-900 dark:text-mango-tango-100';

const masteredStyles =
  'border-de-york-400 dark:border-de-york-700 bg-de-york-100 dark:bg-de-york-950/40 hover:bg-de-york-200 dark:hover:bg-de-york-900/50 text-de-york-900 dark:text-de-york-100';

const unlockedStyles =
  'border-glacier-300 dark:border-glacier-700 bg-glacier-50 dark:bg-glacier-950/30 hover:bg-glacier-100 dark:hover:bg-glacier-900/50 text-glacier-900 dark:text-glacier-100';
...
const OtherClassCard = ({
  ...
  const renderRequirementSummary = (): ReactNode => {
    ...
    return (
      <div className="text-mango-tango-800 dark:text-mango-tango-200 flex flex-col text-xs">
        <span>
