...
export default class AlchemyItemHoly extends React.Component<AlchemyItemHolyProps, {  }> {
        ...
        if (this.props.item.holy_level === null) {
            return (
                <DangerAlert additional_css={'my-4'}>
                    <strong>Error</strong>: Holy Oil does not seem to have a level associated with it.
                </DangerAlert>
            );
        }

         const effects = this.itemHolyEffects.determineItemHolyEffects(this.props.item.holy_level);
        ...
        return (
            <div className='mr-auto ml-auto w-3/5'>
                ...
                <p className='my-4 text-sky-700 dark:text-sky-600'>
                    These items can only be used at the Purgatory Smiths Workbench in Purgatory on items
                    you wish to enhance. Each oil will stack with the other. The amount of oils one can apply
                    to their weapons and armour is dependant on the craft level of that item. Set items, always have
                    the max holy stacks that can applied.
                </p>
                <p className='my-4 text-sky-700 dark:text-sky-600'>
                    As you can see below, the oil has a Holy Level, the higher the level (max 5) the better the stats applied
                    to the item.
                </p>
                <dl>
                    <dt>Holy Level</dt>
