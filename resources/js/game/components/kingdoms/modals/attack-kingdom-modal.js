...
var AttackKingdomModal = (function (_super) {
    ...
    AttackKingdomModal.prototype.attackKingdom = function () {
        ...
        this.setState({
            ...
            new Ajax()
                .setRoute("attack-kingdom-with-units/" +
    ...
    AttackKingdomModal.prototype.useItemsOnKingdom = function () {
        ...
        this.setState({
            ...
            new Ajax()
                .setRoute("drop-items-on-kingdom/" +
                _this.props.kingdom_to_attack_id +
                "/" +
                _this.props.character_id)
                .setParameters({
    ...
    AttackKingdomModal.prototype.setItemsToUse = function (data) {
        ...
        data.forEach(function (selected) {
            if (selected.value !== "Please select one or more items") {
                ...
                if (id_1 !== 0) {
                    var foundItem = _this.state.items_to_use.filter(function (slot) {
                        return slot.id === id_1;
                    });
    ...
    AttackKingdomModal.prototype.render = function () {
        var _this = this;
        return (React.createElement(Dialogue, { is_open: this.props.is_open, handle_close: this.props.handle_close, title: "Attack Kingdom", primary_button_disabled: this.state.loading, secondary_actions: {
                secondary_button_disabled: this.state.selected_units.length === 0 ||
                    this.state.loading,
                secondary_button_label: "Send Units",
                handle_action: this.attackKingdom.bind(this),
            }, tertiary_actions: {
                tertiary_button_disabled: this.state.selected_items.length === 0 ||
                    this.state.loading,
                tertiary_button_label: "Use items",
                handle_action: this.useItemsOnKingdom.bind(this),
            } }, this.state.fetching_data ? (React.createElement("div", { className: "py-4" },
            React.createElement(ComponentLoading, null))) : (React.createElement(Fragment, null,
            this.state.success_message !== "" ? (React.createElement(SuccessAlert, null, this.state.success_message)) : null,
            this.state.error_message !== "" ? (React.createElement(DangerAlert, null, this.state.error_message)) : null,
            React.createElement(Tabs, { tabs: this.tabs, disabled: this.state.loading },
                React.createElement(TabPanel, { key: "use-items" },
                    React.createElement(Fragment, null,
                        React.createElement(Select, { onChange: this.setItemsToUse.bind(this), isMulti: true, options: this.buildItemsSelection(), menuPosition: "absolute", menuPlacement: "bottom", styles: {
                                menuPortal: function (base) { return (__assign(__assign({}, base), { zIndex: 9999, color: "#000000" })); },
                            }, menuPortalTarget: document.body, value: this.getSelectedItems() }),
                        React.createElement("div", { className: "my-4" },
                            React.createElement("dl", null,
                                React.createElement("dt", null, "Total Damage"),
                                React.createElement("dd", null,
                                    React.createElement("div", { className: "flex items-center mb-4" },
                                        (this.state
                                            .total_damage * 100).toFixed(2),
                                        "%",
                                        React.createElement("div", null,
                                            React.createElement("div", { className: "ml-2" },
                                                React.createElement("button", { type: "button", onClick: function () {
                                                        return _this.manageShowHelpDialogue("total_damage");
                                                    }, className: "text-blue-500 dark:text-blue-300" },
                                                    React.createElement("i", { className: "fas fa-info-circle" }),
                                                    " ",
                                                    "Help"))))),
                                React.createElement("dt", null, "Building Damage"),
                                React.createElement("dd", null,
                                    React.createElement("div", { className: "flex items-center mb-4" },
                                        ((this.state
                                            .total_damage /
                                        ...
                                        React.createElement("div", null,
                                            React.createElement("div", { className: "ml-2" },
                                                React.createElement("button", { type: "button", onClick: function () {
                                                        return _this.manageShowHelpDialogue("building_damage");
                                                    }, className: "text-blue-500 dark:text-blue-300" },
                                                    React.createElement("i", { className: "fas fa-info-circle" }),
                                                    " ",
                                                    "Help"))))),
                                React.createElement("dt", null, "Unit Damage"),
                                React.createElement("dd", null,
                                    React.createElement("div", { className: "flex items-center mb-4" },
                                        ((this.state
                                            .total_damage /
                                        ...
                                        React.createElement("div", null,
                                            React.createElement("div", { className: "ml-2" },
                                                React.createElement("button", { type: "button", onClick: function () {
                                                        return _this.manageShowHelpDialogue("unit_damage");
                                                    }, className: "text-blue-500 dark:text-blue-300" },
                                                    React.createElement("i", { className: "fas fa-info-circle" }),
                                                    " ",
                                                    "Help"))))),
                                React.createElement("dt", { className: "text-red-600 dark:text-red-400" }, "Defending Kingdom Reduction"),
                                React.createElement("dd", null,
                                    React.createElement("div", { className: "flex items-center mb-4" },
                                        (this.state
                                            .total_reduction *
                                        ...
                                        React.createElement("div", null,
                                            React.createElement("div", { className: "ml-2" },
                                                React.createElement("button", { type: "button", onClick: function () {
                                                        return _this.manageShowHelpDialogue("total_reduction");
                                                    }, className: "text-blue-500 dark:text-blue-300" },
                                                    React.createElement("i", { className: "fas fa-info-circle" }),
                                                    " ",
                                                    "Help"))))))))),
                React.createElement(TabPanel, { key: "send-units" },
                    React.createElement(UnitMovement, { update_units_selected: this.setAmountToMove.bind(this), kingdoms: this.state.kingdoms, update_kingdoms_selected: this.setKingdoms.bind(this) }))),
            this.state.loading ? React.createElement(LoadingProgressBar, null) : null,
            this.state.show_help_modal ? (React.createElement(KingdomHelpModal, { manage_modal: this.manageShowHelpDialogue.bind(this), type: this.state.help_type })) : null))));
    };
