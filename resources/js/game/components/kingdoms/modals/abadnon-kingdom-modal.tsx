...
> {
    ...
    abandonKingdom() {
        this.setState(
            ...
            () => {
                new Ajax()
                    .setRoute("kingdoms/abandon/" + this.props.kingdom_id)
                    .doAjaxCall(
                        "post",
    ...
    render() {
        return (
            ...
            >
                <p className="mt-4">
                    <strong>Are you sure</strong> you want to do this? You won't
                    be able to abandon the kingdom if:
                </p>
                ...
                <ul className="my-4 list-disc ml-5">
                    ...
                    <li>
                        You have units in movement or are under attack or units
                        are traveling to your kingdom
                    </li>
                ...
                <p className="my-4">
                    Abandoning kingdoms turns it into an NPC kingdom (yellow on
                    the map). You cannot settle or purchase another kingdom for
                    15 minutes AFTER you have abandoned the kingdom.
                </p>
