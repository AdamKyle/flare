...
var KingdomResourceTransfer = (function (_super) {
    ...
    function KingdomResourceTransfer(props) {
        ...
        _this.kingdomResourceTransferRequestAjax = serviceContainer().fetch(
    ...
    KingdomResourceTransfer.prototype.setTypeOfResourceToRequest = function (
        type,
    ) {
        this.setState({
            type: type,
    ...
    KingdomResourceTransfer.prototype.renderKingdomDetailsForIndex = function (
        index,
    ) {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    "dd",
                    null,
                    formatNumber(kingdom.current_wood),
                ),
                React.createElement("dt", null, "Current Clay"),
                React.createElement(
                    "dd",
                    null,
                    formatNumber(kingdom.current_clay),
                ),
                React.createElement("dt", null, "Current Stone"),
                React.createElement(
                    "dd",
                    null,
                    formatNumber(kingdom.current_stone),
                ),
                React.createElement("dt", null, "Current Iron"),
                React.createElement(
                    "dd",
                    null,
                    formatNumber(kingdom.current_iron),
                ),
                React.createElement("dt", null, "Current Steel"),
                React.createElement(
                    "dd",
                    null,
                    formatNumber(kingdom.current_steel),
                ),
            ),
        );
    };
    KingdomResourceTransfer.prototype.sendOffRequest = function () {
        ...
        this.setState(
            ...
            function () {
                _this.kingdomResourceTransferRequestAjax.requestResources(
                    _this,
                    params,
    ...
    KingdomResourceTransfer.prototype.render = function () {
        ...
        if (this.state.kingdoms.length <= 0) {
            return React.createElement(
                "p",
                null,
                "You have no other kingdoms on this plane to request resources for. Or you have no other kingdoms on this plane, who have Market Places built.",
            );
        }
        return React.createElement(
            "div",
            ...
            React.createElement(
                ...
                {
                    className:
                        "max-w-full md:max-w-[75%] md:mr-auto md:ml-auto",
                },
                this.state.kingdoms.length > 0
                    ? React.createElement(
                          ...
                          React.createElement(
                              ...
                              {
                                  className:
                                      "text-red-700 dark:text-red-500 italic my-2 text-center",
                              },
                          ...
                          React.createElement(
                              ...
                              React.createElement(
                                  ...
                                  React.createElement("input", {
                                      ...
                                      onChange:
                                          this.setAmountToRequest.bind(this),
                                          ...
                                          menu_items: [
                                              {
                                                  ...
                                                  icon_class:
                                                      "fas fa-shopping-bag",
                                                  on_click: function () {
                                                      return _this.setTypeOfResourceToRequest(
                                                          "wood",
                                                      );
                                                  },
                                              },
                          ...
                          React.createElement(
                              "p",
                              { className: "my-2" },
                              'When sending resources, you will also send a "gaurd" with the resources. They will return if the resources are delivered. They can be killed if the kingdom to be delivered to is no longer in your control.',
                          ),
                    ...
                    : React.createElement(
                          "p",
                          null,
                          "There are no kingdoms to request resources from. Settle some more.",
                      ),
            ),
        );
    };
