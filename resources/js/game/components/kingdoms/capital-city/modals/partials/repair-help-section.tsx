...
export default class RepairHelpSection extends React.Component<any, any> {
        ...
        return (
            <div>
                <p className="my-2">
                    ...
                    selected to be repaired. If you are sure about your
                ...
                <WarningAlert>
                    ...
                    Requesting Resources or Repairing, you will see these
                    options when you viewing the building request queue.
                </WarningAlert>
            </div>
        );
    }
