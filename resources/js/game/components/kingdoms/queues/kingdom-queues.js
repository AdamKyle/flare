...
var KingdomQueues = (function (_super) {
    ...
    KingdomQueues.prototype.cancelQueue = function (
        cancellationType,
        queueIndex,
        queueKey,
    ) {
                ...
                if (buildingQueue.type === "upgrading") {
                    return React.createElement(
                        ...
                        React.createElement(
                            ...
                            {
                                className:
                                    "bold my-4 text-gray-800 dark:text-gray-300",
                            },
                            "Upgrading ",
                            buildingQueue.name,
                        ),
    ...
    KingdomQueues.prototype.renderUnitRecruitmentQueues = function () {
        ...
        return this.state.queues.unit_recruitment_queues.map(
            function (unitRecruitmentQueue, index) {
                return React.createElement(
                    BasicCard,
                    { additionalClasses: "my-2" },
                    React.createElement(
    ...
    KingdomQueues.prototype.renderUnitMovementQueues = function () {
        ...
        return this.state.queues.unit_movement_queues.map(
            function (unitMovementQueue, index) {
    ...
    KingdomQueues.prototype.renderBuildingExpansionQueues = function () {
        ...
        return this.state.queues.building_expansion_queues.map(
            function (buildingExpansionQueue, index) {
                return React.createElement(
                    BasicCard,
                    { additionalClasses: "my-2" },
                    React.createElement(
    ...
    KingdomQueues.prototype.render = function () {
        return React.createElement(
            ...
            React.createElement(
                "p",
                { className: "my-2" },
                "Below you will find the various queues. This could be building expansions, repairs, upgrades, unit recruitment and movement.",
            ),
            ...
            React.createElement(
                ...
                {
                    className:
                        "w-[90%] mr-auto ml-auto max-h-[600px] overflow-y-auto",
                },
