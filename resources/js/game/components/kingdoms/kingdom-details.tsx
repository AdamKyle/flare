...
import SkyOutlineButton from "../ui/buttons/sky-outline-button";
...
> {
    ...
    showGoblinBank() {
        const building = this.props.kingdom.buildings.filter(
            (building: BuildingDetails) => building.name === "Goblin Coin Bank",
        )[0];
    ...
    canManageGoldBars(): boolean {
        let bankBuilding: BuildingDetails[] | BuildingDetails =
            this.props.kingdom.buildings.filter((building: BuildingDetails) => {
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <dl>
                            ...
                            <dd>
                                {(
                                    this.props.kingdom.current_morale * 100
                                ).toFixed(2) + "/100%"}
                            </dd>
                            <dt>Treasury</dt>
                            <dd>{formatNumber(this.props.kingdom.treasury)}</dd>
                            <dt>Gold Bars</dt>
                            <dd>
                    ...
                    <div>
                        ...
                        <dl>
                            ...
                            <dd>
                                {formatNumber(
                                    this.props.kingdom.current_stone,
                                ) +
                                    "/" +
                            ...
                            <dd>
                                {formatNumber(
                                    this.props.kingdom.current_steel,
                                ) +
                                    "/" +
                ...
                <div className="grid md:grid-cols-3 gap-2">
                    <div>
                        ...
                        <dl>
                            ...
                            <dd>
                                {(
                                    this.props.kingdom.walls_defence * 100
                                ).toFixed(2)}
                                %
                            </dd>
                            ...
                            <dd>
                                {(
                                    this.props.kingdom.treasury_defence * 100
                                ).toFixed(2)}
                                %
                            </dd>
                            ...
                            <dd>
                                {(
                                    this.props.kingdom.passive_defence * 100
                                ).toFixed(2)}
                                %
                            </dd>
                            ...
                            <dd>
                                {(
                                    this.props.kingdom.defence_bonus * 100
                                ).toFixed(2)}
                                %
                            </dd>
                        </dl>
                    ...
                    <div>
                        ...
                        <div className="grid md:grid-cols-1 gap-4">
                            <PrimaryOutlineButton
                                button_label={
                                    this.props.kingdom.smelting_time_left >
                                    0 ? (
                                        <Fragment>
                                            <i className="far fa-clock text-yellow-700 dark:text-yellow-500 mr-2" />{" "}
                                            Smelter
                                        </Fragment>
                                    ) : (
                                        "Smelter"
