...
var Kingdom = (function (_super) {
    ...
    Kingdom.prototype.isInQueue = function () {
        ...
        return (
            this.state.kingdom.building_queue.filter(function (queue) {
    ...
    Kingdom.prototype.isUnitInQueue = function () {
        ...
        return (
            this.state.kingdom.unit_queue.filter(function (queue) {
        ...
        return React.createElement(
            ...
            this.state.kingdom.is_protected
                ? React.createElement(
                      ...
                      " day(s). This value does not include today.",
                  )
                : null,
            React.createElement(
                "div",
                ...
                React.createElement(
                    ...
                    this.state.building_to_view !== null ||
                        ...
                        : React.createElement(KingdomTabs, {
                              kingdom: this.state.kingdom,
                              kingdoms: this.props.kingdoms,
                              dark_tables: this.props.dark_tables,
                              manage_view_building:
                                  this.manageViewBuilding.bind(this),
