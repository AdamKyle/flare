...
var KingdomLogDetails = (function (_super) {
    ...
    KingdomLogDetails.prototype.renderBuildingChanges = function () {
        ...
        this.props.log.old_buildings.forEach(function (oldBuilding) {
            var foundNewBuilding = _this.props.log.new_buildings.filter(
    ...
    KingdomLogDetails.prototype.renderUnitChanges = function () {
        ...
        this.props.log.old_units.forEach(function (oldUnit) {
            var foundNewUnit = _this.props.log.new_units.filter(
                function (newUnit) {
    ...
    KingdomLogDetails.prototype.renderUnitsSentChange = function () {
        ...
        this.props.log.units_sent.forEach(function (sentUnit) {
            var foundNewUnit = _this.props.log.units_survived.filter(
                function (newUnit) {
        ...
        return resourceKeys.map(function (resourceKey) {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    "+",
                    formatNumber(
                        _this.props.log.additional_details.resource_request_log
                            .resource_details[resourceKey],
                    ),
                ),
            );
        });
    };
    KingdomLogDetails.prototype.renderAdditionalResourceMovementLogDetails =
        function () {
        ...
        if (this.props.log.status === "Kingdom requested resources") {
            return React.createElement(
                ...
                React.createElement(
                    "dl",
                    null,
                    this.renderResourcesDeliveredDetails(),
                ),
                this.props.log.additional_details.resource_request_log
                    ...
                    ? React.createElement(
                          ...
                          React.createElement(
                              ...
                              {
                                  className:
                                      "text-yellow-700 dark:text-yellow-600 mb-4",
                              },
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "h3",
                        { className: "mb-4" },
                        this.props.log.status,
                    ),
                    React.createElement(
                        "p",
                        { className: "my-4 text-red-600 dark:text-red-500" },
                        "You have not visited your kingdom in the last 90 days. So it was handed to The Old Man and made into an NPC Kingdom.",
                    ),
                    React.createElement(
                        "dl",
                        { className: "my-4" },
                        ...
                        React.createElement(
                            "dd",
                            null,
                            this.props.log.additional_details.kingdom_data.name,
                        ),
                        ...
                        React.createElement(
                            ...
                            "(X/Y)",
                            " ",
                            this.props.log.additional_details.kingdom_data.x,
                            " ",
                            "/",
                            " ",
                            this.props.log.additional_details.kingdom_data.y,
                        ),
                        React.createElement("dt", null, "On Map"),
                        React.createElement(
                            "dd",
                            null,
                            this.props.log.additional_details.kingdom_data
                                .game_map_name,
                        ),
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "h4",
                            null,
                            "Walking your kingdoms",
                        ),
                        React.createElement(
                            "p",
                            { className: "my-4" },
                            'Kingdoms have to be walked at least once in a 90 day period or they get handed over to The Old Man. What it means to walk a kingdom is to physically visit the kingdom to consider it "walked".',
                        ),
                    ),
                ),
            );
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "p",
                            { className: "my-4" },
                            "Kingdoms can purchase additional population for recruiting large amount of units, but one should becarfeul because if you have more then your max at the hourly reset The Old Man will stomp around. he will attempt to:",
                        ),
                        React.createElement(
                            "ul",
                            ...
                            React.createElement(
                                "li",
                                { className: "ml-4" },
                                "If you have none, he will take it from your treasury.",
                            ),
                            React.createElement(
                                "li",
                                { className: "ml-4" },
                                "If you have none, he will take it from your own gold.",
                            ),
                            React.createElement(
                                "li",
                                { className: "ml-4" },
                                "If you have none, he will destroy the kingdom.",
                            ),
                        ),
                    ),
                ),
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "dt",
                        {
                            className: this.props.log.took_kingdom
                                ? "hidden"
                                : "",
                        },
                ...
                React.createElement(
                    "p",
                    { className: !this.props.log.took_kingdom ? "hidden" : "" },
                    "You now own this kingdom. You took it from the defender. Check your kingdoms list. Any surviving units are now held up here.",
                ),
            ),
            React.createElement("div", {
                className:
                    ...
                    this.props.log.old_units.length === 0 &&
                        ...
                        ? React.createElement(
                              ...
                              React.createElement(
                                  "p",
                                  null,
                                  "There were no changes in kingdom units.",
                              ),
                          )
                        : React.createElement(
                              "div",
