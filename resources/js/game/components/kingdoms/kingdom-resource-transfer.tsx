    ...
    render() {
        ...
        return (
            <div>
                ...
                <p>
                    You can only request resources from one kingdom at a time. Below is a list of kingdoms that have resources
                    you can request from. By default players can request a max of 5,000 resources of any or all types. If the kingdom you request from, has Airships, you can use one and increase the max to 10,000 at a time.
                    There are passive skills that allow you to increase this amount when using an Airship.
                </p>
                        ...
                        this.state.kingdoms.length > 0 ?
                            <div>
                                ...
                                <div className="flex items-center mb-5">
                                    <label className="w-1/3">Amount to transfer</label>
                                    <div className="w-1/3">
                                        <input
                                            type="number"
                                            value={0}
                                ...
                                <dl>
                                    <dt>Amount:</dt>
                                    <dd className='text-green-700 dark:text-green-500'>+9999</dd>
                                    <dt>For Type:</dt>
                                    <dd className='text-orange-700 dark:text-orange-500'>All</dd>
                                    <dt>Use Air Ship</dt>
                                    <dd>Yes</dd>
                                    <dt>Population Cost</dt>
                                    <dd>50</dd>
                                </dl>
                                <DangerButton button_label={'Clear'} on_click={() => {}} additional_css={'my-3'}/>
                                <div className="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-2"></div>
                                <div className='my-4 flex justify-between'>
                                    <PrimaryButton button_label={'Previous'} on_click={() => {
                                    }} disabled={!this.state.can_go_back}/>
                                    <PrimaryButton button_label={'Next'} on_click={() => {
