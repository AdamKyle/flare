export enum CharacterInventoryApiUrls {
  ...
  CHARACTER_SET_OPTIONS = '/character/{character}/inventory/set-options',
  CHARACTER_HOLY_OIL_TARGET_SET_OPTIONS = '/character/{character}/inventory/holy-oil-target-set-options',
