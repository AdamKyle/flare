...
const CraftAndEnchantExperienceRunningSection = ({
  ...
  const enchantingSkill = experience?.enchanting_skill ?? null;
  const enchantingXpGained = experience?.enchanting_xp_gained ?? 0;
...
export default CraftAndEnchantExperienceRunningSection;
