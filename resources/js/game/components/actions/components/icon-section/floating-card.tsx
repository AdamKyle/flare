...
const FloatingCard = (props: FloatingCardProps): ReactNode => {
  return (
    <div className="absolute top-8 left-36 ml-4 shadow-lg rounded-sm border border-gray-500 dark:border-gray-700 w-[20rem] md:w-[28rem] z-10 max-w-none text-black dark:text-gray-300">
