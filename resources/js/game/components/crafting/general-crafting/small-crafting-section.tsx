...
export default class SmallCraftingSection extends React.Component<
    SmallCraftingSectionProps,
    SmallCraftingSectionState
> {
            ...
            <div className="relative">
                {this.state.crafting_type !== null ? (
                    ...
                    <div className="text-center my-4">
                        <Select
                            onChange={(value) =>
                                this.craftingSectionManager.setCraftingTypeForSmallerActionsList(
                                    value,
                                )
                            }
