...
import { craftingGetEndPoints, craftingPostEndPoints, } from "./helpers/crafting-type-url";
...
var Crafting = (function (_super) {
    ...
    Crafting.prototype.showCraftForNpc = function () {
        ...
        return (this.props.fame_tasks.filter(function (task) {
    ...
    Crafting.prototype.setTypeToCraft = function (data) {
        ...
        this.setState({
            ...
            if (_this.state.selected_type !== null &&
                _this.state.selected_type !== "") {
                var url = craftingGetEndPoints("craft", _this.props.character_id);
                new Ajax()
                    .setRoute(url)
                    .setParameters({
    ...
    Crafting.prototype.changeType = function () {
        ...
        else if (this.state.sorted_armour.length === 0 &&
            this.state.armour_craft_type !== null) {
            this.setState({
                sorted_armour: [],
                armour_craft_type: null,
    ...
    Crafting.prototype.craft = function (craftForNpc, craftForEvent) {
        ...
        this.setState({
            ...
            var url = craftingPostEndPoints("craft", _this.props.character_id);
            new Ajax()
                .setRoute(url)
                .setParameters({
                ...
                var oldCraftableItems = JSON.parse(JSON.stringify(_this.state.craftable_items));
                _this.setState({
                    loading: false,
                    craftable_items: result.data.items,
                    skill_xp: result.data.xp,
    ...
    Crafting.prototype.render = function () {
        return (React.createElement(Fragment, null,
            React.createElement("div", { className: "mt-2 lg:grid lg:grid-cols-3 lg:gap-2 lg:ml-[120px]" },
                React.createElement("div", { className: "lg:cols-start-1 lg:col-span-2" },
                    this.state.selected_type === null ? (React.createElement(CraftingTypeSelection, { select_type_to_craft: this.setTypeToCraft.bind(this) })) : this.state.selected_type === "armour" ? (this.state.sorted_armour.length > 0 ? (React.createElement(SelectItemToCraft, { set_item_to_craft: this.setItemToCraft.bind(this), items: this.buildItems(), default_item: this.defaultItem() })) : (React.createElement(ArmourTypeSelection, { select_armour_type_to_craft: this.selectedArmourType.bind(this) }))) : (React.createElement(SelectItemToCraft, { set_item_to_craft: this.setItemToCraft.bind(this), items: this.buildItems(), default_item: this.defaultItem() })),
                    this.state.loading ? React.createElement(LoadingProgressBar, null) : null,
                    this.state.craftable_items.length > 0 ? (React.createElement(CraftingXp, { skill_xp: this.state.skill_xp })) : null)),
            this.props.is_small ? (React.createElement("div", { className: "mt-3 mb-3 grid text-center" },
                React.createElement(CraftingActionButtons, { can_craft: this.canCraft(), can_close: this.canClose(), can_change_type: this.canChangeType(), craft: this.craft.bind(this), change_type: this.changeType.bind(this), clear_crafting: this.clearCrafting.bind(this), show_craft_for_npc: this.showCraftForNpc(), show_craft_for_event: this.state.show_craft_for_event }))) : (React.createElement("div", { className: "text-center lg:ml-[-100px] mt-3 mb-3" },
                React.createElement(CraftingActionButtons, { can_craft: this.canCraft(), can_close: this.canClose(), can_change_type: this.canChangeType(), craft: this.craft.bind(this), change_type: this.changeType.bind(this), clear_crafting: this.clearCrafting.bind(this), show_craft_for_npc: this.showCraftForNpc(), show_craft_for_event: this.state.show_craft_for_event })))));
    };
    return Crafting;
}(React.Component));
