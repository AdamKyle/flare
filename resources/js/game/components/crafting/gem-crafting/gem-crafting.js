...
var GemCrafting = (function (_super) {
    ...
    GemCrafting.prototype.craftingTiers = function () {
        var tierForSelection = this.state.tiersForCrafting.map(function (tier, index) {
            return {
    ...
    GemCrafting.prototype.render = function () {
        return (React.createElement(Fragment, null,
            React.createElement("div", { className: "mt-2 lg:grid lg:grid-cols-3 lg:gap-2 lg:ml-[120px]" },
                React.createElement("div", { className: "lg:cols-start-1 lg:col-span-2" }, this.state.loading ? (React.createElement(LoadingProgressBar, null)) : (React.createElement(Fragment, null,
                    React.createElement(Select, { onChange: this.setTierToCraft.bind(this), options: this.craftingTiers(), menuPosition: "absolute", menuPlacement: "bottom", styles: {
                            menuPortal: function (base) { return (__assign(__assign({}, base), { zIndex: 9999, color: "#000000" })); },
                        }, menuPortalTarget: document.body, value: this.craftingTierSelected() }),
                    this.state.selectedTier !== 0 ? (React.createElement("div", { className: "mt-4 mb-2" },
                        React.createElement("dl", null,
                            React.createElement("dt", null, "Gold Dust Cost"),
                            React.createElement("dl", null, formatNumber(this.state.tierCost
                                .gold_dust_cost)),
                    ...
                    this.state.isCrafting ? (React.createElement(LoadingProgressBar, null)) : null,
                    this.state.tiersForCrafting.length > 0 ? (React.createElement("div", { className: "my-4" },
                        React.createElement(CraftingXp, { skill_xp: this.state.skill_xp }))) : null)))),
            this.state.errorMessage !== null ? (React.createElement("div", { className: "mt-2 lg:grid lg:grid-cols-3 lg:gap-2 lg:ml-[120px]" },
                React.createElement("div", { className: "lg:cols-start-1 lg:col-span-2" },
                    React.createElement(DangerAlert, null, this.state.errorMessage)))) : null,
            React.createElement("div", { className: "text-center lg:ml-[-100px] mt-3 mb-3" },
                React.createElement(PrimaryButton, { button_label: "Craft", on_click: this.craft.bind(this), disabled: this.state.loading ||
                        this.state.selected_item === null ||
                        this.props.cannot_craft ||
                        this.state.isCrafting }),
                React.createElement(DangerButton, { button_label: "Close", on_click: this.props.remove_crafting, additional_css: "ml-2", disabled: this.state.loading ||
                        this.props.cannot_craft ||
                        this.state.isCrafting }),
                React.createElement("a", { href: "/information/gem-crafting", target: "_blank", className: "relative top-[0px] ml-2" },
                    "Help ",
