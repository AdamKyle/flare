...
var Enchanting = (function (_super) {
            ...
            function () {
                ...
                new Ajax()
                    ...
                    .doAjaxCall(
                        "post",
                        function (result) {
                            var oldEnchantments = JSON.parse(
                                JSON.stringify(_this.state.enchantments),
                            );
                            _this.setState(
                                {
                                    loading: false,
    ...
    Enchanting.prototype.selectedItemToEnchant = function () {
        ...
        if (this.state.selected_item !== null) {
            var foundItem = this.state.enchantable_items.filter(
                function (item) {
    ...
    Enchanting.prototype.selectedEnchantment = function (type) {
        ...
        if (selectedType !== null) {
            var foundEnchantment = this.state.enchantments.filter(
                function (item) {
    ...
    Enchanting.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                "div",
                { className: "mt-2 grid lg:grid-cols-3 gap-2 lg:ml-[120px]" },
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "div",
                        { className: "lg:hidden grid grid-cols-3" },
                        React.createElement(
                            "div",
                            { className: "col-start-1 col-span-2" },
                            React.createElement(Select, {
                                ...
                                options:
                                    this.renderEnchantmentOptions("prefix"),
                                menuPosition: "absolute",
                                menuPlacement: "bottom",
                                styles: {
                                    menuPortal: function (base) {
                        ...
                        React.createElement(
                            "div",
                            { className: "cols-start-3 cols-end-3 mt-2 ml-4" },
                            React.createElement(DangerLinkButton, {
                                button_label: "Clear",
                ...
                React.createElement(
                    ...
                    {
                        className:
                            "hidden lg:block cols-start-3 cols-end-3 mt-2",
                    },
                    React.createElement(DangerLinkButton, {
                        button_label: "Clear",
                        on_click: this.resetPrefixes.bind(this),
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(Select, {
                                ...
                                options:
                                    this.renderEnchantmentOptions("suffix"),
                                menuPosition: "absolute",
                                menuPlacement: "bottom",
                                styles: {
                                    menuPortal: function (base) {
            ...
            React.createElement(
                "div",
                { className: "m-auto lg:w-1/2 relative lg:left-[-60px]" },
                React.createElement(
                    InfoAlert,
                    {
                    ...
                    React.createElement(
                        "p",
                        { className: "mb-2" },
                        "Sometimes, you just need to level your character as well. Never underestimate a bit of grind.",
                    ),
                    React.createElement(
                        "p",
                        null,
                        "Click Help below for more info.",
                    ),
                ),
            ),
            React.createElement(
                ...
                this.state.enchantments.length > 0
                    ? React.createElement(
                          "div",
                          { className: "ml-[25px] lg:ml-0 mb-2 lg:mb-0" },
            ...
            this.state.event_items.length <= 0 &&
                ...
                ? React.createElement(
                      ...
                      "You have no event crafted items. You can craft your own items and either enchant them for your self or enchant for event and participate in the event for a Legendary item.",
                  )
                : null,
            React.createElement(
                "div",
