...
> {
    ...
    render() {
        const { character_id, isSaving, onCancel, onClose, onDismiss, status } =
            this.props;
                ...
                <div className="rounded border border-gray-200 p-3 dark:border-gray-700">
                    ...
                    <div className="h-1.5 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
                        <div
                            ...
                            style={{
                                width: `${batch.inventory_percent ?? 0}%`,
                            }}
                            role="progressbar"
                            aria-valuemin={0}
                            aria-valuemax={100}
                ...
                {actionLog.length > 0 ? (
                    <div className="rounded border border-gray-200 p-3 dark:border-gray-700">
                        ...
                        <p className="mb-2 text-xs text-gray-500 dark:text-gray-400">
                            Showing latest 50 actions. Counts above are the
                            source of truth for full batch progress.
                        </p>
