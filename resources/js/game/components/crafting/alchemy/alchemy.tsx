...
export default class Alchemy extends React.Component<any, any> {
    ...
    craft() {
        this.setState({
            ...
            const url = craftingPostEndPoints('alchemy', this.props.character_id);
        ...
        return (
            <Fragment>
                ...
                <div className={'text-center md:ml-[-100px] mt-3 mb-3'}>
                    <PrimaryButton button_label={'Transmute'} on_click={this.craft.bind(this)} disabled={this.state.loading || this.state.selected_item === null || this.props.cannot_craft} />
