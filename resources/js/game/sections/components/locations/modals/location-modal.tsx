        ...
        if (this.props.location.type_name === "Underwater Caves") {
            return (
                <Fragment>
                    ...
                    <p className="my-4">
                        Players in this location cannot explore, instead they
                        will find their attack section has been updated to allow
                        them to select a{" "}
                        <a href="/information/ranked-fights" target="_blank">
                            Rank <i className="fas fa-external-link-alt"></i>
                        </a>{" "}
                        and a monster, from here the fights take place on the
                        server.
                    </p>
                    <p className="mb-4">
                        Ranked fights are tracked and reset every month. Players
                        can see who is at the top of the rank fights by opening
                        the side menu and selecting Tops. From here you can see
                        who is #1 in each of the ranks. Being #1 means killing
                        the last creature in the list for that rank.
                    </p>
                    <div className="border-b-2 border-b-gray-200 dark:border-b-gray-600 my-3 hidden sm:block"></div>
                </Fragment>
            );
        ...
        return (
            ...
            >
                ...
                {this.state.cost > 0 ? (
                    ...
                    <WarningAlert>
                        You are too close to the location to be able to
                        teleport.
                    </WarningAlert>
                )}
