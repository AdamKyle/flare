...
import SettleKingdomModalProps from "../../../../lib/game/types/map/modals/settle-kingdom-modal-props";
import {AxiosError, AxiosResponse} from "axios";
import Ajax from "../../../../lib/ajax/ajax";
import LoadingProgressBar from "../../../../components/ui/progress-bars/loading-progress-bar";
import DangerAlert from "../../../../components/ui/alerts/simple-alerts/danger-alert";
import SuccessAlert from "../../../../components/ui/alerts/simple-alerts/success-alert";
import PurchaseNpcKingdomModalProps from "../../../../lib/game/types/map/modals/purchase-npc-kingdom-modal-props";


export default class PurchaseNpcKingdom extends React.Component<PurchaseNpcKingdomModalProps, any> {
    ...
    purchaseKingdom() {
        this.setState({
            ...
            (new Ajax()).setRoute('kingdoms/'+this.props.character_id+'/purchase-npc-kingdom').setParameters({
        ...
        return (
            ...
            >
                <p className='mb-4 mt-2'>
                    Checkout <a href='/information/kingdoms' target='_blank'>Kingdom's Help <i
                    className="fas fa-external-link-alt"></i></a> for more info. <br />< br />

                    Kingdom names can be 5-30 characters long.
                </p>
                <p className='mb-4'>
                    Each additional kingdom beyond the first costs 10,000 Gold. This includes switching Planes.<br />
