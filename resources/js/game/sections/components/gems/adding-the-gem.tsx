...
export default class AddingTheGem extends React.Component<
    AddingTheGemProps,
    {}
> {
            ...
            <BasicCard>
                            ...
                            <dd>
                                {(
                                    this.props.gem_to_add
                                        .primary_atonement_amount * 100
                                ).toFixed(0)}
                                %
                            </dd>
                            <dt>
                                {this.props.gem_to_add
                                    .secondary_atonement_name + " Atonement: "}
                            </dt>
                            <dd>
                                {(
                                    this.props.gem_to_add
                ...
                <div className="my-4">
                    <PrimaryButton
                        ...
                        on_click={() => this.props.do_action("attach-gem")}
