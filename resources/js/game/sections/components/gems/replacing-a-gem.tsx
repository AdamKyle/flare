...
export default class ReplacingAGem<T> extends React.Component<
    ReplacingAGemProps<T>,
    any
> {
    ...
    displayCards(): JSX.Element[] {
        return this.props.when_replacing.map(
            (gemComparisonDetails: WhenReplacing) => {
                const gemYouHave = this.props.gems_you_have.filter(
                    (gem: AttachedGems) => {
                    ...
                    <BasicCard additionalClasses="my-4">
                        ...
                        <div className="my-4">
                            <PrimaryButton
                                ...
                                on_click={() => {
                                    this.replaceGem(gemYouHave.name);
                                }}
                                disabled={this.props.action_disabled}
                            />
                        </div>
                    </BasicCard>
                );
    ...
    render() {
        return (
            <div>
                <p className="my-4">
                    Each card below will detail the comparison of replacing the
                    gem at that slot. The cost is the same as attaching a gem to
                    an empty slot.
                </p>
