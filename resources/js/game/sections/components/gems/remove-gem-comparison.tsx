                ...
                <BasicCard additionalClasses={"my-4"}>
                    ...
                    <div className="my-4">
                        <PrimaryButton
                            ...
                            on_click={() => {
                                this.removeGem(comparison.gem_id_to_remove);
                            }}
                        />
                    </div>
                </BasicCard>
    ...
    render() {
        return (
            ...
            >
                ...
                <p className="my-4">
                    Below is the original atonement of the item as well as the
                    adjusted changes after removing each gem. You may of course
                    choose to remove all gems, at the cost of 10 Gold Bars x The
                    number of gems attached.
                </p>
                <div className="max-h-[350px] overflow-y-scroll mb-4">
                    {this.renderOutGemComparison()}
                </div>
                {this.state.is_removing ? <LoadingProgressBar /> : null}
