...
var BattleMesages = (function (_super) {
    ...
    BattleMesages.prototype.render = function () {
        ...
        return this.props.battle_messages.map(function (battleMessage) {
            return (React.createElement("p", { className: clsx({
                    "text-green-700 dark:text-green-400": _this.typeCheck(battleMessage.type, "player-action"),
                }, {
                    "text-red-500 dark:text-red-400": _this.typeCheck(battleMessage.type, "enemy-action"),
                }, {
                    "text-blue-500 dark:text-blue-400": _this.typeCheck(battleMessage.type, "regular"),
