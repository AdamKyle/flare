            ...
            <div className="relative">
                ...
                >
                    <AttackButton
                        ...
                        on_click={() => this.props.attack("attack")}
                        disabled={
                    ...
                    <AttackButton
                        ...
                        on_click={() => this.props.attack("cast")}
                        disabled={
                            this.attackButtonDisabled() ||
                            this.props.preforming_action
                        }
                    ...
                    <AttackButton
                        ...
                        on_click={() => this.props.attack("cast_and_attack")}
                        disabled={
                            this.attackButtonDisabled() ||
                            this.props.preforming_action
                        }
                    ...
                    <AttackButton
                        ...
                        icon_class={"ra ra-lightning-sword"}
                        on_click={() => this.props.attack("attack_and_cast")}
                        disabled={
                            this.attackButtonDisabled() ||
                            this.props.preforming_action
                        }
                    ...
                    <AttackButton
                        ...
                        on_click={() => this.props.attack("defend")}
                        disabled={
                            this.attackButtonDisabled() ||
                            this.props.preforming_action
                        }
