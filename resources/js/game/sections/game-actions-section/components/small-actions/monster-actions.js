...
var MonsterActions = (function (_super) {
    ...
    MonsterActions.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "relative" },
            React.createElement(MonsterSelection, { monsters: this.state.monsters, update_monster_to_fight: this.setSelectedMonster.bind(this), character: this.props.character, close_monster_section: this.props.close_monster_section }),
            React.createElement(Revive, { can_attack: this.props.character_statuses.can_attack, is_character_dead: this.props.character.is_dead, character_id: this.props.character.id, revive_call_back: function () {
                    _this.setState({
                        character_revived: true,
                    });
                } }),
            this.props.children,
            this.state.monster_to_fight !== null ? (React.createElement(FightSection, { set_attack_time_out: this.setAttackTimeOut.bind(this), monster_to_fight: this.state.monster_to_fight, character: this.props.character, is_same_monster: this.state.is_same_monster, reset_same_monster: this.resetSameMonster.bind(this), character_revived: this.state.character_revived, reset_revived: this.resetRevived.bind(this), is_small: this.props.is_small })) : null));
    };
