...
import SmallMapSectionProps from "./types/small-map-section-props";
import MapSection from "../../../map/map-section";

export default class SmallMapMovementActions extends React.Component<
    SmallMapSectionProps,
    any
> {
        ...
        return (
            <div className="relative">
                <button
                    ...
                    className="text-red-600 dark:text-red-500 absolute right-[-20px] top-[-20px]"
                >
                ...
                <MapSection
                    ...
                    update_character_quests_plane={
                        this.props.update_plane_quests
                    }
