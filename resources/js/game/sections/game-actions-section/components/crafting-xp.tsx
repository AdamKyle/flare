        ...
        return (
            <div className='my-2'>
                <div className="flex justify-between mb-1">
                    <span className="font-medium text-orange-700 dark:text-white text-xs"> {this.props.skill_xp.skill_name} Skill XP (LV: {this.props.skill_xp.level})</span>
                    <span className="text-xs font-medium text-orange-700 dark:text-white">{formatNumber(this.props.skill_xp.current_xp)}/{formatNumber(this.props.skill_xp.next_level_xp)}</span>
                </div>
