...
var Actions = (function (_super) {
    ...
    function Actions(props) {
        ...
        _this.traverseUpdate = Echo.private(
            "update-plane-" + _this.props.character.user_id,
        );
                ...
                _this.setState(
                    ...
                    function () {
                        ...
                        if (characterLevel >= 301) {
                            _this.actionsManager.setCharactersForDueling(
                                event.characters,
                            );
                        }
                    },
    ...
    Actions.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    "div",
                    { className: "md:col-start-1 md:col-span-1" },
                    !this.state.show_exploration &&
                        ...
                        ? React.createElement(
                              ...
                              React.createElement(DropDown, {
                                  menu_items:
                                      this.actionsManager.buildCraftingList(
                    ...
                    this.props.character.can_access_hell_forged
                        ? React.createElement(
                              ...
                              React.createElement(SuccessOutlineButton, {
                                  ...
                                  on_click:
                                      this.manageHellForgedShop.bind(this),
                                  additional_css: "w-1/2",
                                  disabled: this.props.character.is_dead,
                              }),
                          )
                    ...
                    this.props.character.can_access_purgatory_chains
                        ? React.createElement(
                              ...
                              React.createElement(SuccessOutlineButton, {
                                  ...
                                  on_click:
                                      this.managedPurgatoryChainsShop.bind(
                                          this,
                                      ),
                                  additional_css: "w-1/2",
                                  disabled: this.props.character.is_dead,
                    ...
                    this.props.character.can_access_twisted_memories
                        ? React.createElement(
                              ...
                              React.createElement(SuccessOutlineButton, {
                                  ...
                                  on_click:
                                      this.managedTwistedEarthShop.bind(this),
                                  additional_css: "w-1/2",
                                  disabled: this.props.character.is_dead,
                              }),
                          )
                    ...
                    this.props.celestial_id !== 0 &&
                        ...
                        ? React.createElement(
                              ...
                              React.createElement(SuccessOutlineButton, {
                                  ...
                                  on_click:
                                      this.manageFightCelestial.bind(this),
                                  additional_css: "w-1/2",
                                  disabled:
                ...
                React.createElement(
                    "div",
                    { className: "md:col-start-2 md:col-span-3 mt-1" },
                    !this.state.show_exploration &&
                        !this.state.show_duel_fight &&
                        !this.state.show_join_pvp &&
                        !this.state.show_celestial_fight &&
                        ...
                        ? React.createElement(
                              ...
                              this.state.crafting_type !== null
                                  ? React.createElement(CraftingSection, {
                                        remove_crafting:
                                            this.removeCraftingType.bind(this),
                                        type: this.state.crafting_type,
                                        character_id: this.props.character.id,
                                        user_id: this.props.character.user_id,
                                        cannot_craft:
                                            this.actionsManager.cannotCraft(),
                              ...
                              this.state.show_hell_forged_section ||
                                  ...
                                  ? React.createElement(Shop, {
                                        ...
                                        character_id: this.props.character.id,
                                        close_hell_forged:
                                            this.manageHellForgedShop.bind(
                                                this,
                                            ),
                                        ...
                                        close_twisted_earth:
                                            this.managedTwistedEarthShop.bind(
                                                this,
                                            ),
                                    })
                                  : null,
                    ...
                    !this.state.show_exploration &&
                        ...
                        : null,
                    this.state.show_duel_fight
                        ? React.createElement(DuelPlayer, {
                    ...
                    this.state.show_exploration
                        ? React.createElement(ExplorationSection, {
                              character: this.props.character,
                              manage_exploration:
                                  this.manageExploration.bind(this),
                              monsters: this.state.monsters,
                          })
                        : null,
                    this.state.show_celestial_fight
                        ? React.createElement(CelestialFight, {
                              character: this.props.character,
                              manage_celestial_fight:
                                  this.manageFightCelestial.bind(this),
                        ...
                        : null,
                    this.state.show_join_pvp
                        ? React.createElement(JoinPvp, {
                              manage_section: this.manageJoinPvp.bind(this),
                              character_id: this.props.character.id,
                          })
                        : null,
                    this.state.show_gambling_section
                        ? React.createElement(GamblingSection, {
                              character: this.props.character,
                              close_gambling_section:
                                  this.manageGamblingSection.bind(this),
                              is_small: false,
                          })
                        : null,
                ),
