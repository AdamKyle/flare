...
export default class ActiveBoonsActionSection extends React.Component<ActiveBoonsActionsSectionProps, ActiveBoonsActionsSectionState> {
                ...
                <div className={'mb-4 mt-[-20px] text-center'}>
                    {
                        !this.state.viewing_active_boons ?
                            <OrangeButton button_label={'Active Boons'} on_click={this.manageViewingActiveBoons.bind(this)} />
                        :
                            <DangerButton button_label={'Close Active Boons'} on_click={this.manageViewingActiveBoons.bind(this)} />
                    }
...

                {
                    this.state.viewing_active_boons ?
                        <BasicCard additionalClasses={'mb-4'}>
                            <CharacterActiveBoons character_id={this.props.character_id} finished_loading={true} />
                        </BasicCard>
                    : null
                }
            </>
