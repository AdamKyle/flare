...
export default class ChangeNameModal extends React.Component<ChangeNameModalProps, ChangeNameState> {
        ...
        return(
            <Dialogue is_open={this.props.is_open}
                      ...
                      secondary_actions={{
                          ...
                          secondary_button_disabled: this.state.name.length === 0 || this.state.name === this.props.name,
