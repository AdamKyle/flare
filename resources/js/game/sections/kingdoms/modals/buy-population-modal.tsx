...
export default class BuyPopulationModal extends React.Component<BuyPopulationModalProps, BuyPopulationModalState> {
    ...
    render() {
        return(
            ...
            >
                <p className='mt-4'>
                    <strong>Caution:</strong> You may buy a total of 2 billion people at a cost of 5 Gold person.
                    However if, upon the hourly update of kingdoms, you have more then the maximum population
                    your kingdom is allowed, The Old Man will be angry with you.
                </p>

                <p className='my-4'>
                    The Old Man will first take the cost of 10,000 gold per additional person over the population limit
                    for the kingdom from your kingdom treasury. No gold? He will take your the amount out of your Gold Bars
                    rounded up. No Gold Bars? He will take the gold out of your pockets. Still no gold? He will destroy your kingdom.
                </p>
