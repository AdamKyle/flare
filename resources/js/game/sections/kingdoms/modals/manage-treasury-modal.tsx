...
export default class ManageTreasuryModal extends React.Component<ManageTreasuryModalProps, ManageTreasuryModalState> {
    ...
    setAmountToWithdraw(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        return this.setState({
            success_message: '',
            error_message: value === 0 ? 'This would cost gold wastage. Not allowed.' : '',
    ...
    deposit() {
        this.setState({
            ...
            (new Ajax()).setRoute('kingdoms/deposit/' + this.props.kingdom_id)
                .setParameters({
    ...
    withdraw() {
        this.setState({
            ...
            (new Ajax()).setRoute('kingdoms/embezzle/' + this.props.kingdom_id)
                .setParameters({
    ...
    massEmbezzle() {
        this.setState({
            ...
            (new Ajax()).setRoute('kingdoms/mass-embezzle/' + this.props.character_id)
                .setParameters({
                    embezzle_amount: this.state.amount_to_withdraw,
                }).doAjaxCall('post', (result: AxiosResponse) => {
                this.setState({
            ...
            >
                <Tabs tabs={this.tabs} disabled={this.state.loading}>
                    ...
                    <TabPanel key={'withdrawal'}>
                        <InfoAlert>
                            Withdrawing, or Embezzling, will reduce the morale of the kingdom by 15%, regardless of amount taken.
                            If a kingdom has 15% or less morale, you cannot withdraw gold.
                            Withdrawing gold also reduces your treasury defence, which reduces your overall kingdom defence.
                        </InfoAlert>
                        <div className='flex items-center my-4'>
                        ...
                        <PrimaryButton button_label={'Withdraw Amount'}
                                       ...
                                       disabled={this.state.amount_to_withdraw === '' || this.props.treasury === 0 || this.props.morale <= 0.15}
                        />
                    </TabPanel>
                    <TabPanel key={'mass-embezzle'}>
                        ...
                        <p className='my-4'>
                            Each kingdom that gets embezzled from will reduce it's morale by 15%. Low morale kingdoms and kingdoms with no treasury will be skipped.
                            Each kingdom that can be embezzled from will also loose Treasury Defence, which in turn reduces your over all kingdom defence.
                        </p>
                        <p className='my-4'>
                        ...
                        <p className='my-4'>
                            Finally, if you have not completed the Goblins Lust for Gold <a href='/information/quests' target='_blank'>quest <i
                            className="fas fa-external-link-alt"></i></a> you will not be able to embezzle and be told as such.
                        </p>
                        ...
                        <PrimaryButton button_label={'Mass Embezzle'}
