...
export default class RecruitWithGold extends React.Component<any, any> {
        ...
        this.setState(
            {
                ...
                time_needed:
                    timeNeeded -
                    timeNeeded * this.props.kingdom_unit_time_reduction,
    ...
    getPopulationCost() {
        const amount = this.getPopulationNeeded(
            parseInt(this.state.amount_to_recruit, 10) || 0
        );
            ...
            <Fragment>
                ...
                <div className="flex items-center mb-5">
                    ...
                    <div className="w-2/3">
                        <input
                            type="text"
                            onChange={this.setGoldAmount.bind(this)}
                        ...
                        <div>
                            <div className="ml-2">
                                <button
                                    type={"button"}
                                    onClick={() =>
                                        this.props.manage_help_dialogue(
                ...
                <PrimaryButton
                    button_label={"Purchase Units"}
                    additional_css={"mr-2"}
                    on_click={this.recruitUnits.bind(this)}
                    disabled={
                        this.state.amount_to_recruit <= 0 ||
                        this.state.loading ||
                        this.state.cost_in_gold > this.props.character_gold
                    }
                />
                <DangerButton
                    button_label={"Cancel"}
                    on_click={this.props.remove_selection}
                    disabled={this.state.loading}
                />
            </Fragment>
        );
