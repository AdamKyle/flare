        ...
        return (
            <Fragment>
                <Tabs tabs={this.tabs} full_width={true}>
                    <TabPanel key={'info'}>
                        <InfoTab view_port={0} character={this.props.character} finished_loading={this.props.finished_loading} manage_addition_data={this.props.manage_addition_data}/>
                    </TabPanel>
                    ...
                    <TabPanel key={'factions'}>
                        <CharacterFactions update_pledge_tab={this.props.update_pledge_tab}
