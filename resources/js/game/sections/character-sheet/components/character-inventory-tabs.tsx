        ...
        return (
            <Tabs tabs={this.tabs} full_width={true}>
                ...
                <TabPanel key={'equipped'}>
                    <EquippedTable dark_table={this.state.dark_tables} equipped_items={this.state.inventory.equipped} is_dead={this.props.is_dead} sets={this.state.inventory.sets} character_id={this.props.character_id} is_set_equipped={this.state.inventory.set_is_equipped} update_inventory={this.updateInventory.bind(this)} />
                </TabPanel>
                <TabPanel key={'sets'}>
                    <SetsTable dark_table={this.state.dark_tables} sets={this.state.inventory.sets} is_dead={this.props.is_dead} character_id={this.props.character_id} savable_sets={this.state.inventory.savable_sets} update_inventory={this.updateInventory.bind(this)} set_name_equipped={this.state.inventory.set_name_equipped} />
                </TabPanel>
                <TabPanel key={'quest'}>
