...
import { isSkillLocked, getSkillProgressionData } from "./helpers/is-skill-locked";
...
export default class ItemSkillTree extends React.Component<ItemSkillTreeProps, any> {
    ...
    buildNodes(skills: ItemSkill): (JSX.Element | undefined)[] {
        ...
        nodes = skills.children.map((child: ItemSkill) => {
            ...
            const progressionData = getSkillProgressionData(child, this.props.progression_data);
            ...
            if (typeof progressionData !== 'undefined')  {
                ...
                return (
                    <TreeNode label={<SkillTreeNode 
                        ...
                        is_locked={isSkillLocked(child, this.props.skill_data, this.props.progression_data)}
                    />}>
    ...
    render() {
        ...
        const progressionData = getSkillProgressionData(this.props.skill_data[0], this.props.progression_data);
