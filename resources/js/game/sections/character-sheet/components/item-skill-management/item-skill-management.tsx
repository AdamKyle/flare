...
export default class ItemSkillManagement extends React.Component<
    ItemSkillManagementProps,
    ItemSkillManagementState
> {
    ...
    componentDidUpdate(prevProps: Readonly<ItemSkillManagementProps>): void {
        if (this.state.skill_progression !== null) {
            const updatedSkillProgressionInfo =
                this.props.skill_progression_data.find(
                    (data: ItemSkillProgression) => {
        ...
        return (
            <Fragment>
                ...
                <p className="text-center font-thin text-sm text-gray-600 dark:text-gray-300 italic mt-1">
                    All the skills here will stack together. For more info
                    please refer to:{" "}
