...
export default class ItemSkillDetails extends React.Component<ItemSkillDetailsProps, any> {
    ...
    render() {
        ...
        const parentSkill: ItemSkill | undefined = findParentSkill(this.props.skill_progression_data.item_skill, this.props.skills);
                ...
                <div className="grid lg:grid-cols-2 gap-2">
                    <div>
                        <dl>
                            ...
                            }>{(skillData.str_mod * 100).toFixed(0)}% {skillData.item_skill.str_mod > 0 ? '(+'+(skillData.item_skill.str_mod * 100).toFixed(0)+'%/Lv)' : ''}</dd>
                            ...
                            }>{(skillData.dex_mod * 100).toFixed(0)}% {skillData.item_skill.dex_mod > 0 ? '(+'+(skillData.item_skill.dex_mod * 100).toFixed(0)+'%/Lv)' : ''}</dd>
                            ...
                            }>{(skillData.dur_mod * 100).toFixed(0)}% {skillData.item_skill.dur_mod > 0 ? '(+'+(skillData.item_skill.dur_mod * 100).toFixed(0)+'%/Lv)' : ''}</dd>
                            ...
                            }>{(skillData.agi_mod * 100).toFixed(0)}% {skillData.item_skill.agi_mod > 0 ? '(+'+(skillData.item_skill.agi_mod * 100).toFixed(0)+'%/Lv)' : ''}</dd>
                            ...
                            }>{(skillData.int_mod * 100).toFixed(0)}% {skillData.item_skill.int_mod > 0 ? '(+'+(skillData.item_skill.int_mod * 100).toFixed(0)+'%/Lv)' : ''}</dd>
                            ...
                            }>{(skillData.chr_mod * 100).toFixed(0)}% {skillData.item_skill.chr_mod > 0 ? '(+'+(skillData.item_skill.chr_mod * 100).toFixed(0)+'%/Lv)' : ''}</dd>
                            ...
                            }>{(skillData.focus_mod * 100).toFixed(0)}% {skillData.item_skill.focus_mod > 0 ? '(+'+(skillData.item_skill.focus_mod * 100).toFixed(0)+'%/Lv)' : ''}</dd>
                        </dl>
                    </div>
                    ...
                    <div>
                        <dl>
                            ...
                            }>{(skillData.base_attack_mod * 100).toFixed(0)}% {skillData.item_skill.base_attack_mod > 0 ? '(+'+(skillData.item_skill.base_attack_mod * 100).toFixed(0)+'%/Lv)' : ''}</dd>
                            ...
                            }>{(skillData.base_ac_mod * 100).toFixed(0)}% {skillData.item_skill.base_ac_mod > 0 ? '(+'+(skillData.item_skill.base_ac_mod * 100).toFixed(0)+'%/Lv)' : ''}</dd>
                            ...
                            }>{(skillData.base_healing_mod * 100).toFixed(0)}% {skillData.item_skill.base_healing_mod > 0 ? '(+'+(skillData.item_skill.base_healing_mod * 100).toFixed(0)+'%/Lv)' : ''}</dd>
                        </dl>
                    </div>
                </div>
                <div className='border-b-2 border-b-gray-300 dark:border-b-gray-600 my-3'></div>
