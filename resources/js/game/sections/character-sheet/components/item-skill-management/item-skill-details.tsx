...
export default class ItemSkillDetails extends React.Component<
            ...
            <>
                ...
                {this.props.is_skill_locked ? (
                    <InfoAlert additional_css="my-4">
                        This skill is locked and cannot be trained until you
                ...
                <p className="mb-4">
                    ...
                    <a href="/information/item-skills" target="_blank">
                ...
                {parentSkill ? (
                    <Fragment>
                        ...
                        <div className="bg-yellow-200 border border-yellow-700 dark:border-yellow-400 rounded-md py-3 px-4 text-yellow-900 dark:text-yellow-700">
                            <h3 className="my-4 font-bold text-yellow-900 dark:text-yellow-700">
                                Requirements
                            </h3>
                            <dl>
                                ...
                                <dd>
                                    {
                                        this.props.skill_progression_data
                                            .item_skill.parent_level_needed
                                    }
                                </dd>
                            </dl>
                        </div>
