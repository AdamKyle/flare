...
export class GemBagTable extends React.Component<any, any> {
    ...
    showSellConfirmation(gemSlotId: number) {
        this.setState({
            gem_to_sell: this.state.gem_slots.find((gemSlot: any) => {
    ...
    gemActions(data: GemBagDetails): JSX.Element {
        return (
            <PrimaryButton
                button_label={"Sell"}
                on_click={() => this.showSellConfirmation(data.id)}
            />
        );
    }
        ...
        return (
            <Fragment>
                ...
                {this.state.view_sell ? (
                    <ActionDialogue
                        ...
                        title={
                            <span>
                                ...
                                (Tier: {this.state.gem_to_sell.tier})
                            </span>
                        }
                    ...
                    >
                        <p className="my-4">
                            <strong>Are you sure?</strong> By selling this gem,
                            you get 15% of the currencies required to make a gem
                            of their tier back.
                        </p>
                        <p className="my-4">
                ...
                {this.state.view_sell_all ? (
                    ...
                    >
                        <p className="my-4">
                            <strong>Are you sure?</strong> By selling all gems,
                            you get 15% of the currencies required to make a gem
                            of their tier back.
                        </p>
                        <p className="my-4">
