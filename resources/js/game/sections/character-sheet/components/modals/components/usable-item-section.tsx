    ...
    render() {
        return (
            <Fragment>
                ...
                {
                    this.props.item.damages_kingdom ?
                        <Fragment>
                    ...
                    :
                        <Fragment>
                            <p className='mb-4 text-sky-700 dark:text-sky-600'>
                            ...
                            <div className='grid grid-cols-2 gap-2'>
                                ...
                                <div>
                                    ...
                                    <dl>
                                        ...
                                        })}>{(this.props.item.base_ac_mod_bonus * 100).toFixed(2)}%</dl>
                                        <dt>Base Dmg. Mod</dt>
                                        <dl className={clsx({
                                            'text-green-700 dark:text-green-600': this.props.item.base_damage_mod_bonus > 0
                                        })}>{(this.props.item.base_damage_mod_bonus * 100).toFixed(2)}%</dl>
                                        <dt>Base healing Mod</dt>
                                        <dl className={clsx({
                                            'text-green-700 dark:text-green-600': this.props.item.base_healing_mod_bonus > 0
                                        })}>{(this.props.item.base_healing_mod_bonus * 100).toFixed(2)}%</dl>
                                    </dl>
                                </div>
                            </div>
                            <div className='border-b-2 border-b-gray-300 dark:border-b-gray-600 my-3'></div>
