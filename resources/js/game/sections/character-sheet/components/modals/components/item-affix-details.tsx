                ...
                <div className="max-h-[350px] overflow-y-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <dl>
                                <dt>Str Modifier</dt>
                                <dd>
                                    {(this.props.affix.str_mod * 100).toFixed(
                                        2,
                                    )}
                                    %
                                </dd>
                                <dt>Dex Modifier</dt>
                                <dd>
                                    {(this.props.affix.dex_mod * 100).toFixed(
                                        2,
                                    )}
                                    %
                                </dd>
                                <dt>Agi Modifier</dt>
                                <dd>
                                    {(this.props.affix.agi_mod * 100).toFixed(
                                        2,
                                    )}
                                    %
                                </dd>
                                <dt>Chr Modifier</dt>
                                <dd>
                                    {(this.props.affix.chr_mod * 100).toFixed(
                                        2,
                                    )}
                                    %
                                </dd>
                                <dt>Dur Modifier</dt>
                                <dd>
                                    {(this.props.affix.dur_mod * 100).toFixed(
                                        2,
                                    )}
                                    %
                                </dd>
                                <dt>Int Modifier</dt>
                                <dd>
                                    {(this.props.affix.int_mod * 100).toFixed(
                                        2,
                                    )}
                                    %
                                </dd>
                                ...
                                <dd>
                                    {(this.props.affix.focus_mod * 100).toFixed(
                                        2,
                                    )}
                                    %
                                </dd>
                            ...
                            <dl>
                                ...
                                <dd>
                                    {(
                                        this.props.affix.skill_training_bonus *
                                        100
                                    ).toFixed(2)}
                                    %
                                </dd>
                                ...
                                <dd>
                                    {(
                                        this.props.affix.skill_bonus * 100
                                    ).toFixed(2)}
                                    %
                                </dd>
                            </dl>
                        ...
                        <div>
                            ...
                            <dl>
                                ...
                                <dd>
                                    {(
                                        this.props.affix.base_ac_mod * 100
                                    ).toFixed(2)}
                                    %
                                </dd>
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <p className="my-4">
                                Damage is a % of your total weapon damage after
                                all modifiers.
                            </p>
                            ...
                            <dl>
                                ...
                                <dd>
                                    {(
                                        this.props.affix.str_reduction * 100
                                    ).toFixed(2)}
                                    %
                                </dd>
                                <dt>Dex Reduction:</dt>
                                <dd>
                                    {(
                                        this.props.affix.dex_reduction * 100
                                    ).toFixed(2)}
                                    %
                                </dd>
                                <dt>Dur Reduction:</dt>
                                <dd>
                                    {(
                                        this.props.affix.dur_reduction * 100
                                    ).toFixed(2)}
                                    %
                                </dd>
                                <dt>Int Reduction:</dt>
                                <dd>
                                    {(
                                        this.props.affix.int_reduction * 100
                                    ).toFixed(2)}
                                    %
                                </dd>
                                <dt>Chr Reduction:</dt>
                                <dd>
                                    {(
                                        this.props.affix.chr_reduction * 100
                                    ).toFixed(2)}
                                    %
                                </dd>
                                <dt>Agi Reduction:</dt>
                                <dd>
                                    {(
                                        this.props.affix.agi_reduction * 100
                                    ).toFixed(2)}
                                    %
                                </dd>
                        ...
                        <div>
                            ...
                            <dl>
                                ...
                                <dd>
                                    Accuracy, Dodge, Casting Accuracy and
                                    Criticality
                                </dd>
                            ...
                            <dl>
                                ...
                                <dd>
                                    {(
                                        this.props.affix.resistance_reduction *
                                        100
                                    ).toFixed(2)}
                                    %
                                </dd>
