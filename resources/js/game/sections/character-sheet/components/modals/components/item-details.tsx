                ...
                <div className="grid md:grid-cols-3 gap-3 mb-4">
                    <div>
                        ...
                        <dl>
                            <dt>Str Modifier</dt>
                            <dd>
                                {(this.props.item.str_modifier * 100).toFixed(
                                    2,
                                )}
                                %
                            </dd>
                            <dt>Dex Modifier</dt>
                            <dd>
                                {(this.props.item.dex_modifier * 100).toFixed(
                                    2,
                                )}
                                %
                            </dd>
                            <dt>Agi Modifier</dt>
                            <dd>
                                {(this.props.item.agi_modifier * 100).toFixed(
                                    2,
                                )}
                                %
                            </dd>
                            <dt>Chr Modifier</dt>
                            <dd>
                                {(this.props.item.chr_modifier * 100).toFixed(
                                    2,
                                )}
                                %
                            </dd>
                            <dt>Dur Modifier</dt>
                            <dd>
                                {(this.props.item.dur_modifier * 100).toFixed(
                                    2,
                                )}
                                %
                            </dd>
                            <dt>Int Modifier</dt>
                            <dd>
                                {(this.props.item.int_modifier * 100).toFixed(
                                    2,
                                )}
                                %
                            </dd>
                            ...
                            <dd>
                                {(this.props.item.focus_modifier * 100).toFixed(
                                    2,
                                )}
                                %
                            </dd>
                    ...
                    <div>
                        ...
                        <dl>
                            ...
                            <dd>
                                {(
                                    this.props.item.base_damage_mod * 100
                                ).toFixed(2)}
                                %
                            </dd>
                            <dt>Base Ac Mod</dt>
                            ...
                            <dd>
                                {(
                                    this.props.item.base_healing_mod * 100
                                ).toFixed(2)}
                                %
                            </dd>
                        </dl>
                    ...
                    <div>
                        ...
                        <dl>
                            <dt>Spell Evasion</dt>
                            <dd>
                                {(this.props.item.spell_evasion * 100).toFixed(
                                    2,
                                )}
                                %
                            </dd>
                            ...
                            <dd>
                                {(
                                    this.props.item.healing_reduction * 100
                                ).toFixed(2)}
                                %
                            </dd>
                ...
                <div className="grid md:grid-cols-3 gap-3 mb-4">
                    <div>
                        ...
                        <dl>
                            ...
                            <dd>
                                {(
                                    this.props.item.devouring_light * 100
                                ).toFixed(2)}
                                %
                            </dd>
                            ...
                            <dd>
                                {(
                                    this.props.item.devouring_darkness * 100
                                ).toFixed(2)}
                                %
                            </dd>
                        </dl>
                    ...
                    <div>
                        ...
                        <dl>
                            ...
                            <dd>
                                {(
                                    this.props.item.resurrection_chance * 100
                                ).toFixed(2)}
                                %
                            </dd>
                        </dl>
                    ...
                    <div>
                        ...
                        <div className="border-b-2 border-b-gray-300 dark:border-b-gray-600 my-3"></div>
                        <p className="mb-4">
                            Indicates how many can be applied to the item, via
                            the{" "}
                ...
                <div className="grid md:grid-cols-3 gap-3 mb-4">
                    <div>
                        ...
                        <dl>
                            <dt>Chance</dt>
                            <dd>
                                {(this.props.item.ambush_chance * 100).toFixed(
                                    2,
                                )}
                                %
                            </dd>
                            ...
                            <dd>
                                {(
                                    this.props.item.ambush_resistance * 100
                                ).toFixed(2)}
                                %
                            </dd>
                        </dl>
                    ...
                    <div>
                        ...
                        <dl>
                            <dt>Chance</dt>
                            <dd>
                                {(this.props.item.counter_chance * 100).toFixed(
                                    2,
                                )}
                                %
                            </dd>
                            ...
                            <dd>
                                {(
                                    this.props.item.counter_resistance * 100
                                ).toFixed(2)}
                                %
                            </dd>
                        </dl>
