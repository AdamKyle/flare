        ...
        return (
            ...
            >
...

                {
                    ...
                    :
                        <Fragment>
                            <RenderAtonementDetails original_atonement={this.props.elemental_atonement} />
                            <div className='border-b-2 border-b-gray-300 dark:border-b-gray-600 my-6'></div>
                            <h4 className='my-4'>Elemental Damage</h4>
                            <dl>
                                <dt>Element: </dt>
                                <dd>{this.props.elemental_atonement.elemental_damage.name}</dd>
                                <dt>Damage: </dt>
                                <dd>{(this.props.elemental_atonement.elemental_damage.amount * 100).toFixed(2)}%</dd>
                            </dl>
