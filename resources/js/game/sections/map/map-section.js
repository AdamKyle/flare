...
var MapSection = (function (_super) {
    ...
    function MapSection(props) {
        ...
        _this.mapTimeOut = Echo.private(
            "show-timeout-move-" + _this.props.user_id,
        );
        _this.explorationTimeOut = Echo.private(
            "exploration-timeout-" + _this.props.user_id,
        );
        _this.celestialTimeout = Echo.private(
            "update-character-celestial-timeout-" + _this.props.user_id,
        );
        return _this;
    }
    MapSection.prototype.componentDidMount = function () {
        ...
        if (this.props.map_data !== null) {
            this.setState(
                __assign(__assign({}, this.props.map_data), {
                    time_left: 0,
                    automation_time_out: 0,
                    celestial_time_out: 0,
                }),
    ...
    MapSection.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                {
                    className:
                        "overflow-hidden max-h-[315px] sm:max-w-[75%] md:max-w-[44%] sm:border-2 lg:border-0 sm:mr-auto sm:ml-auto lg:max-w-full lg:mr-0 lg:ml-0",
                },
                React.createElement(
                    Draggable,
                    {
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            this.state.map_name === "The Ice Plane"
                                ? React.createElement(Snowfall, null)
                                : null,
                            ...
                            React.createElement(NpcKingdoms, {
            ...
            React.createElement(
                ...
                React.createElement(MapActions, {
                    character_id: this.props.character_id,
                    can_move: this.state.can_player_move,
                    is_dead: this.props.is_dead,
                ...
                React.createElement(DirectionalMovement, {
                    character_position: this.state.character_position,
