...
var MapSection = (function (_super) {
    ...
    MapSection.prototype.render = function () {
        ...
        return (React.createElement(Fragment, null,
            React.createElement("div", { className: "overflow-hidden max-h-[315px] sm:max-w-[315px] md:max-w-[44%] sm:border-2 lg:border-0 sm:mr-auto sm:ml-auto lg:max-w-full lg:mr-0 lg:ml-0" },
