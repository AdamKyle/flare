...
export default class ViewLocationModal extends React.Component<ViewLocationModalProps, any> {
    ...
    renderModal() {
        ...
        if (this.props.player_kingdom_id !== null) {
            return <KingdomDetails kingdom_id={this.props.player_kingdom_id}
        ...
        if (this.props.enemy_kingdom_id !== null) {
            return <KingdomDetails kingdom_id={this.props.enemy_kingdom_id}
                                   character_id={this.props.character_id}
        ...
        if (this.props.npc_kingdom_id !== null) {
            return <KingdomDetails kingdom_id={this.props.npc_kingdom_id}
                                   character_id={this.props.character_id}
                                   show_top_section={false}
                                   handle_close={this.props.handle_close}
                  />
