...
var Conjuration = (function (_super) {
    ...
    Conjuration.prototype.componentDidMount = function () {
        ...
        new Ajax()
            ...
            .doAjaxCall("get", function (response) {
            _this.setState({
                loading: false,
    ...
    Conjuration.prototype.getSelectedCelestial = function () {
        var _this = this;
        var selectedCelestial = this.state.celestials.filter(function (celestial) {
    ...
    Conjuration.prototype.render = function () {
        var _this = this;
        return (React.createElement(Dialogue, { is_open: this.props.is_open, handle_close: this.props.handle_close, title: this.props.title, secondary_actions: {
                handle_action: function () { return _this.conjure(false); },
                secondary_button_disabled: this.state.selected_celestial_id === null,
                secondary_button_label: "Conjure",
            }, tertiary_actions: {
                handle_action: function () { return _this.conjure(true); },
                tertiary_button_label: "Private Conjure",
                tertiary_button_disabled: this.state.selected_celestial_id === null,
            } }, this.state.loading ? (React.createElement("div", { className: "h-40" },
            React.createElement(ComponentLoading, null))) : this.state.celestials.length === 0 ? (React.createElement(Fragment, null,
            React.createElement("p", null, "Sorry Child this plane has no celestials for you to conjure."))) : (React.createElement(Fragment, null,
            this.state.error_message !== "" ? (React.createElement(DangerAlert, null, this.state.error_message)) : null,
            React.createElement("p", { className: "mb-4" },
                "For more info, see:",
                " ",
                React.createElement("a", { href: "/information/celestials", target: "_blank" },
                    "Celestials help docs.",
                    " ",
                    React.createElement("i", { className: "fas fa-external-link-alt" }))),
            React.createElement("p", { className: "mb-4" }, "Check server message section below for relevant details including location. Private conjurations will show you the location in server messages, public will show everyone as a global message. Celestials are first come first serve entities."),
            React.createElement("div", { className: "flex items-center" },
                React.createElement("label", { className: "w-[100px]" }, "Celestials"),
                React.createElement("div", { className: "w-2/3" },
                    React.createElement(Select, { onChange: this.setSelectedCelestial.bind(this), options: this.buildCelestialOptions(), menuPosition: "absolute", menuPlacement: "bottom", styles: {
                            menuPortal: function (base) { return (__assign(__assign({}, base), { zIndex: 9999, color: "#000000" })); },
                        }, menuPortalTarget: document.body, value: this.getSelectedCelestial() }))),
            this.state.conjuring ? React.createElement(LoadingProgressBar, null) : null))));
    };
    return Conjuration;
}(React.Component));
