...
export default class TraverseModal extends React.Component<any, any> {
    ...
    getDefaultValue() {
        const playerMap = this.state.game_maps.filter(
            (map: any) => map.id === this.props.map_id,
        )[0];
        ...
        return (
            ...
            >
                {this.state.loading ? (
                    ...
                    <Fragment>
                        <p className="mb-4">
                            Welcome to traverse. Every plane but Surface
                            requires a quest item to access, you can gain these
                            items by switching to the quest tab in the game area
                            and completing quests, some items drop off regular
                            creatures, some require quest chains to be
                            completed.
                        </p>
                        <p className="mb-4">
                            Some planes of existence like Shadow Planes, make
                            character attacks weaker, while others like Hell and
                            Purgatory will make your character over all, weaker.
                            To offset this, there is{" "}
                            <a
                            ...
                            which if followed does help make these areas easier
                            to farm valuable currencies and XP in.
                        </p>
                        <div className="w-2/3">
                            {this.state.is_traversing ? (
                        ...
                        {this.state.error_message !== null ? (
                            <p className="mt-4 mb-4 text-red-500 dark:text-red-400">
