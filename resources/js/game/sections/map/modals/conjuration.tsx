...
import ConjureModalProps from "../types/map/modals/conjure-modal-props";
import ConjureModalState from "../types/map/modals/conjure-modal-state";
import CelestialType from "../../../lib/game/types/actions/monster/celestial-type";

export default class Conjuration extends React.Component<
    ConjureModalProps,
    ConjureModalState
> {
    ...
    conjure(privateConjure: boolean) {
        ...
        this.setState(
            ...
            () => {
                new Ajax()
                    .setRoute("conjure/" + this.props.character_id)
                    .setParameters({
    ...
    getSelectedCelestial(): { label: string; value: number } {
        const selectedCelestial = this.state.celestials.filter(
        ...
        return (
            ...
            >
                {this.state.loading ? (
                    ...
                    <Fragment>
                        <p>
                            Sorry Child this plane has no celestials for you to
                            conjure.
                        </p>
                    </Fragment>
                ) : (
                    <Fragment>
                        ...
                        <p className="mb-4">
                            For more info, see:{" "}
                            <a href="/information/celestials" target="_blank">
                                Celestials help docs.{" "}
                                <i className="fas fa-external-link-alt"></i>
                            </a>
                        </p>
                        <p className="mb-4">
                            Check server message section below for relevant
                            details including location. Private conjurations
                            will show you the location in server messages,
                            public will show everyone as a global message.
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="w-2/3">
                                <Select
                                    onChange={this.setSelectedCelestial.bind(
                                        this,
                                    )}
                        ...
                        {this.state.conjuring ? <LoadingProgressBar /> : null}
                    </Fragment>
                )}
            </Dialogue>
        );
