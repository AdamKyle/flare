                                ...
                                <div className="grid md:grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <ul className='list-disc ml-[18px]'>
                                            ...
                                            { this.state.quest_data.secondary_skill_name !== null ? <li className={'text-orange-600 dark:text-orange-400'}>Get Secondary Skill: {this.state.quest_data.secondary_skill_name} to level: {this.state.quest_data.required_secondary_skill_level}</li> : null }
