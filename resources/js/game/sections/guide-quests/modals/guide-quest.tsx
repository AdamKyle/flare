                                ...
                                <div className="grid md:grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <ul className='list-disc ml-[18px]'>
                                            ...
                                            { this.state.quest_data.required_secondary_skill !== null ? <li className={'text-orange-600 dark:text-orange-400'}>Get Secondary Skill: {this.state.quest_data.secondary_skill_name} to level: {this.state.quest_data.required_secondary_skill_level}</li> : null }
                                            { this.state.quest_data.skill_type_name !== null ? <li className={'text-orange-600 dark:text-orange-400'}>Get Skill; Type: {this.state.quest_data.skill_type_name} to level: {this.state.quest_data.required_skill_type_level}</li> : null }
                                            ...
                                            { this.state.quest_data.secondary_quest_item_id !== null ? <li className={'text-orange-600 dark:text-orange-400'}>Get Secondary Quest Item: {this.state.quest_data.secondary_quest_item_name}</li> : null }
                                            { this.state.quest_data.required_mercenary_type !== null ? <li className={'text-orange-600 dark:text-orange-400'}>Get Mercenary: {this.state.quest_data.mercenary_name} to level {this.state.quest_data.required_mercenary_level}</li> : null }
                                            { this.state.quest_data.required_secondary_mercenary_type !== null ? <li className={'text-orange-600 dark:text-orange-400'}>Get Secondary Mercenary: {this.state.quest_data.secondary_mercenary_name} to level {this.state.quest_data.required_secondary_mercenary_level}</li> : null }
                                            { this.state.quest_data.required_class_specials_equipped !== null ? <li className={'text-orange-600 dark:text-orange-400'}>Equip # of Class Specials: {this.state.quest_data.required_class_specials_equipped}</li> : null }
