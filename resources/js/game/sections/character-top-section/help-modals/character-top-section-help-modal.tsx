...
export default class CharacterTopSectionHelpModal extends React.Component<any, any> {
        ...
        return (
            <div>
                ...
                <p className="my-2 text-gray-700 dark:text-gray-200">
                    ...
                    As well as your characters attack stat, which can be seen on the character sheet
                    in the Top Left called: Damage Stat. If you are on mobile you can see this by going to the character sheet
                    tab and expanding the top section (Character Details).
                </p>
        ...
        return (
            <div>
                ...
                <p className="my-2 text-gray-700 dark:text-gray-200">
                    ...
                    to it and any <a href="/information/class-ranks" target="_blank">
                    class specials{" "}
                    <i className="fas fa-external-link-alt"></i>
                </a>{" "} as well as <a href="/information/class-skills" target="_blank">
                    class skills.{" "}
                    <i className="fas fa-external-link-alt"></i>
                </a>{" "} Durability or Dur is the
                    calculation of all enchantments that effect this stat - also
                    known as Modded Durability.
                </p>
                <p className="my-2 text-gray-700 dark:text-gray-200">
