...
const themeStyles =
  'border-danube-400 dark:border-danube-500 bg-danube-100 dark:bg-danube-100';

const interactiveStyles =
  'hover:bg-danube-200 dark:hover:bg-danube-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-danube-500 dark:focus-visible:ring-danube-300 cursor-pointer';
...
const ClassPrerequisiteCard = ({
  ...
  const renderContent = (): ReactNode => (
    <div className="flex min-w-0 flex-1 flex-col gap-0.5">
      <span className="text-danube-900 dark:text-danube-900 truncate font-semibold">
        {name}
      </span>
      <span className="text-danube-700 dark:text-danube-800 text-xs">
