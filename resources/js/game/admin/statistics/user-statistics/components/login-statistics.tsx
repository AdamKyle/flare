...
export default class LoginStatistics extends React.Component<any, any> {
    ...
    componentDidMount() {
        (new Ajax()).setRoute('admin/site-statistics/all-time-sign-in').doAjaxCall('get', (result: AxiosResponse) => {
            this.setState({
    ...
    createDataSet(data: number[]|[], labels: string[]|[]): {login_count: number, date: string}[] {
