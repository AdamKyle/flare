...
class ExplorationWarningServiceTest extends TestCase
{
    ...
    public function testDismissLatestSoftDismissesWarningAndLinkedLog(): void
    {
        Event::fake();
    ...
    public function testDismissSelectedSoftDismissesWarningAndLinkedLog(): void
    {
        Event::fake();
    ...
    public function testDismissLatestSoftDismissesAllWarningsForCharacterAtOnce(): void
    {
        Event::fake();
