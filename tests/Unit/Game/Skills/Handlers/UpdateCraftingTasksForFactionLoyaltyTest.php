...
class UpdateCraftingTasksForFactionLoyaltyTest extends TestCase
{
    ...
    public function test_crafting_handler_does_not_apply_xp_inline()
    {
        $item = $this->createItem();
    ...
    public function test_crafting_handler_does_not_apply_currencies_inline()
    {
        $item = $this->createItem();
    ...
    public function test_crafting_retry_does_not_duplicate_reward_request()
    {
        $item = $this->createItem();
