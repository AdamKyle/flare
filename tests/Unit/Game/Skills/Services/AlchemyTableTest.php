...
class AlchemyTableTest extends TestCase
{
    ...
    public function testFetchAlchemistItemsIncludesOwnedAmountFromAlchemyBag(): void
    {
    ...
    public function testFetchAlchemistItemsShowsZeroOwnedWhenNotInAlchemyBag(): void
    {
        $character = $this->character->getCharacter();
    ...
    public function testFetchAlchemistItemsReflectsStackedAmount(): void
    {
        $character = $this->character->getCharacter();
