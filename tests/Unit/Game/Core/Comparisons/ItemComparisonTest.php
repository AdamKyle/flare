...
class ItemComparisonTest extends TestCase
{
    ...
    public function testFetchComparisonIsEmpty()
    {
        ...
        $character = $this->character->inventoryManagement()->unequipAll()->getCharacter(false);
    ...
    public function testDownGradingAWeapon() {
        ...
        $character = $character->inventoryManagement()->equipItem( 'left-hand', $this->item->name)->getCharacter(false);
