...
class DropCheckServiceLocationTypeTest extends TestCase
{
    ...
    public function testManualQuestItemDropsUseLocationTypeNotEnemyStrengthType(): void
    {
    ...
    public function testEnemyStrengthTypeAloneDoesNotEnableManualQuestItemDrops(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter()
            ->givePlayerLocation()
