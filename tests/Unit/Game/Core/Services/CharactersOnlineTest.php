...
class CharactersOnlineTest extends TestCase
{
    ...
    public function testCurrentOnlineDataIncludesCharacterNameLevelMapAndDuration(): void
    {
    ...
    public function testCurrentOnlineDataIncludesCurrentlyExploringAndActivityTimestamps(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        UserLoginDuration::factory()->create([
            'user_id' => $character->user_id,
    ...
    public function testCurrentOnlineDataUsesOpenLoginDurationRows(): void
    {
    ...
    public function testCurrentOnlineExcludesStaleOpenLoginRowsWithOldHeartbeat(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        UserLoginDuration::factory()->create([
            'user_id' => $character->user_id,
    ...
    public function testCurrentOnlineIncludesOpenLoginRowsWithRecentHeartbeat(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        UserLoginDuration::factory()->create([
            'user_id' => $character->user_id,
    ...
    public function testCurrentOnlineExcludesRowsWithCompletedDuration(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        UserLoginDuration::factory()->create([
            'user_id' => $character->user_id,
    ...
    public function testCurrentOnlineExcludesRowsWithLoggedOutAtSet(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        UserLoginDuration::factory()->create([
            'user_id' => $character->user_id,
    ...
    public function testHistoricalFilterReturnsTotalDurationAndNeverMarksExploring(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        UserLoginDuration::factory()->create([
            'user_id' => $character->user_id,
    ...
    public function testHistoricalFilterReturnsCompletedDurationRowsOnly(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        UserLoginDuration::factory()->create([
            'user_id' => $character->user_id,
    ...
    public function testUsersWithoutCharactersAreSkipped(): void
    {
