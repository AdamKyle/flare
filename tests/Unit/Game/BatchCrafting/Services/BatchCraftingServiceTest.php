...
class BatchCraftingServiceTest extends TestCase
{
    ...
    public function test_stop_on_death(): void
    {
    ...
    public function test_stop_on_no_gold(): void
    {
        $user = $this->createUser();
    ...
    public function test_stop_on_no_gold_dust(): void
    {
        $user = $this->createUser();
    ...
    public function test_trinketry_start_ignores_shards_and_stops_for_its_two_required_currencies(): void
    {
    ...
    public function test_stop_on_no_required_currency(): void
    {
        $user = $this->createUser();
    ...
    public function test_craft_experience_does_not_stop_on_full_normal_inventory(): void
    {
        $user = $this->createUser();
    ...
    public function test_alchemy_batch_does_not_stop_on_full_normal_inventory(): void
    {
    ...
    public function test_stop_on_maxed_crafting_levels_or_nothing_left_to_craft(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_max_level_craft_batch_still_crafts_when_eligible_craftable_items_exist(): void
    {
    ...
    public function test_kept_crafted_items_set_server_message_includes_link_metadata(): void
    {
    ...
    public function test_batch_craft_kept_output_crafted_message_is_linked_to_exact_set_slot(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_batch_craft_kept_output_does_not_dispatch_duplicate_plain_crafted_message(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false, ['xp' => 100, 'xp_max' => 100])->getCharacter();
    ...
    public function test_batch_craft_and_enchant_kept_output_enchant_message_is_linked_to_exact_set_slot(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false, ['xp' => 100, 'xp_max' => 100])->getCharacter();
    ...
    public function test_batch_trinketry_kept_output_crafted_message_is_linked_to_exact_set_slot(): void
    {
        Event::fake([ServerMessageEvent::class]);
    ...
    public function test_batch_craft_sold_output_does_not_emit_link_metadata(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false, ['xp' => 100, 'xp_max' => 100])->getCharacter();
    ...
    public function test_alchemy_amount_keep_dispatches_linked_kept_in_bag_message(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_alchemy_experience_keep_dispatches_linked_kept_in_bag_message(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $this->instance(
    ...
    public function test_alchemy_experience_keep_best_destroy_rest_dispatches_linked_kept_message_for_retained_best(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $this->instance(
            SkillCheckService::class,
    ...
    public function test_alchemy_destroy_does_not_emit_link_metadata(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value)->update(['level' => 2]);
    ...
    public function test_alchemy_list_does_not_emit_link_metadata(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value)->update(['level' => 2]);
    ...
    public function test_max_level_craft_and_enchant_batch_still_crafts_and_enchants_when_eligible_items_and_affixes_exist(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $spellCrafting = $this->createGameSkill(['name' => 'Spell Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_batch_processes_one_experience_item_per_tick_and_persists_queue_in_progress(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_and_enchant_first_tick_crafts_and_sets_enchant_phase_in_progress(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_and_enchant_second_tick_enchants_pending_slot_and_advances_index(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_experience_queue_includes_two_ring_entries(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
    ...
    public function test_craft_experience_builds_fixed_set_queue_with_duplicate_spells_rings_and_shield(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $spellCrafting = $this->createGameSkill(['name' => 'Spell Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_enchant_batch_does_not_process_historical_rows(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_enchant_batch_leaves_partially_enchanted_items_untouched(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value;
    ...
    public function test_max_level_alchemy_amount_batch_still_transmutes_when_eligible_alchemy_item_exists(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value;
    ...
    public function test_alchemy_amount_crafts_selected_item(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value;
    ...
    public function test_alchemy_amount_stops_when_selected_item_is_not_craftable(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'shards' => 1000, 'alchemy_bag_limit' => 10]);
    ...
    public function test_max_level_trinketry_batch_stops_at_max_level(): void
    {
    ...
    public function test_holy_oils_stop_when_all_oils_applied(): void
    {
        $user = $this->createUser();
    ...
    public function test_holy_oils_stop_when_no_oils_remain(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold_dust' => 100]);
    ...
    public function test_holy_oils_stop_when_selected_items_are_exhausted(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold_dust' => 100]);
    ...
    public function test_active_lookup_excludes_cancelled_batch(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_active_lookup_excludes_completed_batch(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_active_lookup_returns_newest_active_batch_by_id(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_visible_lookup_returns_active_batch_when_active_exists(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_visible_lookup_returns_completed_undismissed_batch_when_no_active_exists(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_visible_lookup_does_not_return_dismissed_completed_batch(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_visible_lookup_prefers_active_batch_over_older_completed_undismissed_batch(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_status_returns_timer_progress_fields(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_status_returns_action_log_item_snapshots(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_status_exposes_craft_enchant_set_progress_by_completed_queue_entries(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_status_reflects_active_retry_state_after_a_tick_with_one_normal_failure(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_retry_state_clears_after_a_normal_tick_with_no_failure_despite_earlier_cumulative_failures(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 10, false)->getCharacter();
    ...
    public function test_status_retry_state_is_inactive_for_a_completed_batch_with_historical_failures(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_status_returns_non_clickable_sold_snapshot(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_status_returns_non_clickable_destroyed_snapshot(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_status_returns_disenchanted_count(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_no_gold_status_includes_kept_set_summary_when_pieces_exist(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_info_acknowledgement_stores_state(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_acknowledged_info_does_not_auto_show_again(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_complete_for_death_ends_active_batch(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_craft_and_enchant_with_disenchant_removes_item_through_existing_service_path(): void
    {
        Bus::fake();
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_status_includes_inventory_percent(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_status_includes_skill_xp_data(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value;
    ...
    public function test_status_skill_is_maxed_when_at_max_level(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_status_missing_skill_does_not_crash(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_enchant_failure_does_not_increment_crafted_count(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_experience_mode_stops_when_all_crafting_skills_are_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_specific_item_mode_stops_when_amount_reached(): void
    {
        $user = $this->createUser();
    ...
    public function test_craft_amount_completion_summary_reports_all_crafted(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 1000]);
        $this->createBatchCrafting([
    ...
    public function test_craft_amount_completion_summary_reports_some_crafted(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 1000]);
        $this->createBatchCrafting([
    ...
    public function test_craft_amount_completion_summary_reports_none_crafted(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 1000]);
        $this->createBatchCrafting([
    ...
    public function test_alchemy_experience_mode_stops_when_alchemy_skill_is_maxed(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_alchemy_amount_mode_stops_when_amount_reached(): void
    {
        $user = $this->createUser();
    ...
    public function test_trinketry_does_not_require_amount(): void
    {
        $user = $this->createUser();
    ...
    public function test_craft_experience_stops_when_no_eligible_items_exist(): void
    {
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_holy_oils_stops_on_insufficient_gold_dust_for_actual_cost(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_batch_start_writes_started_log_entry(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_character_payload_includes_active_batch_crafting_state(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $this->createBatchCrafting([
            'character_id' => $character->id,
    ...
    public function test_character_payload_includes_inactive_batch_crafting_state(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_update_character_status_includes_active_batch_crafting_state(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $this->createBatchCrafting([
            'character_id' => $character->id,
    ...
    public function test_status_returns_active_visible_panel_data_after_starting_craft_for_experience(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_status_returns_active_visible_panel_data_after_starting_craft_amount(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_status_returns_active_visible_panel_data_after_starting_craft_and_enchant(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 1, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_status_payload_contains_fields_needed_by_frontend_panel(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_successful_action_writes_succeeded_log_entry(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_failed_roll_writes_failed_roll_log_entry(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $character->user_id]);
        $processor = Mockery::mock(BatchCraftingProcessor::class);
    ...
    public function test_hard_stop_writes_hard_stop_log_entry(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 0]);
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $user->id, 'batch_type' => BatchCraftingType::CRAFT->value]);
    ...
    public function test_cancel_writes_cancelled_log_entry(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $user->id]);
    ...
    public function test_complete_writes_completed_log_entry(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $character->user_id]);
        $processor = Mockery::mock(BatchCraftingProcessor::class);
    ...
    public function test_exception_writes_exception_log_entry(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $character->user_id]);
        $processor = Mockery::mock(BatchCraftingProcessor::class);
    ...
    public function test_status_event_dispatches_after_successful_action(): void
    {
    ...
    public function test_admin_monitoring_event_dispatches_after_successful_action(): void
    {
    ...
    public function test_status_event_dispatches_after_failed_roll(): void
    {
        Event::fake([BatchCraftingStatusUpdated::class]);
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $character->user_id]);
    ...
    public function test_status_event_dispatches_after_hard_stop(): void
    {
        Event::fake([BatchCraftingStatusUpdated::class]);
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 0]);
    ...
    public function test_status_event_dispatches_after_cancel(): void
    {
        Event::fake([BatchCraftingStatusUpdated::class]);
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_status_event_dispatches_after_dismiss(): void
    {
        Event::fake([BatchCraftingStatusUpdated::class]);
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_automation_log_update_dispatches_after_start(): void
    {
    ...
    public function test_automation_log_update_dispatches_after_successful_tick_with_useful_message(): void
    {
        Event::fake([AutomationLogUpdate::class]);
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $character->user_id]);
    ...
    public function test_automation_log_update_dispatches_after_cancel(): void
    {
        Event::fake([AutomationLogUpdate::class]);
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_automation_log_update_dispatches_after_completion(): void
    {
        Event::fake([AutomationLogUpdate::class]);
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_process_completes_with_batch_crafting_set_full_reason(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $user->id]);
    ...
    public function test_status_includes_batch_crafting_set_summary(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_craft_experience_builds_twenty_three_internal_targets(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $spellCrafting = $this->createGameSkill(['name' => 'Spell Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        ...
        $processor = new BatchCraftingProcessor(
            ...
            resolve(ServerMessageHandler::class),
        );
    ...
    public function test_batch_crafting_set_move_failure_stops_batch(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 1000]);
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $user->id]);
    ...
    public function test_batch_crafting_set_full_uses_correct_end_reason(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_experience_kept_output_moves_to_batch_crafting_set(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_experience_kept_output_moves_to_batch_crafting_set(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_experience_records_action_when_enchant_fails(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_for_experience_does_not_require_craft_experience_skill(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_and_enchant_for_experience_ignores_submitted_craft_experience_skill(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_batch_disposition_sell_directly_credits_gold_without_creating_inventory_slots(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_batch_crafting_set_move_failure_for_non_full_reason_continues_batch_instead_of_ending_it(): void
    {
        $this->instance(
            SkillCheckService::class,
            Mockery::mock(SkillCheckService::class, function ($mock) {
    ...
    public function test_status_payload_top_level_keys_are_unique(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_craft_experience_options_absent_when_all_crafting_skills_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_experience_options_include_only_non_maxed_skills(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
    ...
    public function test_status_returns_trinketry_experience_skill_progress(): void
    {
        $trinketry = $this->createGameSkill([
            'name' => 'Trinketry',
            'type' => SkillTypeValue::CRAFTING->value,
    ...
    public function test_status_returns_alchemy_experience_skill_progress(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $alchemySkill = $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value;
    ...
    public function test_status_omits_maxed_alchemy_and_trinketry_experience_skills(): void
    {
        $trinketry = $this->createGameSkill([
            'name' => 'Trinketry',
            'type' => SkillTypeValue::CRAFTING->value,
    ...
    public function test_craft_for_experience_rejected_when_all_four_crafting_skills_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_for_experience_available_when_at_least_one_crafting_skill_is_not_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_for_experience_does_not_require_craft_experience_skill(): void
    {
        $spellCrafting = $this->createGameSkill(['name' => 'Spell Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_for_experience_ignores_submitted_craft_experience_skill(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_for_experience_status_exposes_non_maxed_relevant_skill_progress_data(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
    ...
    public function test_craft_for_experience_queue_excludes_weapon_entries_when_weapon_crafting_is_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_for_experience_queue_excludes_armour_and_shield_entries_when_armour_crafting_is_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_for_experience_queue_excludes_ring_entries_when_ring_crafting_is_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_for_experience_queue_excludes_spell_damage_and_spell_healing_entries_when_spell_crafting_is_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_for_experience_queue_includes_only_non_maxed_skill_categories(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_specific_item_craft_starts_with_one_minute_pending_timer(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 1, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_amount_continues_after_an_individual_failed_attempt_when_continuing_is_possible(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 1000]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_and_enchant_specific_item_starts_with_one_minute_pending_timer(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 1, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_alchemy_amount_starts_with_one_minute_pending_timer(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_holy_oils_selected_waits_for_the_initial_full_minute(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_craft_set_does_not_require_a_selected_set_to_start(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_set_starts_with_one_minute_pending_timer(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $armour = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value]);
    ...
    public function test_craft_set_continues_to_next_set_item_after_an_individual_failed_attempt_when_continuing_is_possible(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_set_puts_crafted_items_into_crafted_items_set(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_craft_set_sell_disposition_does_not_create_crafted_items_set_output(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_set_destroy_disposition_does_not_create_crafted_items_set_output(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_set_stops_when_crafted_items_set_does_not_have_enough_space(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_enchant_set_validates_selected_set_ownership(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_enchant_set_processes_eligible_set_items(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value;
    ...
    public function test_holy_oils_set_validates_selected_set_ownership(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_holy_oils_set_calculates_total_remaining_stacks_and_oils_needed(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_holy_oils_set_applies_oils_only_to_items_with_remaining_stacks(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_holy_oils_set_stops_when_no_selected_oils_remain(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
        $item = $this->createItem(['type' => 'weapon', 'holy_stacks' => 1]);
    ...
    public function test_disenchant_disposition_records_gold_dust_gained(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_list_disposition_creates_market_board_row_using_supplied_listing_price(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_kept_crafted_item_action_log_includes_set_slot_id(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_status_exposes_chart_points_for_entire_run(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_status_normalizes_legacy_chart_points_to_the_current_numeric_contract(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting([
    ...
    public function test_cancel_updates_status_immediately_and_broadcasts(): void
    {
        Event::fake([BatchCraftingStatusUpdated::class]);
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
    ...
    public function test_cancel_exposes_dismiss_state_instead_of_cancel_state(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $user->id]);
    ...
    public function test_cancelled_batch_does_not_continue_when_processed_again(): void
    {
        $user = $this->createUser();
        $character = $this->createCharacter(['user_id' => $user->id, 'inventory_max' => 10, 'gold' => 100]);
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $user->id]);
    ...
    public function test_new_standalone_enchant_set_start_is_rejected(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_event_enchant_is_still_unavailable_without_event_eligibility(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_set_selects_highest_craftable_item_not_lowest(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_set_status_exposes_selected_set_requested_completed_and_gold_totals(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_set_status_exposes_clickable_item_snapshot_data(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_enchant_set_status_exposes_selected_set_eligible_total_and_affixes(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value;
    ...
    public function test_enchant_set_exposes_enchanted_count_clearly(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value;
    ...
    public function test_holy_oils_set_status_exposes_stack_oil_and_bonus_totals(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
        $item = $this->createItem(['type' => 'weapon', 'holy_stacks' => 1]);
    ...
    public function test_holy_oils_set_skips_items_with_no_remaining_stacks_and_counts_skips(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
        $maxedItem = $this->createItem(['type' => 'weapon', 'holy_stacks' => 1]);
    ...
    public function test_disenchanting_skill_progress_appears_when_not_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_disenchanting_skill_progress_does_not_appear_when_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_alchemy_amount_remains_valid_when_alchemy_is_maxed(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value;
    ...
    public function test_craft_set_queue_includes_every_valid_weapon_type(): void
    {
    ...
    public function test_craft_set_queue_includes_every_armour_type_including_shield(): void
    {
        $queue = resolve(BatchCraftingProcessor::class)->craftSetQueue();
    ...
    public function test_craft_set_queue_includes_exactly_two_ring_entries(): void
    {
        $queue = resolve(BatchCraftingProcessor::class)->craftSetQueue();
    ...
    public function test_craft_set_queue_includes_spell_damage_and_spell_healing(): void
    {
        $queue = resolve(BatchCraftingProcessor::class)->craftSetQueue();
    ...
    public function test_craft_set_requested_count_equals_real_queue_count(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $armour = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value]);
    ...
    public function test_craft_set_status_exposes_requested_completed_and_remaining_from_real_queue(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_set_completion_summary_reports_full_set_crafted(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_set_completion_summary_reports_partial_set_crafted(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_set_completion_summary_reports_no_set_items_crafted(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_set_selects_highest_craftable_armour_item(): void
    {
    ...
    public function test_craft_and_enchant_specific_status_exposes_current_crafted_and_enchanted_items(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $this->createBatchCrafting([
    ...
    public function test_holy_oils_selected_gear_status_exposes_applications_and_current_items(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_alchemy_amount_status_exposes_requested_completed_and_remaining_amount(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_and_enchant_status_exposes_crafted_and_enchanted_snapshot_lists_from_same_action(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $this->createBatchCrafting([
    ...
    public function test_enchant_set_status_uses_progress_enchanted_total_instead_of_capped_action_log(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_status_uses_progress_disenchanted_total_instead_of_capped_action_log(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $this->createBatchCrafting([
    ...
    public function test_alchemy_experience_status_exposes_alchemy_snapshots_and_full_run_totals(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
        $this->createBatchCrafting([
    ...
    public function test_trinketry_status_exposes_trinketry_snapshots_and_full_run_totals(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_holy_oils_selected_gear_status_exposes_target_item_snapshots(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
        $this->createBatchCrafting([
    ...
    public function test_chart_success_counts_enchanted_actions(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_chart_success_counts_disenchanted_actions(): void
    {
        Bus::fake();
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 5, false)->getCharacter();
    ...
    public function test_enchant_set_requested_remaining_and_progress_use_eligible_total(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $this->createBatchCrafting([
    ...
    public function test_enchant_set_status_exposes_actual_enchanted_item_snapshots(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $this->createBatchCrafting([
    ...
    public function test_craft_for_event_status_exposes_real_crafting_xp_gained(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_enchant_for_event_status_exposes_real_enchanting_xp_gained(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value;
    ...
    public function test_craft_and_enchant_for_experience_starts_when_all_crafting_skills_maxed_but_enchanting_is_not(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_and_enchant_for_experience_starts_when_enchanting_maxed_but_a_crafting_skill_is_not(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value;
    ...
    public function test_craft_and_enchant_for_experience_rejected_when_all_crafting_skills_and_enchanting_are_maxed(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_and_enchant_experience_processing_continues_when_enchanting_maxed_but_crafting_skill_is_not(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_amount_rejects_prefix_above_current_enchanting_level(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 1, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_amount_rejects_suffix_above_current_enchanting_level(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 1, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_set_does_not_use_selected_set_ownership(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0, 'cost' => 1])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_and_enchant_set_accepts_suffix_only_plan(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0, 'cost' => 1])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_and_enchant_set_accepts_prefix_only_plan(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0, 'cost' => 1])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_and_enchant_set_rejects_row_with_neither_prefix_nor_suffix(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_and_enchant_set_rejects_suffix_affix_id_in_prefix_slot(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_and_enchant_set_rejects_prefix_affix_id_in_suffix_slot(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_and_enchant_set_preview_cost_includes_prefix_only_cost(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_and_enchant_set_preview_cost_includes_suffix_only_cost(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_set_start_blocker_uses_craft_set_plan_not_enchant_plan_for_selected_high_cost_items(): void
    {
    ...
    public function test_craft_and_enchant_set_int_blocker_names_exact_offending_enchant_with_int_numbers(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $armour = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value]);
    ...
    public function test_craft_enchant_set_processor_does_not_auto_select_affix_for_empty_selected_plan_row(): void
    {
        $this->instance(
            SkillCheckService::class,
            Mockery::mock(SkillCheckService::class, function ($mock) {
    ...
    public function test_craft_and_enchant_set_rejects_prefix_affix_above_current_enchanting_level(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value;
    ...
    public function test_craft_and_enchant_set_starts_with_valid_full_enchant_plan(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0, 'cost' => 1])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_set_allows_sell_disposition(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0, 'cost' => 1])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_and_enchant_set_rejects_keep_best_sell_rest_disposition(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_and_enchant_set_enchants_each_planned_item_before_crafting_the_next_entry(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_set_places_completed_final_items_into_crafted_items_set(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_set_completion_summary_reports_full_set_completed(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_and_enchant_set_starts_with_one_minute_pending_timer(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0, 'cost' => 1])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_gold_dust_gained_over_time_chart_data_is_recorded_when_disposition_disenchants(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_set_status_exposes_current_prefix_and_suffix_when_enchanting(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_set_action_log_includes_phase(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_set_action_log_includes_prefix_and_suffix_when_applicable(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_set_logs_double_enchanted_status_when_both_affixes_apply(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_set_action_log_includes_gold_spent_for_craft_action(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_for_experience_status_exposes_crafted_items_set_max_slots_as_two_thousand(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 100, 'inventory_max' => 10]);
        $this->createBatchCrafting([
    ...
    public function test_craft_and_enchant_amount_keep_disposition_exposes_normal_inventory_capacity_data(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_craft_and_enchant_amount_sell_disposition_does_not_move_output_to_crafted_items_set(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_set_ignores_selected_set_id_since_destination_is_always_crafted_items_set(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_enchant_set_ignores_crafted_items_set_as_selected_set_because_destination_is_always_crafted_items_set(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 2000, 'inventory_max' => 30]);
    ...
    public function test_holy_oils_set_rejects_crafted_items_set_as_destination(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $craftedItemsSet = resolve(BatchCraftingSetService::class)->getOrCreateForCharacter($character);
    ...
    public function test_craft_set_does_not_require_an_empty_selected_set_since_no_set_is_needed(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_enchant_set_ignores_non_empty_selected_set_because_destination_is_always_crafted_items_set(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 2000, 'inventory_max' => 30]);
    ...
    public function test_craft_enchant_set_destroyed_enchant_records_honest_outcome_without_claiming_affixes(): void
    {
        $this->instance(
            SkillCheckService::class,
            Mockery::mock(SkillCheckService::class, function ($mock) {
    ...
    public function test_craft_and_enchant_amount_destroyed_enchant_records_honest_outcome(): void
    {
        $this->instance(
            SkillCheckService::class,
            Mockery::mock(SkillCheckService::class, function ($mock) {
    ...
    public function test_action_log_is_not_trimmed_past_fifty_entries(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $existingLog = [];
    ...
    public function test_craft_amount_status_exposes_crafted_items_set_destination_and_cost_preview(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_and_enchant_amount_status_exposes_enchant_risk_and_cost_preview(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_and_enchant_amount_preview_exposes_failure_risk_below_level_four_hundred(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_craft_and_enchant_amount_preview_hides_failure_risk_at_level_four_hundred(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_craft_and_enchant_amount_preview_works_with_no_affixes_selected(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_and_enchant_amount_preview_works_with_prefix_only(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_and_enchant_amount_preview_works_with_suffix_only(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_and_enchant_amount_preview_works_with_both_affixes_selected(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_and_enchant_amount_start_rejects_missing_required_affixes(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_holy_oils_selected_preview_treats_identical_name_items_as_separate_selections(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000000, 'inventory_max' => 10]);
    ...
    public function test_holy_oils_processing_applies_only_to_selected_owned_slot(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_batch_holy_oils_selected_destroy_emits_destroyed_server_message(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_batch_holy_oils_selected_list_emits_listed_server_message_with_price(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_batch_holy_oils_set_destroy_emits_destroyed_server_message(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_batch_holy_oils_set_list_emits_listed_server_message_with_price(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_alchemy_amount_status_exposes_bag_cap_and_cost_preview(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_alchemy_amount_preview_uses_specialized_alchemy_snapshot_details(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'shards' => 1000, 'inventory_max' => 10]);
    ...
    public function test_holy_oils_selected_preview_exposes_stacks_remaining_cost_and_capped(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_holy_oils_set_preview_exposes_per_item_stacks_total_remaining_cost_and_capped(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_holy_oil_set_preview_uses_numbered_name_for_unnamed_set(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_amount_allows_full_request_when_crafted_items_set_has_exactly_enough_remaining_space(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_amount_caps_at_remaining_crafted_items_set_space_when_request_exceeds_it(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_and_enchant_amount_allows_full_request_when_crafted_items_set_has_exactly_enough_remaining_space(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_craft_and_enchant_amount_caps_at_remaining_crafted_items_set_space_when_request_exceeds_it(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_start_sends_server_message_stating_first_action_runs_in_one_minute(): void
    {
        Event::fake([ServerMessageEvent::class]);
    ...
    public function test_brand_new_character_status_payload_shows_craft_for_experience_available(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_brand_new_character_status_payload_shows_craft_and_enchant_for_experience_available(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_craft_for_experience_is_available_when_any_relevant_crafting_skill_can_gain_xp(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_for_experience_is_available_when_a_crafting_skill_row_is_missing_entirely(): void
    {
    ...
    public function test_craft_for_experience_is_hidden_only_when_all_relevant_crafting_skills_are_maxed(): void
    {
        $weaponCraftingBase = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCraftingBase = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCraftingBase = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_and_enchant_for_experience_is_available_when_crafting_can_gain_xp(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_for_experience_is_available_when_only_enchanting_can_gain_xp(): void
    {
        $weaponCraftingBase = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCraftingBase = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCraftingBase = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_and_enchant_for_experience_is_available_when_enchanting_skill_row_is_missing_entirely(): void
    {
        $weaponCraftingBase = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCraftingBase = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCraftingBase = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_and_enchant_for_experience_is_hidden_only_when_crafting_and_enchanting_are_maxed(): void
    {
        $weaponCraftingBase = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCraftingBase = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCraftingBase = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_disenchanting_does_not_control_craft_and_enchant_for_experience_visibility(): void
    {
        $weaponCraftingBase = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCraftingBase = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCraftingBase = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_and_enchant_set_preview_exposes_full_plan_cost_and_affordability(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_set_preview_honors_selected_item_override_instead_of_highest(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_set_start_rejects_selected_item_for_wrong_slot_type(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_set_start_rejects_selected_item_not_craftable_by_character_skill_level(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_set_start_rejects_unaffordable_full_plan(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_set_preview_exposes_required_cost_and_affordability(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_alchemy_missing_currency_preview_identifies_required_currency_and_amounts(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_trinketry_missing_currency_preview_identifies_required_currency_and_amounts(): void
    {
        $trinketry = $this->createGameSkill(['name' => 'Trinketry', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($trinketry, 1, false)->getCharacter();
    ...
    public function test_trinketry_start_rejects_with_the_quoted_item_and_every_missing_currency_amount(): void
    {
        $trinketry = $this->createGameSkill(['name' => 'Trinketry', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($trinketry, 1, false)->getCharacter();
        $character->update(['gold_dust' => 4, 'copper_coins' => 7, 'shards' => 1000000, 'inventory_max' => 30]);
    ...
    public function test_active_faction_loyalty_automation_blocks_batch_crafting_start(): void
    {
        $spellCrafting = $this->createGameSkill(['name' => 'Spell Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_active_faction_loyalty_automation_blocks_craft_amount_start(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $this->createCharacterAutomation([
            'character_id' => $character->id,
    ...
    public function test_active_faction_loyalty_automation_blocks_craft_and_enchant_start(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $this->createCharacterAutomation([
            'character_id' => $character->id,
    ...
    public function test_active_faction_loyalty_automation_blocks_alchemy_start(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $this->createCharacterAutomation([
            'character_id' => $character->id,
    ...
    public function test_historical_faction_loyalty_automation_does_not_block_batch_crafting_start(): void
    {
        $spellCrafting = $this->createGameSkill(['name' => 'Spell Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($spellCrafting, 1, false)->getCharacter();
        $character->update(['gold' => 100, 'inventory_max' => 10]);
    ...
    public function test_craft_for_experience_failure_does_not_complete_batch(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting([
            'character_id' => $character->id,
    ...
    public function test_craft_amount_failure_does_not_complete_batch(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting([
            'character_id' => $character->id,
    ...
    public function test_craft_and_enchant_failure_does_not_complete_batch(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting([
            'character_id' => $character->id,
    ...
    public function test_alchemy_failure_does_not_complete_batch(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_trinketry_failure_does_not_complete_batch(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_batch_crafting_set_full_hard_stop_still_completes_batch(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting([
            'character_id' => $character->id,
    ...
    public function test_craft_for_experience_skips_too_easy_item_and_crafts_next_eligible_item(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_for_experience_stops_only_when_no_xp_eligible_craft_targets_remain(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_for_experience_skips_too_easy_craft_item_and_uses_next_eligible_item(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_for_experience_skips_too_easy_enchant_work_and_uses_eligible_enchant_work(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_craft_and_enchant_for_experience_destroyed_item_does_not_complete_batch(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $enchanting = $this->createGameSkill(['name' => 'Enchanting', 'type' => SkillTypeValue::ENCHANTING->value, 'max_level' => 400]);
        $this->instance(
    ...
    public function test_craft_and_enchant_for_experience_move_failure_for_non_full_reason_continues_batch(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_alchemy_for_experience_skips_too_easy_alchemy_work_and_uses_next_eligible_work(): void
    {
    ...
    public function test_alchemy_for_experience_stops_only_when_no_xp_eligible_alchemy_work_remains(): void
    {
        $alchemy = $this->createGameSkill(['name' => 'Alchemy', 'type' => SkillTypeValue::ALCHEMY->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $character->skills->first(function ($skill) {
    ...
    public function test_trinketry_for_experience_skips_too_easy_trinket_and_uses_next_eligible_trinket(): void
    {
        $trinketry = $this->createGameSkill(['name' => 'Trinketry', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_trinketry_for_experience_stops_only_when_no_xp_eligible_trinketry_work_remains(): void
    {
        $trinketry = $this->createGameSkill(['name' => 'Trinketry', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($trinketry, 300, false)->getCharacter();
        $character->update(['gold_dust' => 1000000, 'shards' => 1000000, 'copper_coins' => 1000000, 'inventory_max' => 200]);
    ...
    public function test_craft_set_does_not_permanently_skip_a_slot_after_a_normal_craft_failure(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 10, false)->getCharacter();
        $character->update(['gold' => 10, 'inventory_max' => 30]);
    ...
    public function test_craft_and_enchant_set_craft_phase_does_not_permanently_skip_a_plan_entry_after_a_normal_craft_failure(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 10, false)->getCharacter();
        $character->update(['gold' => 10, 'inventory_max' => 30]);
    ...
    public function test_craft_and_enchant_set_enchant_phase_does_not_mark_a_plan_entry_complete_after_a_normal_enchant_failure(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
    ...
    public function test_event_craft_cycles_to_next_event_goal_immediately_when_goal_completes_and_a_new_goal_becomes_available(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $schedule = $this->createScheduledEvent(['event_type' => EventType::WINTER_EVENT, 'status' => ScheduledEventStatus::RUNNING, 'currently_running' => true]);
        ...
        $this->assertSame($event->id, GlobalEventGoal::find($newGoalId)?->event_id);
    }

    public function test_event_craft_stops_with_event_goal_complete_when_no_next_goal_exists(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_unexpected_exception_immediately_creates_a_monitored_bug_report(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $character->user_id]);
        $processor = Mockery::mock(BatchCraftingProcessor::class);
    ...
    public function test_unexpected_exception_tells_player_it_was_a_server_issue(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $character->user_id]);
        $processor = Mockery::mock(BatchCraftingProcessor::class);
    ...
    public function test_normal_per_action_failure_does_not_create_a_monitored_bug_report(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $character->user_id]);
        $processor = Mockery::mock(BatchCraftingProcessor::class);
    ...
    public function test_craft_set_chart_outcome_counts_success_and_failure_per_action_not_per_count_column(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_amount_chart_outcome_counts_six_successes_and_three_failures(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_destroyed_enchant_outcome_counts_as_one_failure_not_one_success(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_one_tick_chart_outcome_data_is_present_after_a_single_tick(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_amount_normal_failure_keeps_processing_without_retry_delay(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_amount_without_countdown_hides_map_timer(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_set_normal_failure_keeps_processing_without_retry_delay(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_and_enchant_amount_normal_failure_keeps_processing_without_retry_delay(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_and_enchant_set_normal_failure_keeps_processing_without_retry_delay(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_hard_stop_does_not_schedule_a_retry_delay(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_status_skills_payload_includes_max_level_for_each_skill(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_craft_amount_skills_payload_only_includes_relevant_crafting_skill(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_craft_and_enchant_amount_skills_payload_includes_relevant_craft_skill_and_enchanting(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
    ...
    public function test_craft_and_enchant_amount_skills_payload_includes_disenchanting_when_disposition_disenchants_losers(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
    ...
    public function test_craft_and_enchant_amount_hard_stops_with_int_too_low_end_reason_when_selected_enchant_requires_more_int_than_character_has(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_for_experience_does_not_continue_retrying_when_auto_selected_enchant_requires_too_much_int_and_no_int_valid_enchant_exists(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_int_too_low_hard_stop_does_not_create_a_monitored_bug_report(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $character->user_id]);
        $processor = Mockery::mock(BatchCraftingProcessor::class);
    ...
    public function test_int_too_low_hard_stop_preserves_an_earlier_non_stopped_failure_action(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_int_too_low_hard_stop_preserves_an_earlier_successful_action(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_int_too_low_hard_stop_sends_player_facing_int_guidance_message(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_int_too_low_hard_stop_without_resolvable_affixes_uses_factual_fallback_details_and_message(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting(['character_id' => $character->id, 'user_id' => $character->user_id]);
        $processor = Mockery::mock(BatchCraftingProcessor::class);
    ...
    public function test_start_rejects_keep_highest_disposition_for_craft_and_enchant(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_keep_highest_for_craft_sells_the_lower_level_duplicate_item(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_keep_best_and_disenchant_rest_for_craft_and_enchant_disenchants_the_lower_level_duplicate_item(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_experience_keep_best_sell_rest_sells_replaced_retained_set_slot(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_experience_keep_best_destroy_rest_destroys_replaced_retained_set_slot(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_experience_keep_best_disenchant_rest_disenchants_replaced_retained_set_slot(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_experience_keep_best_sell_rest_sells_replaced_retained_set_slot(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_experience_keep_best_destroy_rest_destroys_replaced_retained_set_slot(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_alchemy_experience_keep_best_destroy_rest_destroys_replaced_retained_alchemy_bag_item(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $alchemySkill = $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value);
        $alchemySkill->update(['level' => 1, 'xp' => 100, 'xp_max' => 100]);
        ...
        $firstResult = resolve(BatchCraftingService::class)->process($batchCrafting);
        $firstSlot = AlchemyBagSlot::where('character_id', $character->id)->where('item_id', $lowItem->id)->first();
        ...
        $remainingSlots = AlchemyBagSlot::where('character_id', $character->id)->get();
        $this->assertCount(1, $remainingSlots);
        $this->assertSame($highItem->id, $remainingSlots->first()->item_id);
        $this->assertGreaterThanOrEqual(1, $secondResult->destroyed_count);
    }

    public function test_trinketry_experience_keep_best_destroy_rest_destroys_replaced_retained_set_slot(): void
    {
        $trinketry = $this->createGameSkill(['name' => 'Trinketry', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($trinketry, 1, false)->getCharacter();
        $character->update(['gold_dust' => 1000000, 'shards' => 1000000, 'copper_coins' => 1000000, 'inventory_max' => 30]);
    ...
    public function test_alchemy_use_now_uses_valid_boon_item_as_a_boon_on_the_character(): void
    {
        ...
        $this->assertSame(0, AlchemyBagSlot::where('character_id', $character->id)->where('item_id', $item->id)->count());
        $usedAction = collect($result->action_log)->first(fn (array $entry) => ($entry['disposition'] ?? null) === 'use_now');
        $this->assertNotNull($usedAction);
    }

    public function test_alchemy_use_now_keeps_kingdom_bomb_in_alchemy_bag_and_does_not_use_it(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value)->update(['level' => 2]);
        $character->update(['gold_dust' => 1000, 'shards' => 1000, 'alchemy_bag_limit' => 10]);
        ...
        $keptSlot = AlchemyBagSlot::where('character_id', $character->id)->where('item_id', $item->id)->first();
        $this->assertNotNull($keptSlot);
        $keptAction = collect($result->action_log)->first(fn (array $entry) => ($entry['disposition'] ?? null) === 'keep');
        $this->assertNotNull($keptAction);
    }

    public function test_alchemy_use_now_keeps_extra_boon_item_in_alchemy_bag_when_already_at_ten_boons(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value)->update(['level' => 2]);
        $character->update(['gold_dust' => 1000, 'shards' => 1000, 'alchemy_bag_limit' => 10]);
    ...
    public function test_alchemy_amount_destroy_processes_when_alchemy_bag_is_full(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value)->update(['level' => 2]);
    ...
    public function test_alchemy_amount_list_processes_when_alchemy_bag_is_full(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value)->update(['level' => 2]);
        $character->update(['gold_dust' => 1000, 'shards' => 1000, 'alchemy_bag_limit' => 1]);
    ...
    public function test_alchemy_amount_use_now_uses_valid_boon_when_alchemy_bag_is_full(): void
    {
        Bus::fake([CharacterBoonJob::class]);
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value)->update(['level' => 2]);
    ...
    public function test_alchemy_amount_use_now_stops_safely_for_kingdom_bomb_when_alchemy_bag_is_full(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value)->update(['level' => 2]);
        $character->update(['gold_dust' => 1000, 'shards' => 1000, 'alchemy_bag_limit' => 1]);
    ...
    public function test_alchemy_amount_keep_stops_when_alchemy_bag_is_full(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value)->update(['level' => 2]);
        $character->update(['gold_dust' => 1000, 'shards' => 1000, 'alchemy_bag_limit' => 1]);
    ...
    public function test_alchemy_experience_keep_best_destroy_rest_swaps_winner_without_requiring_extra_bag_capacity(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $alchemySkill = $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value);
        $alchemySkill->update(['level' => 1, 'xp' => 100, 'xp_max' => 100]);
    ...
    public function test_batch_craft_specific_item_emits_manual_crafted_server_message(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_batch_craft_and_enchant_specific_item_emits_manual_enchanted_server_message(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 400, false)->getCharacter();
    ...
    public function test_batch_trinketry_emits_manual_crafted_server_message(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $trinketry = $this->createGameSkill(['name' => 'Trinketry', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($trinketry, 1, false)->getCharacter();
    ...
    public function test_batch_sell_disposition_emits_manual_sold_server_message(): void
    {
        Event::fake([ServerMessageEvent::class]);
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 400, false)->getCharacter();
    ...
    public function test_alchemy_amount_rejects_sell_disposition(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'shards' => 1000, 'alchemy_bag_limit' => 10]);
    ...
    public function test_alchemy_experience_rejects_keep_best_sell_rest_disposition(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'shards' => 1000, 'alchemy_bag_limit' => 10]);
    ...
    public function test_keep_highest_for_alchemy_sells_the_lower_level_duplicate_item(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_keep_highest_for_trinketry_sells_the_lower_level_duplicate_item(): void
    {
        $this->instance(
            SkillCheckService::class,
            Mockery::mock(SkillCheckService::class, function ($mock) {
    ...
    public function test_chart_points_currency_records_gold_spent_and_gold_gained_as_separate_named_fields(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_trinketry_chart_records_gold_dust_and_copper_spent_and_gold_gained_separately(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_disenchant_chart_records_gold_spent_and_gold_dust_gained_separately(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_craft_and_enchant_set_status_exposes_final_item_progress_out_of_twenty_three_instead_of_work_units(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $this->createBatchCrafting([
    ...
    public function test_preview_returns_start_blockers_key(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_amount_preview_blocks_when_total_cost_exceeds_available_gold(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 10, 'inventory_max' => 30]);
    ...
    public function test_craft_amount_preview_blocks_when_crafted_items_set_is_full(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_amount_preview_blocks_when_requested_amount_exceeds_crafted_items_set_space(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_amount_start_rejects_when_total_cost_exceeds_available_gold(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 10, 'inventory_max' => 30]);
    ...
    public function test_craft_and_enchant_amount_preview_blocks_when_selected_prefix_int_too_high(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
    ...
    public function test_craft_and_enchant_amount_preview_blocks_when_selected_suffix_int_too_high(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30, 'int' => 1]);
    ...
    public function test_craft_and_enchant_amount_preview_blocks_when_item_plus_enchant_cost_exceeds_gold(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
    ...
    public function test_craft_and_enchant_amount_start_rejects_when_selected_affix_int_too_high(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30, 'int' => 1]);
    ...
    public function test_craft_set_preview_blocks_when_full_plan_cost_exceeds_gold(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
    ...
    public function test_craft_set_preview_blocks_when_crafted_items_set_does_not_have_enough_space_for_full_queue(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_set_start_rejects_when_crafted_items_set_does_not_have_enough_space_for_full_queue(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_and_enchant_set_preview_blocks_when_planned_affix_int_too_high(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_craft_and_enchant_set_preview_blocks_when_full_plan_cost_exceeds_gold(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value)->update(['level' => 5, 'xp' => 0, 'xp_max' => 100]);
    ...
    public function test_craft_and_enchant_set_start_rejects_when_planned_affix_int_too_high(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value)->update(['level' => 5, 'xp' => 0, 'xp_max' => 100]);
        $character->update(['gold' => 1000, 'inventory_max' => 30, 'int' => 1]);
    ...
    public function test_alchemy_amount_preview_blocks_when_gold_dust_insufficient(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_alchemy_amount_preview_blocks_when_shards_insufficient(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_alchemy_amount_preview_blocks_when_alchemy_bag_is_full(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_alchemy_amount_preview_blocks_when_requested_amount_exceeds_bag_remaining_space(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_alchemy_amount_start_rejects_when_gold_dust_insufficient(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 10, 'shards' => 1000, 'alchemy_bag_limit' => 100]);
    ...
    public function test_craft_enchant_set_preview_ignores_equipped_selected_set_because_destination_is_crafted_items_set(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_enchant_set_start_ignores_equipped_selected_set_because_destination_is_crafted_items_set(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 2000, 'inventory_max' => 30]);
    ...
    public function test_craft_set_preview_returns_plan_entries_for_every_queue_slot(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_set_starts_with_selected_wand_and_persists_weapon_crafting_type(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_and_enchant_set_starts_with_selected_wand(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $ringCrafting = $this->createGameSkill(['name' => 'Ring Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
    ...
    public function test_craft_set_execution_queue_persists_shield_with_armour_crafting_type(): void
    {
        $armourCrafting = $this->createGameSkill(['name' => 'Armour Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($armourCrafting, 5, false)->getCharacter();
    ...
    public function test_craft_set_preview_cost_reflects_manually_selected_item_override(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_set_preview_does_not_replace_an_unavailable_explicit_selection(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_set_preview_reports_unavailable_explicit_selection_blocker_metadata(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_set_preview_reports_when_a_target_has_no_craftable_candidate(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_and_enchant_set_preview_reports_unavailable_explicit_selection_without_fallback_cost(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_set_start_rejects_selected_item_not_craftable_for_slot(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_and_enchant_set_preview_allows_empty_normal_unequipped_set_with_no_target_set_blockers(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_and_enchant_set_preview_allows_valid_full_twenty_three_item_set_composition(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_and_enchant_set_preview_ignores_invalid_non_empty_selected_set(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_and_enchant_set_preview_does_not_warn_for_already_enchanted_selected_set(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_craft_and_enchant_set_preview_ignores_mythic_item_in_selected_set(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_status_exposes_actions_per_minute_and_experience_rate_label_for_craft_experience(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $batchCrafting = resolve(BatchCraftingService::class)->start($character, [
    ...
    public function test_status_exposes_actions_per_minute_and_experience_rate_label_for_enchant_for_event(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
        $schedule = $this->createScheduledEvent(['event_type' => EventType::WINTER_EVENT, 'status' => ScheduledEventStatus::RUNNING, 'currently_running' => true]);
    ...
    public function test_craft_amount_processes_when_normal_inventory_is_full_but_crafted_items_set_has_space(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
    ...
    public function test_craft_and_enchant_for_experience_processes_when_normal_inventory_is_full_but_crafted_items_set_has_space(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_craft_and_enchant_amount_processes_when_normal_inventory_is_full_but_crafted_items_set_has_space(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false, ['xp' => 100, 'xp_max' => 100])->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value)->update(['level' => 400, 'xp' => 0, 'xp_max' => 100]);
    ...
    public function test_craft_and_enchant_set_build_new_processes_when_normal_inventory_is_full_but_crafted_items_set_has_space(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value)->update(['level' => 5, 'xp' => 100, 'xp_max' => 100]);
    ...
    public function test_trinketry_processes_when_normal_inventory_is_full_but_crafted_items_set_has_space(): void
    {
        $trinketry = $this->createGameSkill(['name' => 'Trinketry', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($trinketry, 10, false)->getCharacter();
    ...
    public function test_craft_amount_sell_preview_does_not_require_crafted_items_set_capacity(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_amount_keep_preview_still_requires_crafted_items_set_capacity(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_craft_and_enchant_amount_list_preview_is_not_capped_by_crafted_items_set_capacity(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false)->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value)->update(['level' => 5, 'xp' => 100, 'xp_max' => 100]);
    ...
    public function test_alchemy_amount_list_preview_does_not_require_alchemy_bag_capacity(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000, 'shards' => 1000, 'alchemy_bag_limit' => 1]);
    ...
    public function test_holy_oils_selected_list_rejects_when_any_selected_target_is_ineligible(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_holy_oils_selected_disenchant_rejects_when_any_selected_target_is_ineligible(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000]);
    ...
    public function test_missing_output_destination_defaults_to_crafted_items_set(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_output_set_destination_must_belong_to_character(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $otherCharacter = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_output_set_destination_must_not_be_the_crafted_items_set(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $craftedItemsSet = resolve(BatchCraftingSetService::class)->getOrCreateForCharacter($character);
    ...
    public function test_output_set_destination_must_not_be_equipped(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id, 'is_equipped' => true]);
    ...
    public function test_output_set_destination_must_be_empty_at_start(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $set = $this->createInventorySet(['character_id' => $character->id]);
    ...
    public function test_output_set_destination_allows_start_with_a_valid_empty_unequipped_set(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_inventory_output_destination_requires_enough_free_inventory_slots(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_preview_returns_inventory_destination_capacity(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_preview_returns_specified_set_destination_capacity(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_status_returns_selected_output_destination_and_set(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_non_keep_disposition_does_not_normalize_an_output_destination(): void
    {
        Item::factory()->state(['can_craft' => true, 'skill_level_required' => 0])->sequence(['type' => 'body', 'crafting_type' => 'armour'], ['type' => 'leggings', 'crafting_type' => 'armour'], ['type' => 'sleeves', 'crafting_type' => 'armour'], ['type' => 'gloves', 'crafting_type' => 'armour'], ['type' => 'feet', 'crafting_type' => 'armour'], ['type' => 'helmet', 'crafting_type' => 'armour'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'ring', 'crafting_type' => 'ring'], ['type' => 'spell-damage', 'crafting_type' => 'spell'], ['type' => 'spell-healing', 'crafting_type' => 'spell'])->count(10)->create();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_continuation_state_active_with_retry_failed_attempt_reason_after_a_normal_failure(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 10, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_next_attempt_at_matches_the_scheduled_immediate_delay(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 10, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        ...
        $nextAttemptAt = Carbon::parse($result->progress['next_attempt_at']);

        $this->assertTrue($nextAttemptAt->betweenIncluded($before, $before->copy()->addSeconds(5)));
    }

    public function test_mark_processing_sets_state_to_processing_and_clears_next_attempt_at(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $batchCrafting = $this->createBatchCrafting([
    ...
    public function test_mark_processing_clears_initial_startup_metadata(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting([
            'character_id' => $character->id,
    ...
    public function test_mark_processing_leaves_a_non_running_batch_unchanged(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $batchCrafting = $this->createBatchCrafting([
            'character_id' => $character->id,
    ...
    public function test_a_completed_batch_clears_continuation_state(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_a_cancelled_batch_clears_continuation_state(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $this->createBatchCrafting([
            'character_id' => $character->id,
    ...
    public function test_status_exposes_every_continuation_state_key(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $this->createBatchCrafting([
            'character_id' => $character->id,
    ...
    public function test_status_exposes_output_destination_label_for_inventory_destination(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $this->createBatchCrafting([
    ...
    public function test_status_uses_custom_name_for_selected_inventory_set(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_status_uses_numbered_name_for_unnamed_selected_inventory_set(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $this->createInventorySet([
    ...
    public function test_status_exposes_output_destination_label_as_exact_set_name_for_inventory_set_destination(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_status_uses_numbered_name_for_unnamed_output_inventory_set(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $this->createInventorySet([
    ...
    public function test_status_exposes_crafted_items_set_label_for_legacy_batch_without_output_destination(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $this->createBatchCrafting([
    ...
    public function test_status_does_not_replace_selected_set_with_output_destination_data_for_enchant_set(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_start_initializes_waiting_continuation_state_before_first_job(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_status_exposes_initial_waiting_continuation_immediately_after_start(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_mark_processing_changes_initial_waiting_continuation_to_processing_and_clears_next_attempt_at(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_status_does_not_expose_kept_output_committed_flag(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false, ['xp' => 100, 'xp_max' => 100])->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_craft_set_advances_only_after_output_slot_exists(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false, ['xp' => 100, 'xp_max' => 100])->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_failed_destination_commit_does_not_increment_model_kept_count_column(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false, ['xp' => 100, 'xp_max' => 100])->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_failed_destination_commit_does_not_persist_a_kept_disposition_in_the_action_log(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 5]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($weaponCrafting, 5, false, ['xp' => 100, 'xp_max' => 100])->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 10]);
    ...
    public function test_successful_craft_experience_cycle_resets_and_stores_waiting_continuation_for_next_scheduled_attempt(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 10, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 200]);
    ...
    public function test_successful_craft_and_enchant_experience_cycle_resets_and_stores_waiting_continuation_for_next_scheduled_attempt(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_successful_alchemy_experience_tick_stores_waiting_continuation_for_next_scheduled_attempt(): void
    {
        $this->instance(
            SkillCheckService::class,
            Mockery::mock(SkillCheckService::class, function ($mock) {
    ...
    public function test_successful_trinketry_experience_tick_stores_waiting_continuation_for_next_scheduled_attempt(): void
    {
        $trinketry = $this->createGameSkill(['name' => 'Trinketry', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($trinketry, 300, false)->getCharacter();
        $character->update(['gold_dust' => 1000000, 'shards' => 1000000, 'copper_coins' => 1000000, 'inventory_max' => 200]);
    ...
    public function test_successful_event_craft_tick_leaves_event_running_and_stores_waiting_continuation(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_successful_event_enchant_tick_leaves_event_running_and_stores_waiting_continuation(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $character->skills->first(function ($skill) {
            return $skill->baseSkill->type === SkillTypeValue::ENCHANTING->value;
    ...
    public function test_finite_remaining_work_stays_processing_without_countdown(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 10, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 200]);
    ...
    public function test_finite_failed_attempt_remains_in_processing_state(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 10, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_destroyed_craft_and_enchant_item_continuation_takes_priority_over_generic_message(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)
            ->createBaseCharacter()
    ...
    public function test_craft_amount_processes_one_atomic_operation_without_waiting(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 10, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 200]);
    ...
    public function test_craft_and_enchant_amount_processes_one_atomic_operation_without_waiting(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->assignSkill($weaponCrafting, 10, false)->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 200]);
    ...
    public function test_alchemy_amount_processes_one_atomic_operation_without_waiting(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_holy_oils_selected_processes_one_atomic_operation_without_waiting(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function test_start_strips_output_destination_for_craft_experience_progress(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
    ...
    public function test_start_strips_output_destination_for_event_craft_progress(): void
    {
        $weaponCrafting = $this->createGameSkill(['name' => 'Weapon Crafting', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
    ...
    public function test_start_strips_output_destination_for_event_enchant_progress(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $character->update(['gold' => 1000, 'inventory_max' => 30]);
        $schedule = $this->createScheduledEvent(['event_type' => EventType::WINTER_EVENT, 'status' => ScheduledEventStatus::RUNNING, 'currently_running' => true]);
    ...
    public function test_start_strips_output_destination_for_alchemy_amount_progress(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->skills->first(fn ($skill) => $skill->baseSkill->type === SkillTypeValue::ALCHEMY->value)->update(['level' => 2]);
    ...
    public function test_start_strips_output_destination_for_trinketry_progress(): void
    {
        $trinketry = $this->createGameSkill(['name' => 'Trinketry', 'type' => SkillTypeValue::CRAFTING->value, 'max_level' => 400]);
        $character = (new CharacterFactory)->createBaseCharacter()->assignSkill($trinketry, 1, false)->getCharacter();
    ...
    public function test_start_strips_output_destination_for_holy_oils_selected_progress(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $character->update(['gold_dust' => 1000]);
        $item = $this->createItem(['type' => 'weapon', 'holy_stacks' => 1]);
    ...
    public function test_destroyed_event_enchant_uses_immediate_waiting_continuation(): void
    {
