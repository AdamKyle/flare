...
class LocationServiceTest extends TestCase {
    ...
    public function testCanManageOwnKingdom() {
        ...
        $data = $locationService->getLocationData($this->character->getCharacter(false));
    ...
    public function testCanAttackKingdom() {
        ...
        $secondCharacter = $this->createEnemyKingdom()->getCharacter(false);
    ...
    public function testCanAttackNPCKingdom() {
        $locationService = resolve(LocationService::class);
        ...
        $secondCharacter->kingdoms()->first()->update([
            'character_id' => null,
            'npc_owned'   => true,
        ]);
