...
class FactionLoyaltyTopsServiceTest extends TestCase
{
    ...
    public function testFactionLoyaltyTopsIncludesHighestFactionName(): void
    {
        $user = User::factory()->create();
        $character = Character::factory()->create(['user_id' => $user->id]);
    ...
    public function testFactionLoyaltyTopsIncludesTotalFactionLevelAcrossMaps(): void
    {
        $user = User::factory()->create();
        $character = Character::factory()->create(['user_id' => $user->id]);
    ...
    public function testFactionLoyaltyCurrentMonthAndAllTimeUseCumulativeRowsAndPrimaryMetrics(): void
    {
        $user = User::factory()->create();
        $character = Character::factory()->create(['user_id' => $user->id]);
        $map = GameMap::factory()->create();
