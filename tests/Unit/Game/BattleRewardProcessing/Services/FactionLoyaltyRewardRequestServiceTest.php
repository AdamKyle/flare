...
class FactionLoyaltyRewardRequestServiceTest extends TestCase
{
    ...
    public function test_enqueue_creates_new_request_when_no_existing_request_exists(): void
    {
        Event::fake();
        Queue::fake();
    ...
    public function test_enqueue_returns_pending_request_without_creating_a_new_one(): void
    {
        Event::fake();
        Queue::fake();
    ...
    public function test_enqueue_returns_completed_request_without_creating_a_new_one(): void
    {
        Event::fake();
        Queue::fake();
