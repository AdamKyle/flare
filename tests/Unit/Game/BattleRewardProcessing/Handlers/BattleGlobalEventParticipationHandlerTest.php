...
class BattleGlobalEventParticipationHandlerTest extends TestCase
{
    ...
    public function testCreatesParticipationOnFirstKill(): void
    {
        Event::fake();
    ...
    public function testUpdatesExistingParticipationScopedByGoalId(): void
    {
        Event::fake();
    ...
    public function testKillsAreCappedAtMaxKills(): void
    {
        Event::fake();
