...
class BattleDropTest extends TestCase
{
    ...
    public function test_apply_planned_item_does_not_give_second_quest_item_copy_when_preloaded_inventory_slots_is_stale(): void
    {
        Event::fake([ServerMessageEvent::class, GlobalMessageEvent::class]);
    ...
    public function test_apply_planned_item_does_not_give_quest_item_when_related_quest_is_already_completed(): void
    {
        $gameMap = $this->createGameMap(['name' => MapNameValue::SURFACE, 'path' => 'path', 'default' => true]);
    ...
    public function test_apply_planned_item_allows_duplicate_normal_items(): void
    {
        Event::fake([ServerMessageEvent::class, GlobalMessageEvent::class]);
