...
class RaidMapConflictServiceTest extends TestCase
{
    ...
    public function test_corrupted_location_maps_are_included_and_deduplicated(): void
    {
        $gameMap = $this->createGameMap(['name' => 'Surface']);
        $bossLocation = $this->createLocation(['game_map_id' => $gameMap->id]);
    ...
    public function test_active_same_map_raid_conflicts(): void
    {
        $gameMap = $this->createGameMap(['name' => 'Surface']);
        $bossLocation = $this->createLocation(['game_map_id' => $gameMap->id]);
    ...
    public function test_waiting_seasonal_child_reserves_map(): void
    {
        $gameMap = $this->createGameMap(['name' => 'Surface']);
        $bossLocation = $this->createLocation(['game_map_id' => $gameMap->id]);
    ...
    public function test_different_map_raid_does_not_conflict(): void
    {
    ...
    public function test_two_requested_same_map_raids_conflict(): void
    {
        $gameMap = $this->createGameMap(['name' => 'Surface']);
        $bossLocation = $this->createLocation(['game_map_id' => $gameMap->id]);
    ...
    public function test_two_requested_different_map_raids_do_not_conflict(): void
    {
        $gameMapOne = $this->createGameMap(['name' => 'Surface']);
        $gameMapTwo = $this->createGameMap(['name' => 'Labyrinth']);
        $bossLocationOne = $this->createLocation(['game_map_id' => $gameMapOne->id]);
