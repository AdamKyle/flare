...
class AttackedKingdomBuilderTest extends TestCase {
    ...
    public function testLostAll() {
        ...
        $unitLog = $this->createUnitsLog($kingdom->getCharacter(false), $kingdom->getKingdom());
    ...
    public function testLostSomeWithHealers() {
        ...
        $unitLog = $this->createUnitsLog($kingdom->getCharacter(false), $kingdom->getKingdom(), 100, 25, 5, true);
        $log     = $this->createKingdomLog($unitLog);
