...
class CapitalCityUpdateAutoWalkedKingdomsTest extends TestCase
{
    ...
    public function testJobKeepsEmergencyRetryAndBackoffConfiguration(): void
    {
    ...
    public function testFailedLogsOriginalExceptionAndKingdomIdentifier(): void
    {
    ...
    public function testBroadcastFailureAfterTransformationDoesNotFailOrRepeatTransformation(): void
    {
