...
class CapitalCityUnitManagementTest extends TestCase
{
    ...
    public function testMassRecruitmentAcrossMultipleKingdomsCreatesOneQueuePerKingdom(): void
    {
        Queue::fake();
        Event::fake();
    ...
    public function testActiveCapitalCityUnitQueueBlocksUnitFromBeingQueued(): void
    {
        Queue::fake();
        Event::fake();
    ...
    public function testActiveManualUnitQueueBlocksUnitFromBeingQueued(): void
    {
        Queue::fake();
        Event::fake();
    ...
    public function testOwnedUnitsCountAgainstMaxInRecruitmentRequest(): void
    {
        Queue::fake();
    ...
    public function testUIRefreshEventsFireOnceForEntireMassRequest(): void
    {
        Queue::fake();
        Event::fake();
    ...
    public function testPerKingdomProgressEventsFireForMassRecruitmentRequest(): void
    {
        Queue::fake();
        Event::fake();
    ...
    public function testLargerRequestShapeCreatesCorrectNumberOfQueues(): void
    {
        Queue::fake();
        Event::fake();
