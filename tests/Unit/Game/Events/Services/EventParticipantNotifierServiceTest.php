...
{
    use RefreshDatabase, CreateGameMap, CreateGlobalEventGoal;

    public function testDoesNothingWhenParticipantsCountIsZero(): void
    {
    ...
    public function testDoesNothingWhenNoParticipationRowsExist(): void
    {
        EventFacade::fake([UpdateEventGoalProgress::class, UpdateCharacterStatus::class]);
    ...
    public function testDoesNothingWhenNoMapExistsForEventType(): void
    {
        EventFacade::fake([UpdateEventGoalProgress::class, UpdateCharacterStatus::class]);
    ...
    public function testNotifiesUniqueParticipantsWithAggregatedTotals(): void
    {
        EventFacade::fake([UpdateEventGoalProgress::class, UpdateCharacterStatus::class]);
