...
class GlobalEventGoalEligibilityServiceTest extends TestCase
{
    ...
    public function testCraftingEligibilityReturnsExactMapEventGoal(): void
    {
    ...
    public function testEnchantingEligibilityReturnsExactMapEventGoal(): void
    {
        $schedule = ScheduledEvent::factory()->create([
    ...
    public function testCraftingGoalIsNullWhenCharacterNotOnEventMap(): void
    {
        $schedule = ScheduledEvent::factory()->create([
            'event_type' => EventType::DELUSIONAL_MEMORIES_EVENT,
            'status' => ScheduledEventStatus::RUNNING,
    ...
    public function testCraftingGoalIsNullWhenScheduleHasNotStartedYet(): void
    {
        $schedule = ScheduledEvent::factory()->create([
            'event_type' => EventType::DELUSIONAL_MEMORIES_EVENT,
    ...
    public function testEventForCharacterMapResolvesWinterAndDelusionalIndependently(): void
    {
