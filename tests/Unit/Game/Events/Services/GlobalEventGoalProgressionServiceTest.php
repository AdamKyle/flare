...
class GlobalEventGoalProgressionServiceTest extends TestCase
{
    ...
    public function testProgressingDelusionalCreatesNextGoalWithSameEventIdAndLeavesWinterGoalUnchanged(): void
    {
    ...
    public function testAdvanceIfCurrentGoalCompleteReturnsFalseWhenGoalNotComplete(): void
    {
