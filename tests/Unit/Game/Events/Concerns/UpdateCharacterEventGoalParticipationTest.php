...
class UpdateCharacterEventGoalParticipationTest extends TestCase
{
    ...
    public function testMissingKillChildRowCreatesKillChildRowUsingUpdatedParentCurrentKillsTotal(): void
    {
        Event::fake();
    ...
    public function testMissingCraftChildRowCreatesCraftChildRowUsingUpdatedParentCurrentCraftsTotal(): void
    {
        Event::fake();
    ...
    public function testMissingEnchantChildRowCreatesEnchantChildRowUsingUpdatedParentCurrentEnchantsTotal(): void
    {
        Event::fake();
    ...
    public function testExistingChildRowIsUpdatedToTheSameTotalAsTheParentParticipationRow(): void
    {
        Event::fake();
    ...
    public function testDifferentGlobalEventGoalIdRowsAreNotTouched(): void
    {
        Event::fake();
