...
class SeerServiceTest extends TestCase
{
    ...
    public function test_cannot_remove_gems_from_item_when_gem_bag_is_full()
    {
        $item = $this->createItem([
            'socket_count' => 5,
        ]);
    ...
    public function test_remove_the_actual_gem_creates_a_new_gem_bag_slot()
    {
    ...
    public function test_gem_bag_cannot_fit_all_gems_being_removed()
    {
        $item = $this->createItem([
            'socket_count' => 2,
        ]);
    ...
    public function test_cannot_replace_gem_when_gem_bag_is_full()
    {
        $gemForItem = $this->createGem();
    ...
    public function test_replace_the_gem_on_the_item_creates_a_new_gem_bag_slot()
    {
        $gemForItem = $this->createGem();
    ...
    public function test_add_the_gem_to_the_item_deletes_selected_gem_bag_slot()
    {
        $item = $this->createItem([
            'socket_count' => 1,
        ]);
