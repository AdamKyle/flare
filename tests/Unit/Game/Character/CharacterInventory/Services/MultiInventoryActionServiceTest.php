...
class MultiInventoryActionServiceTest extends TestCase
{
    ...
    public function testSellAllCraftedItemsSetSlotsSellsEveryEligibleItemAndIncreasesGoldByEligibleSaleValuesOnly(): void
    {
    ...
    public function testSellAllCraftedItemsSetSlotsKeepsTrinkets(): void
    {
        $trinket = $this->createItem(['type' => 'trinket']);
    ...
    public function testSellAllCraftedItemsSetSlotsKeepsArtifacts(): void
    {
    ...
    public function testSellAllCraftedItemsSetSlotsKeepsQuestItems(): void
    {
    ...
    public function testSellAllCraftedItemsSetSlotsKeepsGems(): void
    {
    ...
    public function testSellAllCraftedItemsSetSlotsKeepsAlchemyItems(): void
    {
    ...
    public function testSellAllCraftedItemsSetSlotsRejectsNormalSetTarget(): void
    {
        $item = $this->createItem();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $normalSet = $character->inventorySets()->create([
    ...
    public function testSellAllCraftedItemsSetSlotsDoesNotSellAnotherCharactersSetSlots(): void
    {
        $item = $this->createItem();
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        $otherCharacter = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function testDisenchantAllCraftedItemsSetSlotsQueuesEveryEnchantedEligibleItemAndDispatchesDisenchantMany(): void
    {
        Bus::fake();
    ...
    public function testDisenchantAllCraftedItemsSetSlotsKeepsUnenchantedItems(): void
    {
    ...
    public function testDisenchantAllCraftedItemsSetSlotsKeepsAlchemyItems(): void
    {
    ...
    public function testDisenchantAllCraftedItemsSetSlotsKeepsGems(): void
    {
    ...
    public function testDisenchantAllCraftedItemsSetSlotsKeepsQuestItems(): void
    {
    ...
    public function testDisenchantAllCraftedItemsSetSlotsKeepsArtifacts(): void
    {
    ...
    public function testDisenchantAllCraftedItemsSetSlotsKeepsTrinkets(): void
    {
    ...
    public function testDisenchantAllCraftedItemsSetSlotsRejectsNormalSetTarget(): void
    {
    ...
    public function testDisenchantAllCraftedItemsSetSlotsDoesNotDisenchantAnotherCharactersSetSlots(): void
    {
