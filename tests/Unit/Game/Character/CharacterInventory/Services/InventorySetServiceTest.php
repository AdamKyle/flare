...
class InventorySetServiceTest extends TestCase
{
    ...
    public function test_cannot_partially_empty_set_when_whole_set_cannot_fit_in_inventory()
    {
        $character = $this->character
            ->inventorySetManagement()
            ->createInventorySets(1, true)
    ...
    public function test_cannot_move_inventory_item_into_batch_crafting_set(): void
    {
        $item = $this->createItem();
        $character = $this->character
            ->inventoryManagement()
    ...
    public function test_cannot_save_equipped_items_into_batch_crafting_set(): void
    {
    ...
    public function test_cannot_rename_batch_crafting_set(): void
    {
        $character = $this->character->getCharacter();
        $set = $character->inventorySets()->create([
            'name' => InventorySet::BATCH_CRAFTING_SET_NAME,
    ...
    public function test_cannot_equip_batch_crafting_set(): void
    {
        $character = $this->character->getCharacter();
        $set = $character->inventorySets()->create([
            'name' => InventorySet::BATCH_CRAFTING_SET_NAME,
    ...
    public function test_can_remove_one_item_from_batch_crafting_set_when_inventory_has_room(): void
    {
        $item = $this->createItem();
        $character = $this->character->getCharacter();
        $set = $character->inventorySets()->create([
    ...
    public function test_cannot_empty_set_when_whole_set_cannot_fit_in_inventory(): void
    {
        $character = $this->character
            ->inventorySetManagement()
            ->createInventorySets(1, true)
    ...
    public function test_can_remove_item_from_batch_crafting_set_when_inventory_has_room(): void
    {
        $item = $this->createItem();
    ...
    public function test_cannot_move_item_into_batch_crafting_set(): void
    {
        $item = $this->createItem();
        $character = $this->character
            ->inventoryManagement()
