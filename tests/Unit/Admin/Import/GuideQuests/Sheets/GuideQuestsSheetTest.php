...
class GuideQuestsSheetTest extends TestCase
{
    ...
    public function testImportCreatesGuideQuestWithBatchCraftingRequirement(): void
    {
    ...
    public function testInvalidHolyOilsImportClearsBatchCraftingRequirementFields(): void
    {
        (new GuideQuestsSheet)->collection(new Collection([
            new Collection([
                'id',
    ...
    public function testImportCreatesRequiredBatchCraftedItems(): void
    {
    ...
    public function testImportUpdatesRequiredBatchCraftedItems(): void
    {
    ...
    public function testImportSkipsInvalidBatchCraftedItemRows(): void
    {
    ...
    public function testImportSetsRequiredBatchCraftedItemsToNullWhenAllRowsAreInvalidOrBlank(): void
    {
        (new GuideQuestsSheet)->collection(new Collection([
            new Collection([
                'id',
    ...
    public function testImportPreservesMustBeEnchantedAsTwoEnchantRequirementFlag(): void
    {
    ...
    public function testImportDoesNotRequireOrStoreSpecificEnchantmentIds(): void
    {
    ...
    public function testImportCreatesOneInventoryRowAndOneAlchemyBagRow(): void
    {
    ...
    public function testImportForcesAlchemyRowMustBeEnchantedToFalse(): void
    {
    ...
    public function testImportSkipsInvalidAlchemyRowsWhereItemTypeIsNotAlchemy(): void
    {
    ...
    public function testImportSkipsInvalidInventoryRowsWhereItemTypeIsAlchemy(): void
    {
    ...
    public function testImportIgnoresRowsThreeThroughFiveIfOldColumnsArePresent(): void
    {
