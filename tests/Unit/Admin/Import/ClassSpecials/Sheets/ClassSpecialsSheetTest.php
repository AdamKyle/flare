...
class ClassSpecialsSheetTest extends TestCase
{
    ...
    public function test_collection_creates_new_class_special_from_row(): void
    {
    ...
    public function test_collection_updates_existing_class_special_by_name(): void
    {
        $gameClass = $this->createClass(['name' => 'Beastmaster', 'damage_stat' => 'str', 'to_hit_stat' => 'dex']);
    ...
    public function test_collection_skips_header_row(): void
    {
        (new ClassSpecialsSheet)->collection(new Collection([
