...
class AdminStatisticsDashboardServiceTest extends TestCase
{
    ...
    public function testHighestLevelCharacterOrdersByCharacterLevel(): void
    {
    ...
    public function testRichestCharacterOrdersByCharacterGold(): void
    {
    ...
    public function testAverageLoginDurationExcludesOpenSessions(): void
    {
    ...
    public function testSnapshotIncludesLoginParticipationData(): void
    {
        $this->createUser();
    ...
    public function testLoginParticipationPercentageUsesDistinctUsersAndDocumentedDenominator(): void
    {
    ...
    public function testLoginParticipationWindowsIncludeRequiredRanges(): void
    {
        $this->createUser();
    ...
    public function testOnlineCharactersAreBasedOnOpenLoginDurationRows(): void
    {
    ...
    public function testOnlineCharactersExcludeStaleOpenLoginRowsWithOldHeartbeat(): void
    {
    ...
    public function testOnlineCharactersIncludeRecentHeartbeatOpenSessions(): void
    {
    ...
    public function testTodayLoginCountChartHasTwentyFourReadableHourlyPoints(): void
    {
        $user = $this->createUser();
        UserLoginDuration::factory()->create([
            'user_id' => $user->id,
    ...
    public function testLoginActivityChartIncludesLoginsAndInactiveUsersDeletedSeries(): void
    {
    ...
    public function testInactiveUserDeletionStatisticsAreRecordedWhenDeleteCommandRuns(): void
    {
        Queue::fake();
    ...
    public function testCharacterGoldStatsIncludeCharactersWithoutKingdoms(): void
    {
    ...
    public function testGuideQuestCompletionStatsUseGuideQuestCompletionSource(): void
    {
        $user = $this->createUser();
