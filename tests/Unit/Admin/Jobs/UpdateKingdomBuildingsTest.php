...
{
    use RefreshDatabase, CreateKingdom, CreateGameBuilding, CreateGameUnit, CreateGameBuildingUnit;
    ...
    public function testAddKingdomBuildingToKingdom()
    {
        ...
        UpdateKingdomBuildings::dispatch($building, $units->pluck('id')->toArray(), 3);
