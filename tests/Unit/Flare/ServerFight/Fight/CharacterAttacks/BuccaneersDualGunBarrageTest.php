...
class BuccaneersDualGunBarrageTest extends TestCase
{
    ...
    public function testSpecialDoesNotFireWhenCachedTypeIsNotDualGunBarrage(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter([], [
                'name' => 'Buccaneer',
    ...
    public function testDualGunSpecialDealsThreeHits(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter([], [
                'name' => 'Buccaneer',
    ...
    public function testThreeHitDamagePercentagesAre75And55And35OfWeaponDamage(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter([], [
                'name' => 'Buccaneer',
    ...
    public function testTotalDamageEqualsOneHundredSixtyFivePercentOfWeaponDamageWithNoDeduction(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter([], [
                'name' => 'Buccaneer',
