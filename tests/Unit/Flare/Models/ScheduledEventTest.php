...
class ScheduledEventTest extends TestCase
{
    ...
    public function test_running_now_includes_schedule_matching_every_running_condition(): void
    {
    ...
    public function test_running_now_excludes_future_scheduled_event(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_future_queued_event(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_starting_event(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_cancelling_event(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_cancelled_event(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_completed_event(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_failed_event(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_running_status_with_future_start(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_running_status_with_expired_scheduled_end(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_running_status_with_no_runtime_event(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_runtime_event_starting_in_the_future(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_runtime_event_that_has_ended(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
    ...
    public function test_running_now_excludes_child_belonging_to_non_running_parent(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-01-01 12:00:00'));
