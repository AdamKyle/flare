...
class EventSchedulerServiceTest extends TestCase
{
    ...
    public function testGeneratedSeasonalRaidHasExactParentId(): void
    {
        $parentStart = now()->addMonth();
        $parentEnd = $parentStart->copy()->addMonths(2);
    ...
    public function testRepeatedGenerationIsIdempotent(): void
    {
        $parentStart = now()->addMonth();
        $parentEnd = $parentStart->copy()->addMonths(2);
    ...
    public function testExistingDevelopmentChildIsReused(): void
    {
        $parentStart = now()->addMonth();
        $parentEnd = $parentStart->copy()->addMonths(2);
    ...
    public function testFutureIndependentRaidRemainsParentless(): void
    {
