...
class AccountDeletionTest extends TestCase
{
    ...
    public function testAlchemyBagAndSlotsAreDeletedWithCharacter(): void
    {
    ...
    public function testGemBagAndSlotsAreDeletedWithCharacter(): void
    {
        $character = $this->characterFactory->getCharacter();
    ...
    public function testDeletionSucceedsWhenAlchemyBagDoesNotExist(): void
    {
        $character = $this->characterFactory->getCharacter();
    ...
    public function testDeletionSucceedsWhenGemBagDoesNotExist(): void
    {
        $character = $this->characterFactory->getCharacter();
