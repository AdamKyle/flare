...
class CharacterSheetBaseInfoTransformerTest extends TestCase
{
    ...
    public function test_transform_sets_automation_running_false_for_expired_automation(): void
    {
        $this->createCharacterAutomation([
            'character_id' => $this->character->id,
            'type' => AutomationType::EXPLORING,
    ...
    public function test_transform_sets_delve_running_false_for_expired_delve(): void
    {
        $this->createCharacterAutomation([
            'character_id' => $this->character->id,
            'type' => AutomationType::DELVE,
