...
class CharacterInventoryCountTransformerTest extends TestCase
{
    ...
    public function test_transformer_payload_includes_main_inventory_keys(): void
    {
    ...
    public function test_transformer_payload_includes_alchemy_bag_keys(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter()
            ->givePlayerLocation()
    ...
    public function test_transformer_payload_includes_gem_bag_keys(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter()
            ->givePlayerLocation()
    ...
    public function test_transformer_payload_includes_crafted_items_set_count_and_max(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter()
            ->givePlayerLocation()
    ...
    public function test_transformer_alchemy_bag_count_reflects_slot_amounts(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter()
            ->givePlayerLocation()
    ...
    public function test_transformer_gem_bag_count_reflects_slot_amounts(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter()
            ->givePlayerLocation()
    ...
    public function test_transformer_is_alchemy_bag_full_when_at_limit(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter()
            ->givePlayerLocation()
    ...
    public function test_transformer_is_gem_bag_full_when_at_limit(): void
    {
        $character = (new CharacterFactory)
            ->createBaseCharacter()
            ->givePlayerLocation()
