...
class RecordUserLoginTimeListenerTest extends TestCase
{
    ...
    public function testNonAdminLoginCreatesOneOpenSession(): void
    {
    ...
    public function testExistingOpenSessionIsClosedBeforeNewSessionIsCreated(): void
    {
    ...
    public function testExistingOpenSessionClosesAtItsLastHeartbeat(): void
    {
        Carbon::setTestNow('2026-07-18 12:00:00');
        $user = User::factory()->create();
    ...
    public function testHeartbeatBeforeLoginCannotProduceNegativeDuration(): void
    {
        Carbon::setTestNow('2026-07-18 12:00:00');
        $user = User::factory()->create();
    ...
    public function testAdminLoginDoesNotCreateSession(): void
    {
