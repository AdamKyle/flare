...
class GameMapGemParamterControllerTest extends TestCase
{
    ...
    public function test_admin_can_create_map_gem_paramters_through_form(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_admin_can_update_map_gem_paramters_through_form(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_admin_can_navigate_back_from_map_gem_show_page(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMapGemParamter = $this->createGameMapGemParamter();
    ...
    public function test_admin_can_navigate_back_from_map_gem_edit_page(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMapGemParamter = $this->createGameMapGemParamter();
    ...
    public function test_duplicate_game_map_shows_validation_error(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMapGemParamter = $this->createGameMapGemParamter();
    ...
    public function test_admin_can_roll_and_reroll_map_gem(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $profile = $this->createGameMapGemParamter([
    ...
    public function test_admin_can_view_current_map_rolled_stats(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_map_rolled_gem_page_formats_percentages_to_three_decimal_places(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_map_rolled_gem_character_power_reduction_renders_as_negative_percentage(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_map_rolled_gem_page_does_not_show_rolled_by_user_id(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_map_rolled_stats_redirects_when_no_current_gem_exists(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $profile = $this->createGameMapGemParamter();
    ...
    public function test_public_map_gem_page_does_not_expose_rolling_controls_or_rolled_values(): void
    {
        $profile = $this->createGameMapGemParamter();
        $rolledGem = Gem::factory()->mapGenerated($profile)->create([
    ...
    public function test_non_admin_cannot_roll_map_gem(): void
    {
    ...
    public function test_non_admin_cannot_view_map_rolled_stats(): void
    {
        $user = $this->createUser();
        $profile = $this->createGameMapGemParamter();
