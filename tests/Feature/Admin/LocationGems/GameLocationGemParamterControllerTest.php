...
class GameLocationGemParamterControllerTest extends TestCase
{
    ...
    public function test_admin_can_navigate_from_list_to_create_page(): void
    {
    ...
    public function test_admin_can_create_location_gem_paramters_through_form(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMap = $this->createGameMap();
    ...
    public function test_admin_can_update_location_gem_paramters_through_form(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_admin_can_navigate_back_from_location_gem_show_page(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameLocationGemParamter = $this->createGameLocationGemParamter();
    ...
    public function test_admin_can_navigate_back_from_location_gem_edit_page(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameLocationGemParamter = $this->createGameLocationGemParamter();
    ...
    public function test_integer_and_reversed_ranges_are_accepted(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMap = $this->createGameMap();
        $location = $this->createLocation(['game_map_id' => $gameMap->id]);
    ...
    public function test_non_numeric_range_shows_validation_error(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMap = $this->createGameMap();
        $location = $this->createLocation(['game_map_id' => $gameMap->id]);
    ...
    public function test_duplicate_location_shows_validation_error(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameLocationGemParamter = $this->createGameLocationGemParamter();
    ...
    public function test_create_page_dropdown_shows_location_with_quest_item_drop_and_map_name(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_create_page_dropdown_does_not_show_location_without_quest_item_drop(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMap = $this->createGameMap();
    ...
    public function test_create_form_fails_validation_with_ineligible_location(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMap = $this->createGameMap();
    ...
    public function test_edit_page_dropdown_shows_eligible_locations_across_multiple_maps(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_create_page_dropdown_shows_special_location(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_special_location_dropdown_label_includes_special_type(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMap = $this->createGameMap(['name' => 'Surface']);
        $this->createLocation([
    ...
    public function test_create_form_can_save_using_special_location(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMap = $this->createGameMap(['name' => 'Surface']);
    ...
    public function test_edit_page_dropdown_shows_special_locations_across_multiple_maps(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_regular_eligible_locations_appear_before_special_locations(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $gameMap = $this->createGameMap(['name' => 'Surface']);
        $this->createLocation([
    ...
    public function test_locations_are_ordered_by_plane_order(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_special_locations_follow_plane_order_within_special_group(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $hellMap = $this->createGameMap(['name' => 'Hell']);
        $surfaceMap = $this->createGameMap(['name' => 'Surface']);
    ...
    public function test_admin_show_uses_rolled_gem_pointer_for_roll_button(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_admin_can_roll_and_reroll_location_gem(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $profile = $this->createGameLocationGemParamter([
    ...
    public function test_admin_can_view_current_location_rolled_stats(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_location_rolled_gem_page_formats_percentages_to_three_decimal_places(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_location_rolled_gem_page_does_not_show_rolled_by_user_id(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function test_location_rolled_stats_redirects_when_no_current_gem_exists(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $profile = $this->createGameLocationGemParamter();
    ...
    public function test_public_location_gem_page_does_not_expose_rolling_controls_or_rolled_values(): void
    {
        $profile = $this->createGameLocationGemParamter();
        $rolledGem = Gem::factory()->locationGenerated($profile)->create([
    ...
    public function test_non_admin_cannot_roll_location_gem(): void
    {
    ...
    public function test_non_admin_cannot_view_location_rolled_stats(): void
    {
        $user = $this->createUser();
        $profile = $this->createGameLocationGemParamter();
