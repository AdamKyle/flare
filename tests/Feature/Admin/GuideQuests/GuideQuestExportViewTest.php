...
class GuideQuestExportViewTest extends TestCase
{
    ...
    public function test_guide_quest_export_view_contains_batch_crafting_requirement_columns_and_values(): void
    {
    ...
    public function test_guide_quest_export_view_contains_event_goal_craft_and_enchant_columns_and_values(): void
    {
        $guideQuest = $this->createGuideQuest([
    ...
    public function test_guide_quest_export_view_contains_batch_crafted_item_requirement_columns_and_values(): void
    {
    ...
    public function test_guide_quest_export_view_has_valid_table_markup_for_new_requirement_fields(): void
    {
        $guideQuest = $this->createGuideQuest([
