...
class GiveToPlayerTest extends TestCase
{
    ...
    public function testAdminUserShowPageRendersGiveToPlayerComponent(): void
    {
    ...
    public function testAdminCanSearchAndGiveItem(): void
    {
    ...
    public function testAdminCanGiveCurrenciesWithCaps(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function testAdminCanGiveGoldBarsToAllKingdomsWithCaps(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
    ...
    public function testNonAdminCannotAccessAdminUserShowPage(): void
    {
