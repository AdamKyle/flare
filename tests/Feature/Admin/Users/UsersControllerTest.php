...
class UsersControllerTest extends TestCase
{
    ...
    public function testCanResetPassword() {
        ...
        $response->assertSessionHas('success', $this->character->getCharacter(false)->name . ' password reset email sent.');
    }
    ...
    public function testCanSeeShowForNonAdmin() {
        ...
        ]))->see($this->character->getCharacter(false)->name);
    }
    ...
    public function testCanSilenceUser() {
        ...
        $response->assertSessionHas('success', $this->character->getCharacter(false)->name . ' Has been silenced for: ' . 10 . ' minutes');
    }
    ...
    public function testForceNameChange() {
        ...
        $response->assertSessionHas('success', $this->character->getCharacter(false)->name . ' forced to change their name.');
    }
}
