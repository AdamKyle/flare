...
class GeneratedGemProfileDataTest extends TestCase
{
    ...
    public function testGeneratedMapGemFileHasRequiredMapsOnly(): void
    {
    ...
    public function testGeneratedMapGemFileValuesFollowConfiguredRanges(): void
    {
        $sheet = IOFactory::load(resource_path('data-imports/World Gems/map-gems.xlsx'))->getActiveSheet();
        $rows = $sheet->toArray(null, true, true, true);
        $headers = array_values($rows[1]);
    ...
    public function testGeneratedLocationGemFileContainsEveryRequiredLocation(): void
    {
    ...
    public function testGeneratedLocationGemFileUsesFivePercentHigherPlaneRanges(): void
    {
        $sheet = IOFactory::load(resource_path('data-imports/World Gems/location-gems.xlsx'))->getActiveSheet();
        $rows = $sheet->toArray(null, true, true, true);
        $headers = array_values($rows[1]);
