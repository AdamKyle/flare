...
class BattleRewardQueueControllerTest extends TestCase
{
    ...
    public function testAdminCanViewRewardQueuePageAndHomeCard(): void
    {
    ...
    public function testNonAdminCannotViewRewardQueuePage(): void
    {
    ...
    public function testAdminApiReturnsSummaryCharactersChartsAndFilteredRequests(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
    ...
    public function testNonAdminCannotAccessRewardQueueApi(): void
    {
    ...
    public function testRequestEnumFiltersWorkIndividually(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
        CharacterBattleRewardRequest::factory()->create([
    ...
    public function testRewardQueueBroadcastChannelIsAdminOnly(): void
    {
    ...
    public function testAdminCanFetchStaleQueueStateData(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
    ...
    public function testNonAdminCannotFetchStaleQueueStateData(): void
    {
        $response = $this->actingAs($this->createUser())
    ...
    public function testAdminCanRepairStaleQueuesAndReceiveCounts(): void
    {
        Queue::fake();
        $admin = $this->createAdmin($this->createAdminRole());
        $character = (new CharacterFactory)->createBaseCharacter()->getCharacter();
