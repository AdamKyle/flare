...
class AdminStatisticsDashboardControllerTest extends TestCase
{
    ...
    public function testNonAdminUsersCannotAccessDashboardJsonEndpoint(): void
    {
    ...
    public function testAdminUsersCanAccessDashboardJsonEndpoint(): void
    {
    ...
    public function testDashboardPageRendersReactMountPage(): void
    {
        $admin = $this->createAdmin($this->createAdminRole());
