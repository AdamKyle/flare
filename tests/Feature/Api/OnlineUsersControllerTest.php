...
class OnlineUsersControllerTest extends TestCase
{
    ...
    public function testCharactersOnlineEndpointReturnsUsefulCharacterDetails(): void
    {
    ...
    public function testWhosPlayingStatisticsEndpointReturnsPublicSummariesWithoutEmails(): void
    {
        $character = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
