...
namespace Tests\Feature\Game\Exploration\Controllers\Api;
...
class ExplorationControllerTest extends TestCase
{
    ...
    public function testBeginStartsExploration(): void
    {
        ...
        $response = $this->actingAs($this->character->user)
            ->call('POST', '/api/exploration/' . $this->character->id . '/start', [
                '_token' => csrf_token(),
    ...
    public function testStopStopsExploration(): void
    {
        ...
        $response = $this->actingAs($this->character->user)
            ->call('POST', '/api/exploration/' . $this->character->id . '/stop', [
                '_token' => csrf_token(),
            ]);
