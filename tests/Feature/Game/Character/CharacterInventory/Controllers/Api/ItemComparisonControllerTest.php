...
class ItemComparisonControllerTest extends TestCase
{
    ...
    public function testGetChatComparisonDataForItemInCraftedItemsSet(): void
    {
        $character = $this->character->getCharacter();
    ...
    public function testFailToCompareItemFromChatForCraftedItemsSetOwnedByAnotherCharacter(): void
    {
        $character = $this->character->getCharacter();
    ...
    public function testFailToCompareItemFromChatForMissingCraftedItemsSetSlot(): void
    {
        $character = $this->character->getCharacter();
    ...
    public function testGetChatComparisonDataForItemInAlchemyBag(): void
    {
        $character = $this->character->getCharacter();
    ...
    public function testFailToCompareItemFromChatForMissingAlchemyBagSlot(): void
    {
        $character = $this->character->getCharacter();
    ...
    public function testFailToCompareItemFromChatForAlchemyBagSlotOwnedByAnotherCharacter(): void
    {
        $character = $this->character->getCharacter();
        $otherCharacter = (new CharacterFactory)->createBaseCharacter()->givePlayerLocation()->getCharacter();
        $item = $this->createItem(['type' => 'alchemy']);
