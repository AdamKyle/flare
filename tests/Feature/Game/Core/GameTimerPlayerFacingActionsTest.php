...
class GameTimerPlayerFacingActionsTest extends TestCase
{
    ...
    public function testPassiveSkillTrainingCompletionTimeIsCappedInDevelopment(): void
    {
    ...
    public function testPassiveSkillTrainingKeepsRealTimeOutsideDevelopment(): void
    {
    ...
    public function testKingdomBuildingTimerIsCappedInDevelopment(): void
    {
        $this->enableCapForTestingEnvironment();
    ...
    public function testKingdomBuildingTimerKeepsRealTimeOutsideDevelopment(): void
    {
        $this->disableCapForTestingEnvironment();
    ...
    public function testUnitRecruitmentTimerIsCappedInDevelopment(): void
    {
        $this->enableCapForTestingEnvironment();
    ...
    public function testMovementTimerIsCappedInDevelopment(): void
    {
        $this->enableCapForTestingEnvironment();
    ...
    public function testCapitalCityBuildingTravelTimerIsCappedInDevelopment(): void
    {
        $this->enableCapForTestingEnvironment();
