...
class MapControllerApiTest extends TestCase
{
    ...
    public function testMoveCharacterWithCelestialSpawnRateSet() {
        Event::fake([
            MoveTimeOutEvent::class,
        ]);
    ...
    public function testCannotMoveCharacter() {
    ...
    public function testMoveCharacterToLocationWithQuestDrop() {
        Event::fake([
            MoveTimeOutEvent::class,
        ]);
    ...
    public function testMoveCharacterToLocationWithDropInventoryIsFull() {
        Event::fake([
            MoveTimeOutEvent::class,
        ]);
        ...
        // Gained the item:
        $this->assertFalse($questInventory->isNotEmpty());
    ...
    public function testIsDeathWaterNoItem() {
        Event::fake([
            MoveTimeOutEvent::class,
        ]);
        ...
        $water->shouldReceive('isDeathWaterTile')->andReturn(true);
        $water->shouldReceive('canWalkOnDeathWater')->andReturn(false);
    ...
    public function testCannotTeleportToDeathWater() {
        Event::fake([
            MoveTimeOutEvent::class,
        ]);
        ...
        $water->shouldReceive('getTileColor')->andReturn("1");
        $water->shouldReceive('isWaterTile')->once()->andReturn(false);
        $water->shouldReceive('isDeathWaterTile')->once()->andReturn(true);
        $water->shouldReceive('canWalkOnDeathWater')->once()->andReturn(false);
    ...
    public function testCannotTeleportWhenCannotMove() {
    ...
    public function testIsDeathWaterWithItem() {
        Event::fake([
            MoveTimeOutEvent::class,
        ]);
    ...
    public function testCannotSetSailWhenCannotMove() {
        $secondPort = $this->createLocation([
            'name'        => 'Sample',
            'description' => 'Port',
            'is_port'     => true,
    ...
    public function testCanSetSailAndNotGetReward() {
        ...
        // Did not gain the item again:
        $this->assertEquals(1, $this->character->getCharacter(false)->inventory->slots->count());
    }
    ...
    public function testCannotTraverseWhenCannotMove() {
        $user      = $this->character->getUser();
