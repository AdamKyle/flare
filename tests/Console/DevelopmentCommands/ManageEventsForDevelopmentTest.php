...
class ManageEventsForDevelopmentTest extends TestCase
{
    ...
    public function testCommandSignatureIsRegistered(): void
    {
        $this->assertArrayHasKey('manage:events-for-development', Artisan::all());
    }

    public function testOldCommandSignatureIsNotRegistered(): void
    {
        $this->assertArrayNotHasKey('create:events-for-development', Artisan::all());
    }

    public function testViewCancelMenuLabelIsCurrentlyRunningEvents(): void
    {
        $this->assertEquals('View / cancel currently running events', ManageEventsForDevelopment::VIEW_CANCEL);
    }

    public function testNonLocalNonTestingEnvironmentRejectsCommandWithNoChanges(): void
    {
    ...
    public function testMissingQueueDefaultRejectsBeforeEventSelection(): void
    {
    ...
    public function testMissingQueueConnectionRejectsBeforeEventSelection(): void
    {
    ...
    public function testMissingQueueDriverRejectsBeforeEventSelection(): void
    {
    ...
    public function testSyncQueueDriverRejectsStartOperationBeforeAnyScheduleIsCreated(): void
    {
    ...
    public function testNullQueueDriverRejectsStartOperationBeforeAnyScheduleIsCreated(): void
    {
        config(['queue.default' => 'null']);
    ...
    public function testExitWorks(): void
    {
        $this->artisan('manage:events-for-development')
            ->expectsQuestion('What would you like to do?', ManageEventsForDevelopment::EXIT)
            ->assertSuccessful();
    ...
    public function testNoEventsRunningPrintsExactEmptyMessage(): void
    {
        $this->artisan('manage:events-for-development')
    ...
    public function testOneWeeklyEventIsQueuedWithStartOneMinuteAheadAndFiveMinuteDuration(): void
    {
    ...
    public function testMultipleCompatibleChoicesCreateAllSchedulesWithIdenticalTimestamps(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testIndependentRaidPromptsAndQueuesSelectedRaid(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testWinterCreatesParentAndExactChild(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testDelusionalCreatesParentAndExactChild(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testNoRaidsAbortsWholeStartOperation(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testDuplicateActiveWeeklyTypeIsRejected(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testDuplicateActiveWinterIsRejected(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testDuplicateActiveDelusionalIsRejected(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testActiveWinterPermitsNewDelusionalStart(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testActiveDelusionalPermitsNewWinterStart(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testWinterAndDelusionalCanStartTogether(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testSameMapRequestedRaidsRejectBeforeCreation(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testExistingSameMapConflictDisplaysExactMapNames(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testConfirmingConflictTearsDownOldRaidBeforeCreatingReplacement(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testRunningRowsDisplay(): void
    {
    ...
    public function testTerminalRowsDoNotDisplay(): void
    {
        $this->createScheduledEvent([
            'event_type' => EventType::WEEKLY_CELESTIALS,
    ...
    public function testFutureScheduledEventIsNotDisplayed(): void
    {
        $this->createScheduledEvent([
            'event_type' => EventType::WEEKLY_CELESTIALS,
    ...
    public function testQueuedEventIsNotDisplayed(): void
    {
        $this->createScheduledEvent([
            'event_type' => EventType::WEEKLY_CELESTIALS,
    ...
    public function testStartingEventIsNotDisplayed(): void
    {
        $this->createScheduledEvent([
            'event_type' => EventType::WEEKLY_CELESTIALS,
    ...
    public function testCancellingEventIsNotDisplayed(): void
    {
        $this->createScheduledEvent([
            'event_type' => EventType::WEEKLY_CELESTIALS,
    ...
    public function testExpiredStaleRunningEventIsNotDisplayed(): void
    {
        $scheduledEvent = $this->createScheduledEvent([
            'event_type' => EventType::WEEKLY_CELESTIALS,
            'status' => ScheduledEventStatus::RUNNING,
    ...
    public function testFutureChildRaidUnderRunningSeasonalParentIsNotDisplayed(): void
    {
    ...
    public function testCancellationChoicesIncludeOnlyRowsRunningNow(): void
    {
    ...
    public function testDirectChildCancellationLeavesParentActive(): void
    {
        $parent = $this->createScheduledEvent([
            'event_type' => EventType::WINTER_EVENT,
            'status' => ScheduledEventStatus::RUNNING,
    ...
    public function testParentCancellationListsOnlyCurrentlyRunningChildren(): void
    {
        $parent = $this->createScheduledEvent([
            'event_type' => EventType::WINTER_EVENT,
            'status' => ScheduledEventStatus::RUNNING,
    ...
    public function testConfirmingParentCancellationEndsChildrenFirst(): void
    {
    ...
    public function testCancelAllCurrentlyRunningReachesTerminalCancelledState(): void
    {
        $scheduledEvent = $this->createScheduledEvent([
            'event_type' => EventType::WEEKLY_CELESTIALS,
            'status' => ScheduledEventStatus::RUNNING,
    ...
    public function testCancelAllCurrentlyRunningIgnoresScheduledFutureEvents(): void
    {
        $runningSchedule = $this->createScheduledEvent([
            'event_type' => EventType::WEEKLY_CELESTIALS,
            'status' => ScheduledEventStatus::RUNNING,
    ...
    public function testBackReturnsToMain(): void
    {
        $scheduledEvent = $this->createScheduledEvent([
            'event_type' => EventType::WEEKLY_CELESTIALS,
            'status' => ScheduledEventStatus::RUNNING,
    ...
    public function testNonSeasonalIndependentRaidDoesNotPromptForSeasonalEvent(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testIndependentRaidBecomesChildOfExactRunningWinterSchedule(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testIndependentRaidBecomesChildOfExactRunningDelusionalSchedule(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testWinterRaidWithoutWinterRunningDisplaysRequirementMessage(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testDecliningSeasonalStartDisplaysMandatoryMessage(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testDecliningSeasonalStartReturnsToRaidSelectionForADifferentRaid(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testDecliningSeasonalStartCreatesNoSchedules(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testAcceptingSeasonalStartCreatesWinterParentAndExactChildRaid(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testAcceptingSeasonalStartCreatesDelusionalParentAndExactChildRaid(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testAcceptingSeasonalStartParentAndChildShareExactTimestamps(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testAcceptingSeasonalStartDispatchesOnlyTheSeasonalRootJob(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testAcceptingSeasonalStartDoesNotPromptForASecondRaid(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
    ...
    public function testSeasonalRaidAttachedToRunningParentIsNeverCreatedAsRootSchedule(): void
    {
        config(['queue.default' => 'database']);
        Queue::fake();
