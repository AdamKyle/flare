...
CREATE TABLE `announcements` (
  ...
  CONSTRAINT `announcements_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `character_mercenaries` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `character_id` bigint unsigned NOT NULL,
  `mercenary_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `game_class_specials` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `attack_type_required` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'any',
...
CREATE TABLE `guide_quests` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `intro_text` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `items` (
  ...
  `specialty_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `passive_skills` (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `max_level` int NOT NULL,
  `bonus_per_level` decimal(8,4) NOT NULL,
...
CREATE TABLE `quests` (
  ...
  `before_completion_description` longtext COLLATE utf8mb4_unicode_ci,
  `after_completion_description` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `raids` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `item_specialty_reward_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `migrations` VALUES (4,'2019_11_22_173623_create_game_races',1);
INSERT INTO `migrations` VALUES (5,'2019_11_22_173640_create_game_classes',1);
INSERT INTO `migrations` VALUES (6,'2019_11_22_173651_create_characters',1);
INSERT INTO `migrations` VALUES (7,'2019_11_23_021655_create_permission_tables',1);
INSERT INTO `migrations` VALUES (8,'2019_11_23_184641_create_websockets_statistics_entries_table',1);
INSERT INTO `migrations` VALUES (9,'2019_11_23_190544_create_messages',1);
INSERT INTO `migrations` VALUES (10,'2019_11_24_201001_create_monsters',1);
INSERT INTO `migrations` VALUES (11,'2019_11_24_222740_create_skills',1);
INSERT INTO `migrations` VALUES (12,'2019_11_25_235345_create_items',1);
INSERT INTO `migrations` VALUES (13,'2019_11_26_001941_create_inventories',1);
INSERT INTO `migrations` VALUES (14,'2019_11_26_223837_create_inventory_slots',1);
INSERT INTO `migrations` VALUES (15,'2019_11_29_220548_create_maps',1);
INSERT INTO `migrations` VALUES (16,'2019_11_30_231615_create_locations',1);
INSERT INTO `migrations` VALUES (17,'2019_12_04_223756_create_item_affixes',1);
INSERT INTO `migrations` VALUES (18,'2020_05_12_205154_create_game_maps',1);
INSERT INTO `migrations` VALUES (19,'2020_05_12_222332_add_game_map_id_to_maps',1);
INSERT INTO `migrations` VALUES (20,'2020_06_09_181647_add_game_map_id_to_locations',1);
INSERT INTO `migrations` VALUES (21,'2020_06_10_200948_create_adventures',1);
INSERT INTO `migrations` VALUES (22,'2020_06_10_202128_create_adventure_logs',1);
INSERT INTO `migrations` VALUES (23,'2020_06_11_173617_create_adventure_location',1);
INSERT INTO `migrations` VALUES (24,'2020_06_11_183143_create_adventure_monster',1);
INSERT INTO `migrations` VALUES (25,'2020_09_14_211537_create_notifications',1);
INSERT INTO `migrations` VALUES (26,'2020_09_20_013710_add_quest_information_to_monsters',1);
INSERT INTO `migrations` VALUES (27,'2020_09_28_011204_create_sessions_table',1);
INSERT INTO `migrations` VALUES (28,'2020_10_06_164008_create_game_skills',1);
INSERT INTO `migrations` VALUES (29,'2020_10_06_182953_add_game_skill_id_to_skills',1);
INSERT INTO `migrations` VALUES (30,'2020_11_11_181548_create_security_questions',1);
INSERT INTO `migrations` VALUES (31,'2020_11_26_201357_create_market_board',1);
INSERT INTO `migrations` VALUES (32,'2020_11_26_202031_create_market_history',1);
INSERT INTO `migrations` VALUES (33,'2020_12_18_024531_create_release_notes',1);
INSERT INTO `migrations` VALUES (34,'2020_12_21_233115_create_character_snap_shots',1);
INSERT INTO `migrations` VALUES (35,'2020_12_28_190720_create_kingdoms',1);
INSERT INTO `migrations` VALUES (36,'2020_12_28_214357_create_game_buildings',1);
INSERT INTO `migrations` VALUES (37,'2020_12_31_233318_add_game_map_id_to_monsters',1);
INSERT INTO `migrations` VALUES (38,'2021_01_12_230649_create_game_units',1);
INSERT INTO `migrations` VALUES (39,'2021_01_12_231050_create_game_building_units',1);
INSERT INTO `migrations` VALUES (40,'2021_01_12_232009_create_kingdom_units',1);
INSERT INTO `migrations` VALUES (41,'2021_01_18_120104_create_units_in_queue',1);
INSERT INTO `migrations` VALUES (42,'2021_03_10_103612_create_unit_movement_queue',1);
INSERT INTO `migrations` VALUES (43,'2021_03_16_173026_create_kingdom_buildings',1);
INSERT INTO `migrations` VALUES (44,'2021_03_17_100859_create_buildings_in_queue',1);
INSERT INTO `migrations` VALUES (45,'2021_03_27_153843_create_audits_table',1);
INSERT INTO `migrations` VALUES (46,'2021_04_08_200645_create_kingdom_logs',1);
INSERT INTO `migrations` VALUES (47,'2021_06_04_110845_create_user_site_access_statistics',2);
INSERT INTO `migrations` VALUES (48,'2021_06_08_200758_change_cost_on_items_to_allow_biger_integers',3);
INSERT INTO `migrations` VALUES (49,'2021_06_09_201729_change_item_affixes_cost',4);
INSERT INTO `migrations` VALUES (50,'2021_06_10_112930_update_market_board_listed_price',5);
INSERT INTO `migrations` VALUES (51,'2021_06_15_215220_add_can_drop_to_items',6);
INSERT INTO `migrations` VALUES (52,'2021_06_15_215526_add_can_drop_to_item_affixes',6);
INSERT INTO `migrations` VALUES (53,'2021_06_18_122128_add_last_walked_to_kingdoms',7);
INSERT INTO `migrations` VALUES (54,'2021_06_18_175714_add_chat_settings_to_users',7);
INSERT INTO `migrations` VALUES (55,'2021_06_22_122810_update_skill_description_length',8);
INSERT INTO `migrations` VALUES (56,'2021_06_10_203954_let_characters_be_npcs',9);
INSERT INTO `migrations` VALUES (57,'2021_06_10_205145_create_npcs',9);
INSERT INTO `migrations` VALUES (58,'2021_06_10_210918_create_npc_commands',9);
INSERT INTO `migrations` VALUES (59,'2021_06_11_212651_all_character_id_to_be_null_on_kingdoms',9);
INSERT INTO `migrations` VALUES (60,'2021_06_21_202724_add_celestial_info_to_monsters',9);
INSERT INTO `migrations` VALUES (61,'2021_06_21_203555_add_celestial_fights',9);
INSERT INTO `migrations` VALUES (62,'2021_06_23_162829_add_new_currencies_to_characters',9);
INSERT INTO `migrations` VALUES (63,'2021_06_23_210800_add_skill_type_to_game_skills',9);
INSERT INTO `migrations` VALUES (64,'2021_06_24_192953_update_monsters',9);
INSERT INTO `migrations` VALUES (65,'2021_06_26_191759_create_character_in_celestial_fights',9);
INSERT INTO `migrations` VALUES (66,'2021_06_30_131820_add_alchemy_costs_to_items',9);
INSERT INTO `migrations` VALUES (67,'2021_06_30_235807_add_is_locked_to_game_skills',9);
INSERT INTO `migrations` VALUES (68,'2021_06_30_235836_create_character_boons',9);
INSERT INTO `migrations` VALUES (69,'2021_06_30_235853_create_quests',9);
INSERT INTO `migrations` VALUES (70,'2021_07_01_103318_add_is_locked_to_skills',9);
INSERT INTO `migrations` VALUES (71,'2021_07_01_150606_create_quests_completed',9);
INSERT INTO `migrations` VALUES (72,'2021_07_20_213308_create_inventory_sets',9);
INSERT INTO `migrations` VALUES (73,'2021_07_20_213342_create_set_slots',9);
INSERT INTO `migrations` VALUES (74,'2021_07_27_180228_update_game_map_with_bonuses',9);
INSERT INTO `migrations` VALUES (75,'2021_07_28_191307_add_class_id_to_game_skills',9);
INSERT INTO `migrations` VALUES (76,'2021_08_03_114147_add_to_hit_stat_to_game_classes',9);
INSERT INTO `migrations` VALUES (77,'2021_08_03_120022_add_new_stats_to_characters',9);
INSERT INTO `migrations` VALUES (78,'2021_08_03_120319_add_new_stat_mods_to_races_and_classes',9);
INSERT INTO `migrations` VALUES (79,'2021_08_03_191405_add_new_stats_to_items_and_item_affixes',9);
INSERT INTO `migrations` VALUES (80,'2021_08_05_223150_change_percision_on_skill_bonuses',9);
INSERT INTO `migrations` VALUES (81,'2021_08_09_185508_add_resurection_chance_to_items',9);
INSERT INTO `migrations` VALUES (82,'2021_08_11_145040_add_new_skill_modifiers_to_item_affixes',9);
INSERT INTO `migrations` VALUES (83,'2021_08_20_123750_remove_security_questions',9);
INSERT INTO `migrations` VALUES (84,'2021_08_24_182605_update_status_for_kingdom_logs',9);
INSERT INTO `migrations` VALUES (85,'2021_08_29_181928_drop_character_snap_shots',9);
INSERT INTO `migrations` VALUES (86,'2021_09_03_063300_add_new_stats_to_monsters',9);
INSERT INTO `migrations` VALUES (87,'2021_09_14_181203_change_items_agi_and_focus_to_default',10);
INSERT INTO `migrations` VALUES (88,'2021_09_14_182130_change_affixes_agi_and_focus_to_default',10);
INSERT INTO `migrations` VALUES (89,'2021_09_20_183725_add_damage_to_item_affixes',11);
INSERT INTO `migrations` VALUES (90,'2021_09_21_153809_change_description_for_item_affixes',11);
INSERT INTO `migrations` VALUES (91,'2021_09_21_164348_add_affix_resistance_to_monsters',11);
INSERT INTO `migrations` VALUES (92,'2021_09_22_153115_add_class_bonus_to_item_affixes',11);
INSERT INTO `migrations` VALUES (93,'2021_09_22_182705_add_stat_ailments_to_item_affixes',11);
INSERT INTO `migrations` VALUES (94,'2021_10_04_231512_add_more_stats_to_monsters',12);
INSERT INTO `migrations` VALUES (95,'2021_10_05_213217_add_healing_deduction_and_affix_damage_reduction_to_items',12);
INSERT INTO `migrations` VALUES (96,'2021_10_11_183326_create_adventure_floor_descriptions',12);
INSERT INTO `migrations` VALUES (97,'2021_10_12_225239_add_skill_precentages_to_monsters',12);
INSERT INTO `migrations` VALUES (98,'2021_10_12_230623_remove_monster_skills_from_skills',12);
INSERT INTO `migrations` VALUES (99,'2021_10_13_195856_add_devouring_light_and_devouring_darkness_to_items',12);
INSERT INTO `migrations` VALUES (100,'2021_10_13_201322_increase_description_length_for_items',12);
INSERT INTO `migrations` VALUES (101,'2021_10_15_175828_add_max_level_configurations',12);
INSERT INTO `migrations` VALUES (102,'2021_10_20_200843_add_devouring_light_to_item_affixes',12);
INSERT INTO `migrations` VALUES (103,'2021_10_30_015030_remove_kingdom_update_setting_from_users',12);
INSERT INTO `migrations` VALUES (104,'2021_11_03_215903_add_auto_disenchant_to_users',13);
INSERT INTO `migrations` VALUES (105,'2021_11_07_012112_add_skill_reduction_to_item_affixes',14);
INSERT INTO `migrations` VALUES (106,'2021_11_07_032536_add_resistance_reduction_to_item_affixes',14);
INSERT INTO `migrations` VALUES (107,'2021_11_07_193909_add_last_logged_in_to_users',14);
INSERT INTO `migrations` VALUES (108,'2021_11_07_202923_add_disable_attack_pop_overs_to_users',14);
INSERT INTO `migrations` VALUES (109,'2021_11_10_204151_change_maxvalue_of_health_in_character_in_celestial_fights',15);
INSERT INTO `migrations` VALUES (110,'2021_11_11_050908_change_current_health_column_type_on_celestial_fights',15);
INSERT INTO `migrations` VALUES (111,'2021_12_12_041115_add_current_adventure_id_to_characters',16);
INSERT INTO `migrations` VALUES (112,'2021_12_14_224600_add_parent_id_to_items',17);
INSERT INTO `migrations` VALUES (113,'2021_12_20_184108_add_stat_attributes_to_character_boons',18);
INSERT INTO `migrations` VALUES (114,'2021_11_04_041106_add_gold_to_units_in_queue',19);
INSERT INTO `migrations` VALUES (115,'2021_11_09_203846_add_enemy_strength_to_locations',19);
INSERT INTO `migrations` VALUES (116,'2021_11_15_194346_add_paid_with_gold_to_buildings_in_queue',19);
INSERT INTO `migrations` VALUES (117,'2021_11_17_004841_add_kingdom_reduction_to_game_skills',19);
INSERT INTO `migrations` VALUES (118,'2021_11_18_013118_create_character_automations',19);
INSERT INTO `migrations` VALUES (119,'2021_11_18_013902_add_is_attack_automation_locked_to_characters',19);
INSERT INTO `migrations` VALUES (120,'2021_11_20_180548_add_opened_flag_to_kingdom_logs',19);
INSERT INTO `migrations` VALUES (121,'2021_11_21_002528_add_is_mass_embezzling_to_characters',19);
INSERT INTO `migrations` VALUES (122,'2021_11_21_230039_create_factions',19);
INSERT INTO `migrations` VALUES (123,'2021_11_22_202619_add_randomly_generated_to_item_affixes',19);
INSERT INTO `migrations` VALUES (124,'2021_11_23_205244_add_location_id_to_adventures',19);
INSERT INTO `migrations` VALUES (125,'2021_11_26_001434_add_flag_to_delete_to_users',19);
INSERT INTO `migrations` VALUES (126,'2021_11_26_025639_create_passive_skills',19);
INSERT INTO `migrations` VALUES (127,'2021_11_26_213514_character_passive_skills',19);
INSERT INTO `migrations` VALUES (128,'2021_12_02_030336_add_passive_skill_lock_details_to_game_buildings',19);
INSERT INTO `migrations` VALUES (129,'2021_12_05_000723_add_is_locked_to_kingdom_buildings',19);
INSERT INTO `migrations` VALUES (130,'2021_12_05_203721_remove_new_building_email_setting_from_users',19);
INSERT INTO `migrations` VALUES (131,'2021_12_06_185609_add_gold_bars_to_kingdoms',19);
INSERT INTO `migrations` VALUES (132,'2021_12_18_031735_add_character_attack_reduction_to_game_maps',19);
INSERT INTO `migrations` VALUES (133,'2021_12_18_064044_add_parent_details_to_quests',19);
INSERT INTO `migrations` VALUES (134,'2021_12_22_045604_add_drops_from_spcial_location_to_items',19);
INSERT INTO `migrations` VALUES (135,'2021_12_22_051945_add_requires_access_to_plane_to_quests',19);
INSERT INTO `migrations` VALUES (136,'2021_12_24_004522_update_stats_for_monsters',19);
INSERT INTO `migrations` VALUES (137,'2021_12_31_010528_add_name_to_inventory_sets',19);
INSERT INTO `migrations` VALUES (138,'2022_01_01_010621_add_location_id_to_game_maps',19);
INSERT INTO `migrations` VALUES (139,'2022_01_08_043251_add_over_flow_set_id_to_adventure_logs',19);
INSERT INTO `migrations` VALUES (140,'2022_01_12_233248_add_kingdom_lock_out_to_characters',19);
INSERT INTO `migrations` VALUES (141,'2022_01_13_022046_add_modifiers_to_character_boons',19);
INSERT INTO `migrations` VALUES (142,'2022_01_31_200645_add_can_auto_battle_to_users',20);
INSERT INTO `migrations` VALUES (143,'2022_02_10_150301_add_experience_buff_to_items',21);
INSERT INTO `migrations` VALUES (144,'2022_02_10_192743_add_copper_coins_to_characters',21);
INSERT INTO `migrations` VALUES (145,'2022_02_11_145421_add_copper_coins_to_quests',21);
INSERT INTO `migrations` VALUES (146,'2022_02_14_200025_remove_attack_autom_ation_flag_from_users',22);
INSERT INTO `migrations` VALUES (147,'2022_02_14_220238_add_can_use_on_other_items_to_items',22);
INSERT INTO `migrations` VALUES (148,'2022_02_15_091842_add_requires_quest_item_to_locations',22);
INSERT INTO `migrations` VALUES (149,'2022_02_15_112039_add_type_to_locations',22);
INSERT INTO `migrations` VALUES (150,'2022_02_15_122007_create_holy_stacks',22);
INSERT INTO `migrations` VALUES (151,'2022_02_15_123223_add_holy_information_to_items',22);
INSERT INTO `migrations` VALUES (152,'2022_02_18_130225_add_devouring_resistance_and_darkness_to_monsters',22);
INSERT INTO `migrations` VALUES (153,'2022_02_25_111903_change_sold_for_in_market_history',23);
INSERT INTO `migrations` VALUES (154,'2022_02_28_185545_remove_disable_attack_typ_popover_from_users',23);
INSERT INTO `migrations` VALUES (155,'2022_03_01_212500_add_ips_to_user_site_access_statistics',23);
INSERT INTO `migrations` VALUES (156,'2022_03_25_205939_add_additional_info_to_items',23);
INSERT INTO `migrations` VALUES (157,'2022_03_28_114204_add_ambush_and_counter_chance_and_resistance_to_monsters',23);
INSERT INTO `migrations` VALUES (158,'2022_04_23_101624_change_character_boons',23);
INSERT INTO `migrations` VALUES (159,'2022_05_05_151046_add_ignored_un_ban_request_to_users',23);
INSERT INTO `migrations` VALUES (160,'2022_05_07_193816_add_before_and_after_acceptance_descriptions_to_quests',23);
INSERT INTO `migrations` VALUES (161,'2022_05_11_091709_drop_adventures_table',23);
INSERT INTO `migrations` VALUES (162,'2022_05_12_200219_drop_columns_from_monsters',23);
INSERT INTO `migrations` VALUES (163,'2022_05_14_104039_create_info_pages',23);
INSERT INTO `migrations` VALUES (164,'2022_05_18_171857_drop_notifications_table',23);
INSERT INTO `migrations` VALUES (165,'2022_05_18_181930_create_guide_quests',23);
INSERT INTO `migrations` VALUES (166,'2022_05_18_182812_add_guide_quest_id_to_quests_completed',23);
INSERT INTO `migrations` VALUES (167,'2022_05_19_134949_add_guide_enabled_to_users',23);
INSERT INTO `migrations` VALUES (168,'2022_05_19_185726_add_reward_level_to_guide_quests',23);
INSERT INTO `migrations` VALUES (169,'2022_05_22_102216_drop_adventure_email_from_users',23);
INSERT INTO `migrations` VALUES (170,'2022_05_29_103505_add_killed_in_pvp_to_characters',23);
INSERT INTO `migrations` VALUES (171,'2022_05_31_103016_add_is_mythic_to_items',23);
INSERT INTO `migrations` VALUES (172,'2022_06_13_144016_add_is_location_locked_from_player_to_locations',23);
INSERT INTO `migrations` VALUES (173,'2022_06_13_150652_create_events_table',23);
INSERT INTO `migrations` VALUES (174,'2022_06_13_200001_monthly_pvp_participants',23);
INSERT INTO `migrations` VALUES (175,'2022_06_14_150342_add_attack_type_to_monthly_pvp_participants',23);
INSERT INTO `migrations` VALUES (176,'2022_06_15_145808_set_monster_id_to_null_on_character_automations',23);
INSERT INTO `migrations` VALUES (177,'2022_06_16_124409_add_celestial_type_to_monsters',23);
INSERT INTO `migrations` VALUES (178,'2022_06_18_132246_add_additional_rewards_to_guide_quests',23);
INSERT INTO `migrations` VALUES (179,'2022_06_23_184907_add_required_kingdom_level_to_guide_quests',23);
INSERT INTO `migrations` VALUES (180,'2022_07_06_160711_add_passive_skill_requirements_to_guide_quests',23);
INSERT INTO `migrations` VALUES (181,'2022_07_09_113427_change_story_fields_for_quests',23);
INSERT INTO `migrations` VALUES (182,'2022_07_12_102109_add_protection_until_to_kingdoms',23);
INSERT INTO `migrations` VALUES (183,'2022_08_06_131338_drop_npc_commands_table',23);
INSERT INTO `migrations` VALUES (184,'2022_08_06_131550_clean_up_characters',23);
INSERT INTO `migrations` VALUES (185,'2022_08_15_180839_add_copper_coin_cost_to_items',23);
INSERT INTO `migrations` VALUES (186,'2022_09_01_075321_add_skill_type_to_skills',23);
INSERT INTO `migrations` VALUES (187,'2022_09_03_103252_change_kingdoms_logs',23);
INSERT INTO `migrations` VALUES (188,'2022_09_04_090311_add_attacking_character_id_to_kingdom_logs',23);
INSERT INTO `migrations` VALUES (189,'2022_09_04_094314_make_changes_to_kingdom_logs',23);
INSERT INTO `migrations` VALUES (190,'2022_09_04_095037_change_status_on_kingdom_logs',23);
INSERT INTO `migrations` VALUES (191,'2022_09_05_114115_add_specialty_type_to_items',23);
INSERT INTO `migrations` VALUES (192,'2022_09_05_115411_change_specialty_type_on_items',23);
INSERT INTO `migrations` VALUES (193,'2022_09_24_162553_add_faction_increase_to_guide_quests',23);
INSERT INTO `migrations` VALUES (194,'2022_09_26_162529_add_required_shards_to_guide_quests',23);
INSERT INTO `migrations` VALUES (195,'2022_10_10_094444_change_x_p_on_characters',23);
INSERT INTO `migrations` VALUES (196,'2022_10_18_135340_add_is_locationhidden_to_messages',23);
INSERT INTO `migrations` VALUES (197,'2022_11_05_205813_add_spin_info_to_character_sheet',23);
INSERT INTO `migrations` VALUES (198,'2022_11_07_143308_add_is_mercenary_unlocked_to_characters',23);
INSERT INTO `migrations` VALUES (199,'2022_11_07_150312_add_unlocks_feature_to_quests',23);
INSERT INTO `migrations` VALUES (200,'2022_11_08_082906_create_character_mercenaries',23);
INSERT INTO `migrations` VALUES (201,'2022_11_10_081755_add_xp_increase_and_reincarnated_times_to_mercenaries',23);
INSERT INTO `migrations` VALUES (202,'2022_11_12_161617_add_can_engage_celestial_to_characters',23);
INSERT INTO `migrations` VALUES (203,'2022_11_14_133054_change_the_item_damage_onkingdom_logs',23);
INSERT INTO `migrations` VALUES (204,'2022_11_19_105822_add_unlocks_passive_id_to_quests',23);
INSERT INTO `migrations` VALUES (205,'2022_11_19_112310_removetext_command_to_message_from_npcs',23);
INSERT INTO `migrations` VALUES (206,'2022_11_21_203021_add_steel_to_kingdoms',23);
INSERT INTO `migrations` VALUES (207,'2022_11_22_101426_create_table_smelting_progress',23);
INSERT INTO `migrations` VALUES (208,'2022_11_22_142006_add_steel_cost_to_game_buildings',23);
INSERT INTO `migrations` VALUES (209,'2022_11_22_142401_add_steel_cost_to_game_units',23);
INSERT INTO `migrations` VALUES (210,'2022_11_24_133158_add_is_special_to_game_buildings',23);
INSERT INTO `migrations` VALUES (211,'2022_11_24_133209_add_is_special_to_game_units',23);
INSERT INTO `migrations` VALUES (212,'2022_11_24_163055_add_xp_buff_to_mercenaries',23);
INSERT INTO `migrations` VALUES (213,'2022_11_24_204858_add_xp_penalty_to_characters',23);
INSERT INTO `migrations` VALUES (214,'2022_11_24_225727_add_reincarnated_stat_increase_and_times_reincarnated_to_characters',23);
INSERT INTO `migrations` VALUES (215,'2022_11_30_144137_create_class_ranks',23);
INSERT INTO `migrations` VALUES (216,'2022_12_01_084448_create_class_ranks_weapon_masteries',23);
INSERT INTO `migrations` VALUES (217,'2022_12_02_112412_create_class_specials',23);
INSERT INTO `migrations` VALUES (218,'2022_12_02_172923_create_character_class_specialties_equipped',23);
INSERT INTO `migrations` VALUES (219,'2022_12_14_183105_add_is_hidden_to_skills',23);
INSERT INTO `migrations` VALUES (220,'2022_12_14_194155_add_required_attack_type_to_game_class_specials',23);
INSERT INTO `migrations` VALUES (221,'2022_12_20_212448_add_stat_pools_to_characters',23);
INSERT INTO `migrations` VALUES (222,'2022_12_27_125831_rank_fights',23);
INSERT INTO `migrations` VALUES (223,'2022_12_27_132349_add_rank_fight_tops',23);
INSERT INTO `migrations` VALUES (224,'2023_01_06_121304_add_gold_bars_cost_to_items',23);
INSERT INTO `migrations` VALUES (225,'2023_01_17_181017_add_class_rank_requirements_to_game_classes',23);
INSERT INTO `migrations` VALUES (226,'2023_01_17_182505_add_unlocks_class_id_to_items',23);
INSERT INTO `migrations` VALUES (227,'2023_01_20_104203_add_reductions_to_class_specials',23);
INSERT INTO `migrations` VALUES (228,'2023_03_14_093113_create_gems',23);
INSERT INTO `migrations` VALUES (229,'2023_03_14_094116_create_gem_bags',23);
INSERT INTO `migrations` VALUES (230,'2023_03_14_100511_create_item_sockets',23);
INSERT INTO `migrations` VALUES (231,'2023_03_14_214841_create_gem_bag_slots',23);
INSERT INTO `migrations` VALUES (232,'2023_03_18_121507_add_socket_amount_to_items',23);
INSERT INTO `migrations` VALUES (233,'2023_04_18_204824_create_announcements',23);
INSERT INTO `migrations` VALUES (234,'2023_04_18_204938_add_raid_id_to_events',23);
INSERT INTO `migrations` VALUES (235,'2023_04_18_205143_add_raid_info_to_locations',23);
INSERT INTO `migrations` VALUES (236,'2023_04_18_205614_add_raid_info_to_monsters',23);
INSERT INTO `migrations` VALUES (237,'2023_04_18_210255_create_raids',23);
INSERT INTO `migrations` VALUES (238,'2023_04_26_140838_create_scheduled_events',23);
INSERT INTO `migrations` VALUES (239,'2023_05_02_122834_update_monster_gold_to_big_integer',23);
INSERT INTO `migrations` VALUES (240,'2023_05_02_142223_add_raid_id_to_quests',23);
INSERT INTO `migrations` VALUES (241,'2023_05_04_132726_create_raid_participations',23);
INSERT INTO `migrations` VALUES (242,'2023_05_04_132750_create_raid_bosses',23);
INSERT INTO `migrations` VALUES (243,'2023_05_04_133259_add_raid_boss_id_to_raid_participations',23);
INSERT INTO `migrations` VALUES (244,'2023_05_08_093817_change_health_to_nullable_on_raid_bosses',23);
INSERT INTO `migrations` VALUES (245,'2023_05_09_104028_change_raid_id_on_events',23);
INSERT INTO `migrations` VALUES (246,'2023_05_10_110644_add_currently_running_to_scheduled_events',23);
INSERT INTO `migrations` VALUES (247,'2023_05_10_192257_change_event_type_on_scheduled_events',23);
INSERT INTO `migrations` VALUES (248,'2023_05_30_150733_add_raid_boss_details_to_raid_bosses',23);
INSERT INTO `migrations` VALUES (249,'2023_05_31_135357_create_raid_boss_participations',23);
INSERT INTO `migrations` VALUES (250,'2023_06_02_190403_add_recination_times_and_required_quest_id_to_quests',23);
INSERT INTO `migrations` VALUES (251,'2023_06_05_190646_add_elemental_information_to_monsters',23);
INSERT INTO `migrations` VALUES (252,'2023_06_14_105325_add_life_stealing_resistance_to_monsters',23);
INSERT INTO `migrations` VALUES (253,'2023_06_15_202412_add_item_specialty_type_to_raids',23);
INSERT INTO `migrations` VALUES (254,'2023_06_16_114248_create_item_skills',23);
INSERT INTO `migrations` VALUES (255,'2023_06_16_150509_add_item_skill_id_to_items',23);
INSERT INTO `migrations` VALUES (256,'2023_06_16_193432_create_item_skill_progressions',23);
INSERT INTO `migrations` VALUES (257,'2023_06_21_110406_add_event_id_to_announcements',23);
INSERT INTO `migrations` VALUES (258,'2023_06_22_135441_add_artifact_item_id_to_raids',23);
INSERT INTO `migrations` VALUES (259,'2023_07_03_121434_remove_fields_from_item_affixes',23);
INSERT INTO `migrations` VALUES (260,'2023_07_05_160947_remove_can_monster_have_skill_from_skills',23);
INSERT INTO `migrations` VALUES (261,'2023_07_06_160047_add_affix_type_to_item_affixes',23);
